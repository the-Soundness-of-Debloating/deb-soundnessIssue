...
int c_strcasecmp(char const *s1, char const *s2) {
...

  {
    ...
    if ((unsigned long)p1 == (unsigned long)p2) {
       printf("<This branch (L248) is removed by Cov debloating tool>\n"); exit(6);
    }
    while (1) {
      c1 = (unsigned char)c_tolower((int)*p1);
      c2 = (unsigned char)c_tolower((int)*p2);
      if ((int)c1 == 0) {
         printf("<This branch (L254) is removed by Cov debloating tool>\n"); exit(6);
      }
      p1++;
      p2++;
      if (!((int)c1 == (int)c2)) {
    ...
    if ((c & -33) >= 65) {
      if ((c & -33) <= 90) {
        tmp = 1;
         ...
         printf("<This branch (L278) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      tmp = 0;
    }
...
_Bool c_isspace(int c) {
...

  {
    if (c == 32) {
      ...
      if (c == 9) {
         printf("<This branch (L295) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (c == 10) {
          tmp = 1;
        } else {
          if (c == 11) {
            ...
            if (c == 12) {
              ...
              if (c == 13) {
                 printf("<This branch (L307) is removed by Cov debloating tool>\n"); exit(6);
              } else {
                tmp = 0;
              }
            }
    ...
    if (c >= 65) {
      if (c <= 90) {
        tmp = (c - 65) + 97;
         ...
         printf("<This branch (L328) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
       printf("<This branch (L331) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (tmp);
  }
}
    ...
    if (c >= 97) {
      if (c <= 122) {
        tmp = (c - 97) + 65;
         ...
         printf("<This branch (L345) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      tmp = c;
    }
...
__inline void *xnmalloc(size_t n, size_t s) {
   ...
   printf("<This branch (L387) is removed by Cov debloating tool>\n"); exit(6);
}
char *xcharalloc(size_t n) {
   ...
   printf("<This branch (L403) is removed by Cov debloating tool>\n"); exit(6);
}
...
char *last_component(char const *name) {
   ...
   printf("<This branch (L443) is removed by Cov debloating tool>\n"); exit(6);
}
...
ptrdiff_t argmatch(char const *arg, char const *const *arglist,
        ...
        if (tmp___0 == arglen) {
          ...
          if (matchind == -1L) {
            matchind = (ptrdiff_t)i;
             ...
             printf("<This branch (L551) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      }
      i++;
  ...
  while_break:;
    if (ambiguous) {
       printf("<This branch (L559) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      return (matchind);
    }
  }
...
void argmatch_invalid(char const *context, char const *value,
   ...
   printf("<This branch (L587) is removed by Cov debloating tool>\n"); exit(6);
}
void argmatch_valid(char const *const *arglist, char const *vallist,
                    size_t valsize) {
   ...
   printf("<This branch (L629) is removed by Cov debloating tool>\n"); exit(6);
}
ptrdiff_t __xargmatch_internal(char const *context, char const *arg,
                               char const *const *arglist, char const *vallist,
                               size_t valsize, void (*exit_fn)(void)) {
...

  {
    ...
    if (res >= 0L) {
     ...
     printf("<This branch (L643) is removed by Cov debloating tool>\n"); exit(6);
...
void *xrealloc(void *p, size_t n) {
   ...
   printf("<This branch (L751) is removed by Cov debloating tool>\n"); exit(6);
}
void *xmemdup(void const *p, size_t s)
    __attribute__((__malloc__, __alloc_size__(2)));
void *xmemdup(void const *p, size_t s) {
   ...
   printf("<This branch (L763) is removed by Cov debloating tool>\n"); exit(6);
}
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wmissing-prototypes"
#pragma GCC diagnostic ignored "-Wmissing-declarations"
...
void xalloc_die(void) {
   ...
   printf("<This branch (L796) is removed by Cov debloating tool>\n"); exit(6);
}
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wmissing-prototypes"
#pragma GCC diagnostic ignored "-Wmissing-declarations"
...
void version_etc(FILE *stream, char const *command_name, char const *package,
   ...
   printf("<This branch (L992) is removed by Cov debloating tool>\n"); exit(6);
}
char const version_etc_copyright[47] = {
...
int set_char_quoting(struct quoting_options *o, char c, int i) {
   ...
   printf("<This branch (L1370) is removed by Cov debloating tool>\n"); exit(6);
}
...
quoting_options_from_style(enum quoting_style style) {
   ...
   printf("<This branch (L1398) is removed by Cov debloating tool>\n"); exit(6);
}
static char const *gettext_quote(char const *msgid, enum quoting_style s) {
...

  {
    ...
    if (tmp___3 == 0) {
       ...
       printf("<This branch (L1433) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)s == 7U) {
       printf("<This branch (L1436) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___4 = "\'";
    }
    return (tmp___4);
...
quotearg_buffer_restyled(char *buffer, size_t buffersize, char const *arg,
...

  {
    ...
    if ((unsigned int)quoting_style == 4U) {
       printf("<This branch (L1484) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 3U) {
       printf("<This branch (L1487) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 5U) {
       printf("<This branch (L1490) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 6U) {
      goto case_6;
    }
     printf("<This branch (L1495) is removed by Cov debloating tool>\n"); exit(6);
    ...
    while (1) {
      ...
      if (argsize == 0xffffffffffffffffUL) {
        tmp___6 = (int const) * (arg + i) == 0;
         ...
         printf("<This branch (L1593) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tmp___6) {
        ...
        if (quote_string_len) {
          if (i + quote_string_len <= argsize) {
            ...
            if (tmp___0 == 0) {
               ...
               printf("<This branch (L1608) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
      }
      ...
      if ((int)c == 0) {
         printf("<This branch (L1615) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 63) {
         printf("<This branch (L1618) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 7) {
         printf("<This branch (L1621) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 8) {
         printf("<This branch (L1624) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 12) {
         printf("<This branch (L1627) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 10) {
         printf("<This branch (L1630) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 13) {
         printf("<This branch (L1633) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 9) {
         printf("<This branch (L1636) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 11) {
         printf("<This branch (L1639) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 92) {
         printf("<This branch (L1642) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 123) {
      ...
      if ((int)c == 35) {
         printf("<This branch (L1651) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 126) {
         printf("<This branch (L1654) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 32) {
         printf("<This branch (L1657) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 33) {
         printf("<This branch (L1660) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 34) {
      ...
      if ((int)c == 40) {
         printf("<This branch (L1672) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 41) {
         printf("<This branch (L1675) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 42) {
         printf("<This branch (L1678) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 59) {
         printf("<This branch (L1681) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 60) {
         printf("<This branch (L1684) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 61) {
         printf("<This branch (L1687) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 62) {
         printf("<This branch (L1690) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 91) {
         printf("<This branch (L1693) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 94) {
         printf("<This branch (L1696) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 96) {
         printf("<This branch (L1699) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 124) {
         printf("<This branch (L1702) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 39) {
         printf("<This branch (L1705) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 37) {
         printf("<This branch (L1708) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 43) {
         printf("<This branch (L1711) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 44) {
         printf("<This branch (L1714) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 45) {
      ...
      if ((int)c == 49) {
         printf("<This branch (L1729) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 50) {
        goto case_37;
      }
      ...
      if ((int)c == 54) {
         printf("<This branch (L1744) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 55) {
        goto case_37;
      }
        ...
        _L___3:;
          if (quote_these_too) {
            if (!(*(quote_these_too + (unsigned long)c / (sizeof(int) * 8UL)) &
             ...
             printf("<This branch (L2343) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
        _L___2:;
          if (!is_right_quote) {
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize,
...

  {
    ...
    sv = slotvec;
    if (n < 0) {
       printf("<This branch (L2445) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nslots <= n0) {
       ...
       printf("<This branch (L2469) is removed by Cov debloating tool>\n"); exit(6);
    }
    size = (sv + n)->size;
    val = (sv + n)->val;
    ...
    if (size <= qsize) {
                                ...
                                printf("<This branch (L2491) is removed by Cov debloating tool>\n"); exit(6);
    }
...
char *quotearg_n_style(int n, enum quoting_style s, char const *arg) {
   ...
   printf("<This branch (L2509) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_char_mem(char const *arg, size_t argsize, char ch) {
...
void set_program_name(char const *argv0) {
...

  {
    if ((unsigned long)argv0 == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L2605) is removed by Cov debloating tool>\n"); exit(6);
    }
    slash = (char const *)strrchr(argv0, '/');
    if ((unsigned long)slash != (unsigned long)((void *)0)) {
      base = slash + 1;
    } else {
       printf("<This branch (L2611) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (base - argv0 >= 7L) {
...
static int year(struct tm *tm, int const *digit_pair, size_t n,
   ...
   printf("<This branch (L2701) is removed by Cov debloating tool>\n"); exit(6);
}
...
_Bool posixtime(time_t *p, char const *s, unsigned int syntax_bits) {
   ...
   printf("<This branch (L2868) is removed by Cov debloating tool>\n"); exit(6);
}
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wmissing-prototypes"
#pragma GCC diagnostic ignored "-Wmissing-declarations"
...
static void yydestruct(char const *yymsg, int yytype, YYSTYPE *yyvaluep,
  ...
  {
    if (!yymsg) {
       printf("<This branch (L3367) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_default;
  switch_default:;
    goto switch_break;
...
int yyparse(parser_control *pc) {
    ...
    if (yychar <= 0) {
      ...
      if ((unsigned int)yychar <= 277U) {
        yytoken = (int)yytranslate[yychar];
         ...
         printf("<This branch (L3512) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    yyn += yytoken;
    if (yyn < 0) {
      ...
      if (112 < yyn) {
         printf("<This branch (L3520) is removed by Cov debloating tool>\n"); exit(6);
      } else {
  ...
  yydefault:;
    ...
    if (yyn == 0) {
       printf("<This branch (L3550) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto yyreduce;
  yyreduce:;
    yylen = (int)yyr2[yyn];
    ...
    if (yyn == 9) {
       printf("<This branch (L3566) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 10) {
      goto case_10;
    }
    ...
    if (yyn == 19) {
       printf("<This branch (L3581) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 20) {
       printf("<This branch (L3584) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 22) {
       printf("<This branch (L3587) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 23) {
      goto case_23;
    }
    ...
    if (yyn == 28) {
       printf("<This branch (L3599) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 29) {
       printf("<This branch (L3602) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 30) {
      goto case_30;
    }
    ...
    if (yyn == 33) {
       printf("<This branch (L3614) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 34) {
       printf("<This branch (L3617) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 35) {
       printf("<This branch (L3620) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 36) {
       printf("<This branch (L3623) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 37) {
       printf("<This branch (L3626) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 38) {
       printf("<This branch (L3629) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 39) {
      goto case_39;
    }
    if (yyn == 40) {
       printf("<This branch (L3635) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 41) {
       printf("<This branch (L3638) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 42) {
      goto case_42;
    }
    if (yyn == 43) {
       printf("<This branch (L3644) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 44) {
      goto case_44;
    }
    ...
    if (yyn == 47) {
       printf("<This branch (L3656) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 48) {
    ...
    if (yyn == 56) {
       printf("<This branch (L3680) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 57) {
      goto case_57;
    }
    ...
    if (yyn == 59) {
       printf("<This branch (L3689) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 60) {
      goto case_60;
    }
    ...
    if (yyn == 65) {
       printf("<This branch (L3707) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 66) {
      goto case_66;
    }
    ...
    if (yyn == 68) {
       printf("<This branch (L3716) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 69) {
      goto case_69;
    }
    ...
    if (yyn == 73) {
       printf("<This branch (L3731) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 75) {
       printf("<This branch (L3734) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 76) {
       printf("<This branch (L3737) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 77) {
      goto case_77;
    }
    ...
    if (yyn == 79) {
       printf("<This branch (L3746) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yyn == 80) {
      goto case_80;
    }
    ...
    if (yyn == 91) {
       printf("<This branch (L3770) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_default;
  case_4:;
  ...
  case_42:;
    if (4UL <= (yyvsp + -4)->textintval.digits) {
       ...
       printf("<This branch (L3887) is removed by Cov debloating tool>\n"); exit(6);
    } else {
  ...
  yyreturn:;
    if (yychar != -2) {
       printf("<This branch (L4344) is removed by Cov debloating tool>\n"); exit(6);
    }
    yyvsp -= yylen;
    yyssp -= yylen;
    while (1) {
  ...
  while_break___2:;
    if ((unsigned long)yyss != (unsigned long)(yyssa)) {
       printf("<This branch (L4359) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (yyresult);
  }
}
...

  {
    ...
    if (mm < 0L) {
      n_minutes = (s.value / 100L) * 60L + s.value % 100L;
       ...
       printf("<This branch (L4484) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static int to_hour(long hours, int meridian) {
  ...
  {
    if (meridian == 0) {
       printf("<This branch (L4502) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (meridian == 1) {
       printf("<This branch (L4505) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_default;
  switch_default:;
    if (0L <= hours) {
      if (hours < 24L) {
        tmp = hours;
         ...
         printf("<This branch (L4513) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
...
lookup_zone(parser_control const *pc, char const *name) {
  ...
  while_break:;
    ...
    while (1) {
      ...
      if (tmp___0 == 0) {
         printf("<This branch (L4607) is removed by Cov debloating tool>\n"); exit(6);
      }
      tp++;
    }
  while_break___0:;
...
static table const *lookup_word(parser_control const *pc, char *word___0) {
  ...
  while_break:;
    ...
    while (1) {
      ...
      if (tmp == 0) {
         printf("<This branch (L4667) is removed by Cov debloating tool>\n"); exit(6);
      }
      tp++;
    }
  while_break___0:;
    ...
    if (wordlen == 3UL) {
      ...
      if (wordlen == 4UL) {
        if ((int)*(word___0 + 3) == 46) {
           printf("<This branch (L4678) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          tmp___0 = 0;
        }
      } else {
    ...
    while_break___0:;
        ...
        if ((int)c == 45) {
          ...
          _L___2:;
              ...
              _L:;
                ...
                while_continue___1:;
                  ...
                  if (!tmp___0) {
                   ...
                   printf("<This branch (L4863) is removed by Cov debloating tool>\n"); exit(6);
                }
              while_break___1:;
                if (!((unsigned int)c - 48U <= 9U)) {
            ...
            while (1) {
              ...
              if (value1 < value) {
                 printf("<This branch (L4878) is removed by Cov debloating tool>\n"); exit(6);
              }
              value = value1;
              p++;
              c = (unsigned char)*p;
              ...
              if (1844674407370955161UL < value) {
                 printf("<This branch (L4887) is removed by Cov debloating tool>\n"); exit(6);
              }
              value *= 10UL;
            }
          while_break___2:;
              ...
              _L___1:;
                if ((unsigned int)*(p + 1) - 48U <= 9U) {
                  if (sign < 0) {
                     ...
                     printf("<This branch (L4903) is removed by Cov debloating tool>\n"); exit(6);
                  } else {
                    s = (time_t)value;
                    if (s < 0L) {
                       printf("<This branch (L4907) is removed by Cov debloating tool>\n"); exit(6);
                    }
                    value1___0 = (unsigned long)s;
                  }
                  if (value != value1___0) {
                     printf("<This branch (L4912) is removed by Cov debloating tool>\n"); exit(6);
                  }
                  p++;
                  tmp___1 = p;
                  p++;
      ...
      while_break___6:;
        *p___0 = (char)'\000';
        ...
        if (!tp) {
           printf("<This branch (L5026) is removed by Cov debloating tool>\n"); exit(6);
        }
      ...
      if ((int)c != 40) {
       ...
       printf("<This branch (L5037) is removed by Cov debloating tool>\n"); exit(6);
...
static char *get_tz(char *tzbuf) {
...

  {
    ...
    if (tz) {
       ...
       printf("<This branch (L5105) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (tz);
  }
}
_Bool parse_datetime(struct timespec *result, char const *p,
    ...
    if (tmp___4 == 0) {
      ...
      while (1) {
        ...
        if ((int const) * s == 92) {
           ...
           printf("<This branch (L5215) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if ((int const) * s == 34) {
            ...
            if (large_tz) {
               ...
               printf("<This branch (L5223) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              tz1 = tz1buf;
            }
            z = tz1;
          ...
          while_break___1:;
            *z = (char)'\000';
            ...
            if (!setenv_ok) {
               printf("<This branch (L5248) is removed by Cov debloating tool>\n"); exit(6);
            }
  ...
  while_break___2:;
    ...
    tmp___7 = yyparse(&pc);
    if (tmp___7 != 0) {
       printf("<This branch (L5330) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (pc.timespec_seen) {
      *result = pc.seconds;
    } else {
        ...
        if (pc.rels_seen) {
          if (!pc.dates_seen) {
            ...
            _L:;
              ...
              if (tm.tm_hour < 0) {
                 printf("<This branch (L5353) is removed by Cov debloating tool>\n"); exit(6);
              }
              ...
              tm.tm_sec = (int)pc.seconds.tv_sec;
               ...
               printf("<This branch (L5361) is removed by Cov debloating tool>\n"); exit(6);
            }
          } else {
            tm.tm_sec = 0;
            tm.tm_min = tm.tm_sec;
      ...
      if (pc.local_zones_seen) {
         printf("<This branch (L5380) is removed by Cov debloating tool>\n"); exit(6);
      }
      tm0 = tm;
      Start = mktime(&tm);
      tmp___12 =
      ...
      if (!tmp___12) {
        if (!pc.zones_seen) {
          goto fail;
           ...
           printf("<This branch (L5415) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      if (pc.days_seen) {
        if (!pc.dates_seen) {
          ...
          Start = mktime(&tm);
          if (Start == -1L) {
             printf("<This branch (L5435) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      }
      if ((pc.rel.year | pc.rel.month) | pc.rel.day) {
        ...
        if ((((year___1 < tm.tm_year) ^ (pc.rel.year < 0L)) |
           ...
           printf("<This branch (L5446) is removed by Cov debloating tool>\n"); exit(6);
        }
        tm.tm_year = year___1;
        tm.tm_mon = month;
        tm.tm_mday = day;
        ...
        Start = mktime(&tm);
        if (Start == -1L) {
           printf("<This branch (L5457) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      if (pc.zones_seen) {
        ...
        if ((Start < t1) != (delta < 0L)) {
           printf("<This branch (L5465) is removed by Cov debloating tool>\n"); exit(6);
        }
        Start = t1;
      }
  ...
  fail:;
    ...
    if (tz_was_altered) {
      if (tz0) {
         ...
         printf("<This branch (L5499) is removed by Cov debloating tool>\n"); exit(6);
      } else {
    ...
    if ((unsigned long)cp == (unsigned long)((void *)0)) {
      ...
      if ((unsigned long)dir == (unsigned long)((void *)0)) {
        dir = "/usr/local/lib";
         ...
         printf("<This branch (L5723) is removed by Cov debloating tool>\n"); exit(6);
      }
      tmp = strlen(dir);
      dir_len___0 = tmp;
      tmp___0 = strlen(base);
      ...
      if ((unsigned long)file_name___3 == (unsigned long)((void *)0)) {
         printf("<This branch (L5750) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        ...
        if (fd < 0) {
          cp = "";
           ...
           printf("<This branch (L5829) is removed by Cov debloating tool>\n"); exit(6);
        }
...
char const *locale_charset(void) {
...

  {
    ...
    if ((unsigned long)codeset == (unsigned long)((void *)0)) {
       printf("<This branch (L5849) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  while_break:;
    if ((int const) * (codeset + 0) == 0) {
       printf("<This branch (L5878) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (codeset);
  }
}
...
void gettime(struct timespec *ts) {
...

  {
    ...
    if (tmp == 0) {
     ...
     printf("<This branch (L5973) is removed by Cov debloating tool>\n"); exit(6);
...
int(__attribute__((__nonnull__(1))) rpl_fseeko)(FILE *fp, off_t offset,
   ...
   printf("<This branch (L6042) is removed by Cov debloating tool>\n"); exit(6);
}
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wmissing-prototypes"
#pragma GCC diagnostic ignored "-Wmissing-declarations"
...

  {
    ...
    while (1) {
        ...
        while (1) {
          ...
          if (width < 0) {
            tmp = 0;
             ...
             printf("<This branch (L6300) is removed by Cov debloating tool>\n"); exit(6);
          }
          _w = (size_t)tmp;
          if (_n < _w) {
             printf("<This branch (L6304) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            tmp___0 = _n;
          }
          _incr = tmp___0;
          ...
          if (p) {
            if (digits == 0) {
              if (_n < _w) {
                 ...
                 printf("<This branch (L6346) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
            fputc((int)*f, p);
          }
      ...
      while_continue___5:;
        ...
        if ((int const) * f == 45) {
           printf("<This branch (L6364) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int const) * f == 48) {
          goto case_95;
        }
        ...
        if ((int const) * f == 35) {
           printf("<This branch (L6373) is removed by Cov debloating tool>\n"); exit(6);
        }
        goto switch_default;
      case_95:;
        pad = (int)*f;
    ...
    while_break___5:;
      if ((unsigned int)*f - 48U <= 9U) {
        ...
        while (1) {
          ...
          if (width > 214748364) {
             printf("<This branch (L6396) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            if (width == 214748364) {
    ...
    switch_break___0:;
      format_char = (int)*f;
      if (format_char == 37) {
         printf("<This branch (L6435) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (format_char == 97) {
        goto case_97;
      }
      ...
      if (format_char == 67) {
         printf("<This branch (L6456) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (format_char == 120) {
      ...
      if (format_char == 73) {
         printf("<This branch (L6477) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (format_char == 107) {
      ...
      if (format_char == 106) {
         printf("<This branch (L6486) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (format_char == 77) {
        goto case_77;
      }
      ...
      if (format_char == 103) {
         printf("<This branch (L6537) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (format_char == 71) {
         printf("<This branch (L6540) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (format_char == 87) {
        goto case_87;
      }
      ...
      if (format_char == 122) {
       ...
       printf("<This branch (L6563) is removed by Cov debloating tool>\n"); exit(6);
    ...
    case_98:;
      if (change_case) {
         ...
         printf("<This branch (L6653) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (modifier != 0) {
    ...
    subformat:;
      ...
      while (1) {
        ...
        if (_n___1 < _w___1) {
           printf("<This branch (L6686) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          tmp___6 = _n___1;
        }
        _incr___1 = tmp___6;
        ...
        if (p) {
          if (digits == 0) {
            if (_n___1 < _w___1) {
               ...
               printf("<This branch (L6728) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        ...
        while (1) {
          ...
          if (width < 0) {
            tmp___11 = 0;
             ...
             printf("<This branch (L6762) is removed by Cov debloating tool>\n"); exit(6);
          }
    ...
    case_68:;
      if (modifier != 0) {
         printf("<This branch (L6861) is removed by Cov debloating tool>\n"); exit(6);
      }
      subfmt = "%m/%d/%y";
      goto subformat;
    case_100:;
    ...
    case_101:;
      if (modifier == 69) {
         printf("<This branch (L6874) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = 2;
      number_value = (int)tp->tm_mday;
    ...
    do_number_body:;
      if (modifier == 79) {
         ...
         printf("<This branch (L6898) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    do_number_sign_and_padding:;
      ...
      if (pad == 45) {
         ...
         printf("<This branch (L6997) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        padding =
            (int)(((long)digits -
        ...
        if (padding > 0) {
          if (pad == 95) {
            if ((size_t)padding >= maxsize - i) {
               printf("<This branch (L7006) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (p) {
              while (1) {
                _i___9 = (size_t)0;
              ...
              while (1) {
                ...
                if (_n___4 < _w___4) {
                  tmp___18 = _w___4;
                   ...
                   printf("<This branch (L7042) is removed by Cov debloating tool>\n"); exit(6);
                }
                _incr___4 = tmp___18;
                if (_incr___4 >= maxsize - i) {
                   printf("<This branch (L7046) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (p) {
                  if (digits == 0) {
                     ...
                     printf("<This branch (L7083) is removed by Cov debloating tool>\n"); exit(6);
                  }
            ...
            if ((size_t)digits >= maxsize - i) {
               printf("<This branch (L7094) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (sign_char) {
              while (1) {
                _n___5 = (size_t)1;
                ...
                if (_incr___5 >= maxsize - i) {
                   printf("<This branch (L7112) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (p) {
                  if (digits == 0) {
                     ...
                     printf("<This branch (L7149) is removed by Cov debloating tool>\n"); exit(6);
                  }
                  fputc((int)sign_char, p);
                }
                i += _incr___5;
            ...
            while (1) {
              ...
              if (width < 0) {
                tmp___21 = 0;
                 ...
                 printf("<This branch (L7184) is removed by Cov debloating tool>\n"); exit(6);
              }
      ...
      while (1) {
        ...
        if (p) {
          ...
          while (1) {
            ...
            if (to_lowcase) {
               printf("<This branch (L7300) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if (to_uppcase) {
                 printf("<This branch (L7303) is removed by Cov debloating tool>\n"); exit(6);
              } else {
    ...
    case_109:;
      if (modifier == 69) {
         printf("<This branch (L7368) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = 2;
    ...
    case_78:;
      if (modifier == 69) {
         printf("<This branch (L7376) is removed by Cov debloating tool>\n"); exit(6);
      }
      number_value = ns;
      if (width == -1) {
        width = 9;
       ...
       printf("<This branch (L7391) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = width;
    ...
    case_83:;
      if (modifier == 69) {
         printf("<This branch (L7474) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = 2;
    ...
    case_85:;
      if (modifier == 69) {
         printf("<This branch (L7578) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = 2;
    ...
    case_86:;
      ...
      if (tp->tm_year < 0) {
         printf("<This branch (L7588) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        tmp___30 = -100;
      }
      ...
      if (days < 0) {
        ...
        if (year___1 % 4 == 0) {
          if (year___1 % 100 != 0) {
           ...
           printf("<This branch (L7625) is removed by Cov debloating tool>\n"); exit(6);
        }
        ...
        if (0 <= d___0) {
           ...
           printf("<This branch (L7632) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      if ((int const) * f == 103) {
         printf("<This branch (L7636) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * f == 71) {
    ...
    case_87:;
      if (modifier == 69) {
         printf("<This branch (L7669) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = 2;
      number_value =
    ...
    case_89:;
      if (modifier == 69) {
         printf("<This branch (L7684) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (modifier == 79) {
         printf("<This branch (L7687) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        digits = 4;
      }
    ...
    case_121:;
      if (modifier == 69) {
         printf("<This branch (L7696) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      if (yy___0 < 0) {
         ...
         printf("<This branch (L7704) is removed by Cov debloating tool>\n"); exit(6);
      }
      digits = 2;
      number_value = yy___0;
      goto do_number;
    case_90:;
      if (change_case) {
         ...
         printf("<This branch (L7712) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (!zone) {
      ...
      while (1) {
        ...
        if (_incr___10 >= maxsize - i) {
           printf("<This branch (L7733) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (p) {
          if (digits == 0) {
            if (_n___10 < _w___10) {
               ...
               printf("<This branch (L7769) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
          while (1) {

            if (to_lowcase) {
               printf("<This branch (L7775) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if (to_uppcase) {
    ...
    do_z_conversion:;
      ...
      if (colons == 1UL) {
       ...
       printf("<This branch (L7825) is removed by Cov debloating tool>\n"); exit(6);
...
static void clear_ungetc_buffer_preserving_position(FILE *fp) {
  ...
  {
    if (fp->_flags & 256) {
       printf("<This branch (L7998) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
int rpl_fflush(FILE *stream) {
...

  {
    if ((unsigned long)stream == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L8011) is removed by Cov debloating tool>\n"); exit(6);
    } else {
...
int(__attribute__((__nonnull__(1))) rpl_fclose)(FILE *fp) {
...

  {
    ...
    if (fd < 0) {
       ...
       printf("<This branch (L8067) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (saved_errno != 0) {
       ...
       printf("<This branch (L8088) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (result);
  }
}
...
void close_stdout(void) {
...

  {
    ...
    if (tmp___3 != 0) {
       ...
       printf("<This branch (L8302) is removed by Cov debloating tool>\n"); exit(6);
    }
...
int close_stream(FILE *stream) {
...

  {
    ...
    if (prev_fail) {
       printf("<This branch (L8335) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (fclose_fail) {
...
__inline static void emit_mandatory_arg_note(void) {
   ...
   printf("<This branch (L9208) is removed by Cov debloating tool>\n"); exit(6);
}
__inline static void emit_ancillary_info(void) {
   ...
   printf("<This branch (L9249) is removed by Cov debloating tool>\n"); exit(6);
}
__inline static void emit_try_help(void) {
   ...
   printf("<This branch (L9258) is removed by Cov debloating tool>\n"); exit(6);
}
...
void usage(int status) {
   ...
   printf("<This branch (L9455) is removed by Cov debloating tool>\n"); exit(6);
}
...

  {
    ...
    if (tmp___1 == 0) {
      ...
      if ((unsigned long)in_stream == (unsigned long)((void *)0)) {
         ...
         printf("<This branch (L9486) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    line = (char *)((void *)0);
    buflen = (size_t)0;
    ...
    while (1) {
      ...
      if (tmp___6) {
        ...
        ok = (_Bool)((int)ok & (int)tmp___5);
         ...
         printf("<This branch (L9510) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
  while_break:;
    ...
    if (tmp___9 == -1) {
       ...
       printf("<This branch (L9518) is removed by Cov debloating tool>\n"); exit(6);
    }
    free((void *)line);
    return (ok);
  }
...
int main(int argc, char **argv) {
...

  {
    ...
    while (1) {
      ...
      if (optc == 117) {
       ...
       printf("<This branch (L9651) is removed by Cov debloating tool>\n"); exit(6);
    ...
    case_117:;
      ...
      if (tmp___3 != 0) {
         printf("<This branch (L9698) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto switch_break;
    case_neg_130:;
  ...
  while_break:;
    ...
    if (option_specified_date > 1) {
       ...
       printf("<This branch (L9741) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (set_date) {
       ...
       printf("<This branch (L9749) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (optind < argc) {
      if (optind + 1 < argc) {
         ...
         printf("<This branch (L9756) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)*(*(argv + optind) + 0) == 43) {
        if (format) {

           printf("<This branch (L9761) is removed by Cov debloating tool>\n"); exit(6);
        }
        tmp___13 = optind;
        optind++;
        format = (char const *)(*(argv + tmp___13) + 1);
         ...
         printf("<This branch (L9785) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!format) {
      format = (char const *)nl_langinfo(131180);
      if (!*format) {
         printf("<This branch (L9791) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if ((unsigned long)batch_file != (unsigned long)((void *)0)) {
      ...
      if (!option_specified_date) {
        if (!set_date) {
          if (optind < argc) {
           ...
           printf("<This branch (L9810) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
      _L:;
      ...
      if (set_date) {
         ...
         printf("<This branch (L9841) is removed by Cov debloating tool>\n"); exit(6);
      }
