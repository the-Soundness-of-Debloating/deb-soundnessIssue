...
void file_error(char *filename )
{
 ...
 printf("<This branch (L25770) is removed by Cov debloating tool>\n"); exit(6);
}
void programming_error(char const   *format  , ...)
{
...
void report_error(char const   *format  , ...)
{
 ...
 printf("<This branch (L25826) is removed by Cov debloating tool>\n"); exit(6);
}
void fatal_error(char const   *format  , ...)
{
  ...
  while (1) {
    ...
    if (i < 10) {
      if (! dollar_vars[i]) {
       ...
       printf("<This branch (L34954) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if (fildes[0] != tmp___4) {
      ...
      if (fildes[0] != tmp___5) {
        ...
        if (fildes[0] != tmp___6) {
          ...
          } printf("<This branch (L37430) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    interactive = 0;
  ...
  while (1) {
    ...
    while (1) {
      ...
      if (istring_index + 2 >= istring_size) {
        ...
        } printf("<This branch (L41106) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto while_break___3;
    }
    while_break___3: /* CIL Label */ ;
...
char *search_for_command(char *pathname )
{
  ...
  if (hashed_file) {
    ...
    if (tmp___3) {
      ...
      } printf("<This branch (L56399) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (temp_path) {
        {
