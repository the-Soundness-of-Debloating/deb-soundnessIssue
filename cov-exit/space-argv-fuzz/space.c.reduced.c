...
{ 
  ...
  if (argc != 2) {
    ...
    } printf("<This branch (L468) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error) {
    ...
    } printf("<This branch (L497) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error) {
    ...
    } printf("<This branch (L505) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L556) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 0) {
    {
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L584) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 0) {
    {
    ...
    *addrem_ptr = (struct AddRem *)tmp___0;
    ...
    if ((unsigned long )*addrem_ptr == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L595) is removed by Cov debloating tool>\n"); exit(6);
    }
    (*addrem_ptr)->ADDREM_TYPE = 0;
  ...
  if (error == 0) {
    {
     ...
     printf("<This branch (L630) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L640) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 0) {
    {
...
{ 
  ...
  while (1) {
    ...
    if (add_ptr->BLOCK_TYPE == 2) {
       printf("<This branch (L745) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (group_shape == 0) {
       ...
       printf("<This branch (L761) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      group_shape = 5;
    }
    goto switch_break;
    ...
    if (elem_shape != 2) {
      {
       ...
       printf("<This branch (L791) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
  ...
  if (rot_angle != (double )0) {
    ...
    } printf("<This branch (L825) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (group_shape == 2) {
...
{ 
  ...
  *unit_ptr = 0;
  ...
  if (tmp___1 == 0) {
    ...
    if (tmp___0 == 0) {
       printf("<This branch (L918) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      tmp = GetKeyword(Keywords[64], curr_ptr);
      }
      if (tmp == 0) {
         printf("<This branch (L924) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        return (1);
      }
    }
  }
   printf("<This branch (L930) is removed by Cov debloating tool>\n"); exit(6);
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L948) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
             ...
             int *angle_unit_ptr ) 
{
 ...
 printf("<This branch (L1041) is removed by Cov debloating tool>\n"); exit(6);
}
int anglerot(struct charac *p1 , struct charac **pp2 , double *angle_start_ptr , double *angle_step_ptr ,
             int *angle_unit_ptr ) 
{ 
            ...
            double *pstep_ptr , double *qstep_ptr , int *pqstep_unit_ptr ) 
{
 ...
 printf("<This branch (L1137) is removed by Cov debloating tool>\n"); exit(6);
}
int angunit(struct charac *p1 , struct charac **pp2 , int *angle_unit_ptr ) 
{ 
  struct charac *curr ;
            ...
            double *theta_ptr , double *phi_ptr , int *angle_unit_ptr ) 
{
 ...
 printf("<This branch (L1261) is removed by Cov debloating tool>\n"); exit(6);
}
int blockdef(struct charac *p1 , struct charac **pp2 , struct Node **node_ptr ) 
{ 
  struct charac *curr ;
  ...
  *node_ptr = (struct Node *)((void *)0);
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L1307) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if ((unsigned long )app_ptr == (unsigned long )((void *)0)) {
    ...
    } printf("<This branch (L1353) is removed by Cov debloating tool>\n"); exit(6);
  }
  app_ptr->PCOORD = pcoord;
  app_ptr->QCOORD = qcoord;
  app_ptr->THEA = (double )0;
...
{ 
  ...
  *direction_ptr = 0;
  ...
  if (error != 0) {
     printf("<This branch (L1384) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L1420) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L1431) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
int cosinus(struct charac *p1 , struct charac **pp2 , double *exp_ptr ) 
{
 ...
 printf("<This branch (L1470) is removed by Cov debloating tool>\n"); exit(6);
}
double dacos(double x ) 
{
 ...
 printf("<This branch (L1481) is removed by Cov debloating tool>\n"); exit(6);
}
double dasin(double x ) 
{
...
{ 
  ...
  {
  if (a > b) {
     printf("<This branch (L1549) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    return (b);
  }
}
...
double doubmin(double a , double b ) 
{
 ...
 printf("<This branch (L1565) is removed by Cov debloating tool>\n"); exit(6);
}
int doubstep(struct charac *p1 , struct charac **pp2 , double *pstep_ptr , double *qstep_ptr ,
             int *pqstep_unit_ptr ) 
{ 
...
int extmod(struct charac *p1 , struct charac **pp2 ) 
{
 ...
 printf("<This branch (L1833) is removed by Cov debloating tool>\n"); exit(6);
}
int extremes(struct Geomnode *gnode_ptr , int *pnum_ptr , int *qnum_ptr ) 
{
...
{ 
  ...
  if (elem_ptr->GEOMETRY == 1) {
   ...
   printf("<This branch (L2181) is removed by Cov debloating tool>\n"); exit(6);
  case_0: ;/* CIL Label */ 
  {
...
{ 
  ...
  if (grid->PSTEP == (double )0) {
     ...
     printf("<This branch (L2294) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if ((group_ptr->GRPHAEXC_PTR)->TYPE == 3) {
     ...
     printf("<This branch (L2301) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    {
  ...
  if (elem->GEOMETRY != 1) {
    ...
    } printf("<This branch (L2352) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (grid->PSTEP == (double )0) {
    grid->PSTEP = elem->PDIM;
   ...
   printf("<This branch (L2362) is removed by Cov debloating tool>\n"); exit(6);
  }
...
{ 
  ...
  {
  if (grid->TYPE == 4) {
     printf("<This branch (L2631) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (grid->TYPE == 0) {
    goto case_0;
  }
  ...
  if (grid->TYPE == 2) {
   ...
   printf("<This branch (L2642) is removed by Cov debloating tool>\n"); exit(6);
  ...
  if (pstep != (double )0) {
    ...
    } printf("<This branch (L2678) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    qstep = (double )0;
  }
  angle = (double )60;
...
int gainval(struct charac *p1 , struct charac **pp2 , double *gain_ptr , int *gain_unit_ptr ) 
{
 ...
 printf("<This branch (L2834) is removed by Cov debloating tool>\n"); exit(6);
}
int gaussel(struct charac *p1 , struct charac **pp2 , double *anglee_ptr , double *angleh_ptr ,
            int *angle_unit_ptr , double *tapere_ptr , double *taperh_ptr , int *taper_unit_ptr ) 
{
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L2935) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  *geometry_ptr = 0;
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L2949) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  *geometry_ptr = 1;
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L2981) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (*ureal_ptr < (double )0) {
     printf("<This branch (L2984) is removed by Cov debloating tool>\n"); exit(6);
  }
  *pp2 = *curr_ptr;
  return (0);
}
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (((int const   )*(*tmp + (int )ch) & 2048) == 0) {
    if ((int )ch != 43) {
      if ((int )ch != 45) {
         printf("<This branch (L3011) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
  }
  {
  ...
  while (1) {
    ...
    if ((int const   )*(*tmp___0 + (int )ch) & 2048) {
      if (! ((unsigned long )*curr_ptr != (unsigned long )((void *)0))) {
         printf("<This branch (L3028) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      goto while_break;
    }
  ...
  if (i >= 5) {
    {
     ...
     printf("<This branch (L3048) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    num[i] = (char )'\000';
  }
  {
  ...
  *curr_ptr = *tp;
  ...
  while (1) {
    ...
    if ((int )ch == 95) {
      ...
      if (i < 20) {
        if (! ((unsigned long )*curr_ptr != (unsigned long )((void *)0))) {
           printf("<This branch (L3089) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
         printf("<This branch (L3092) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      goto while_break;
    }
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (*val_ptr < 0) {
     printf("<This branch (L3137) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (*val_ptr == 0) {
     printf("<This branch (L3140) is removed by Cov debloating tool>\n"); exit(6);
  }
  *natur_ptr = *val_ptr;
  *pp2 = *curr_ptr;
  return (0);
...
{ 
  ...
  *curr_ptr = *tp;
  ...
  while (1) {
    ...
    if ((int )ch == 101) {
       printf("<This branch (L3192) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if ((int )ch == 69) {
       printf("<This branch (L3195) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if ((int )ch == 45) {
      _L: ;
      if (! ((unsigned long )*curr_ptr != (unsigned long )((void *)0))) {
  ...
  if (i >= 100) {
     printf("<This branch (L3220) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    num[i] = (char )'\000';
  }
  {
...
{ 
  ...
  *curr_ptr = *tp;
  ...
  while (1) {
    ...
    if (tmp) {
      ...
      if ((int const   )*(*tmp___0 + (int )ch) & 2048) {
        _L: ;
        if (! ((unsigned long )*curr_ptr != (unsigned long )((void *)0))) {
           printf("<This branch (L3265) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
        goto while_break;
      }
  ...
  if (i >= 100) {
     printf("<This branch (L3282) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    *(word + i) = (char )'\000';
  }
  if (i > 100) {
    ...
    } printf("<This branch (L3289) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  tmp___1 = strlen((char const   *)word);
  }
  if (tmp___1 == 0UL) {
     printf("<This branch (L3295) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  tmp___2 = isletter(*(word + 0));
  }
  if (tmp___2 == 0) {
     printf("<This branch (L3301) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L3329) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (*val_ptr < (double )0) {
     printf("<This branch (L3332) is removed by Cov debloating tool>\n"); exit(6);
  }
  *ureal_ptr = *val_ptr;
  *pp2 = *curr_ptr;
  return (0);
...
void gnodevis(int p , int q , double angle , double phase , struct Geomnode *gnode_list_start_ptr ) 
{
 ...
 printf("<This branch (L3373) is removed by Cov debloating tool>\n"); exit(6);
}
int gnodfind(struct Geomnode *gnode_list_start_ptr , struct Geomnode **gnode_ptr ,
             int p , int q ) 
{
  ...
  if (error == 0) {
    ...
    *grampexc_ptr = (struct GrAmpExc *)tmp;
    ...
    if ((unsigned long )*grampexc_ptr == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L3464) is removed by Cov debloating tool>\n"); exit(6);
    }
    (*grampexc_ptr)->TYPE = 0;
...
{ 
  ...
  *elem_ptr = (struct Elem *)((void *)0);
  ...
  if (error == 1) {
     printf("<This branch (L3526) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 17) {
    {
  ...
  if (error == 1) {
    {
     ...
     printf("<This branch (L3541) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 17) {
    {
    printf((char const   * __restrict  )"\n%s", ErrorMessages[24]);
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L3624) is removed by Cov debloating tool>\n"); exit(6);
  }
  *app_ptr = *addrem_ptr;
...
{ 
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L3715) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error != 0) {
    {
    grid_type = 1;
    ...
    if (error == 17) {
      {
       ...
       printf("<This branch (L3740) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  if (error != 0) {
    {
     ...
     printf("<This branch (L3755) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error != 0) {
    {
  ...
  *grid_ptr = (struct Grid *)tmp;
  ...
  if ((unsigned long )*grid_ptr == (unsigned long )((void *)0)) {
    ...
    } printf("<This branch (L3772) is removed by Cov debloating tool>\n"); exit(6);
  }
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     ...
     printf("<This branch (L3837) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (tmp != 0) {
    {
     ...
     printf("<This branch (L3846) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (tmp___0) {
    {
     ...
     printf("<This branch (L3855) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  InserUN(groupname);
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L3896) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  *group_ptr = (struct Group *)tmp___1;
  ...
  if ((unsigned long )*group_ptr == (unsigned long )((void *)0)) {
    ...
    } printf("<This branch (L3906) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error == 0) {
    ...
    *grphaexc_ptr = (struct GrPhaExc *)tmp;
    ...
    if ((unsigned long )*grphaexc_ptr == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L4019) is removed by Cov debloating tool>\n"); exit(6);
    }
    (*grphaexc_ptr)->TYPE = 0;
  ...
  if (error == 0) {
    ...
    *grphaexc_ptr = (struct GrPhaExc *)tmp___0;
    ...
    if ((unsigned long )*grphaexc_ptr == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L4048) is removed by Cov debloating tool>\n"); exit(6);
    }
    (*grphaexc_ptr)->TYPE = 1;
  ...
  if (error == 0) {
    ...
    *grphaexc_ptr = (struct GrPhaExc *)tmp___1;
    ...
    if ((unsigned long )*grphaexc_ptr == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L4082) is removed by Cov debloating tool>\n"); exit(6);
    }
    (*grphaexc_ptr)->TYPE = 3;
...
{ 
  ...
  *node_ptr = (struct Node *)((void *)0);
  ...
  if (error != 0) {
     printf("<This branch (L4249) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  error = nodecoor(*curr_ptr, curr_ptr, pcoord_ptr, qcoord_ptr);
  }
  if (error == 1) {
    {
     ...
     printf("<This branch (L4258) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 17) {
    {
...
{ 
  ...
  *pstep_unit_ptr = 0;
  ...
  if (error != 0) {
     printf("<This branch (L4303) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L4320) is removed by Cov debloating tool>\n"); exit(6);
  }
  *pp2 = *curr_ptr;
  return (0);
}
...
{ 
  ...
  if (tmp == 0UL) {
    ...
    } printf("<This branch (L4376) is removed by Cov debloating tool>\n"); exit(6);
  }
  i = 0;
  {
  while (1) {
...
void interror(char *subname ) 
{
 ...
 printf("<This branch (L4416) is removed by Cov debloating tool>\n"); exit(6);
}
int intmax(int a , int b ) 
{ 
...
{ 
  ...
  if (tmp == 0UL) {
    ...
    } printf("<This branch (L4456) is removed by Cov debloating tool>\n"); exit(6);
  }
  i = 0;
  {
  while (1) {
    ...
    if (tmp___0 == 0) {
       printf("<This branch (L4469) is removed by Cov debloating tool>\n"); exit(6);
    }
    i ++;
  }
  while_break: ;/* CIL Label */ ;
...
{ 
  ...
  if ((int )ch == 45) {
     printf("<This branch (L4493) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    return (0);
  }
  }
...
{ 
  ...
  *unit = 0;
  ...
  if (tmp___2 == 0) {
     printf("<This branch (L4688) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    {
    tmp___1 = GetKeyword(Keywords[7], curr_ptr);
    }
    if (tmp___1 == 0) {
       printf("<This branch (L4694) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      tmp___0 = GetKeyword(Keywords[8], curr_ptr);
      }
      if (tmp___0 == 0) {
         printf("<This branch (L4700) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        {
        tmp = GetKeyword(Keywords[9], curr_ptr);
        }
        if (tmp == 0) {
           printf("<This branch (L4706) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          return (14);
        }
      }
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L5211) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
{ 
  ...
  if (error == 1) {
    {
     ...
     printf("<This branch (L5270) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 17) {
    {

    }
     printf("<This branch (L5276) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 0) {
    {
  ...
  *node_ptr = (struct Node *)tmp;
  ...
  if ((unsigned long )*node_ptr == (unsigned long )((void *)0)) {
    ...
    } printf("<This branch (L5300) is removed by Cov debloating tool>\n"); exit(6);
  }
  (*node_ptr)->NEXT = (struct Node *)((void *)0);
  (*node_ptr)->PCOORD = pcoord;
  (*node_ptr)->QCOORD = qcoord;
    ...
    while (1) {
      ...
      if ((unsigned long )p != (unsigned long )((void *)0)) {
        if (! (p->LINE_NUM == err_ptr->LINE_NUM)) {
         ...
         printf("<This branch (L5426) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L5648) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  *polarization_ptr = 1;
  ...
  if (error == 0) {
   ...
   printf("<This branch (L5658) is removed by Cov debloating tool>\n"); exit(6);
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L5765) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L5774) is removed by Cov debloating tool>\n"); exit(6);
  }
  *pp2 = *curr_ptr;
  return (0);
}
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L5839) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  *omit_pol_ptr = 0;
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L5863) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L5889) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L5954) is removed by Cov debloating tool>\n"); exit(6);
  }
  n = 1;
  {
  while (1) {
    ...
    if ((unsigned long )app_ptr == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L5971) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L6028) is removed by Cov debloating tool>\n"); exit(6);
  }
  *pp2 = *curr_ptr;
  return (0);
}
             ...
             struct Geomnode **qmin_ptr , struct Geomnode **qmax_ptr ) 
{
 ...
 printf("<This branch (L6086) is removed by Cov debloating tool>\n"); exit(6);
}
void prnfile(struct charac *firstel ) 
{ 
  struct charac *p ;
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L6150) is removed by Cov debloating tool>\n"); exit(6);
  }
  *pp2 = *curr_ptr;
  return (0);
}
      ...
      if ((unsigned long )p == (unsigned long )((void *)0)) {
        {
         ...
         printf("<This branch (L6314) is removed by Cov debloating tool>\n"); exit(6);
      }
      p->info = (char )' ';
      p->LINE_NUM = line_num;
      p->PREV = *lastel;
      ...
      if ((unsigned long )p == (unsigned long )((void *)0)) {
        {
         ...
         printf("<This branch (L6331) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
      p->info = c;
      p->LINE_NUM = line_num;
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L6423) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L6434) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
             ...
             double *p2_et_ptr , double *q1_et_ptr , double *q2_et_ptr , int *amp_unit_ptr ) 
{
 ...
 printf("<This branch (L6666) is removed by Cov debloating tool>\n"); exit(6);
}
double secorder(double a , double b , double c , double d , double e , double x ,
                double y ) 
{
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L6706) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
              ...
              struct Geomnode *g ) 
{
 ...
 printf("<This branch (L6982) is removed by Cov debloating tool>\n"); exit(6);
}
int serotdir(struct charac *p1 , struct charac **pp2 , int *direction_ptr ) 
{ 
  struct charac *curr ;
  ...
  *curr_ptr = p1;
  ...
  if (error == 0) {
     ...
     printf("<This branch (L7008) is removed by Cov debloating tool>\n"); exit(6);
  }
  return (1);
}
}
...
{ 
  ...
  *omit_phase_ptr = 0;
  ...
  if (error == 17) {
     printf("<This branch (L7030) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 1) {
    *omit_phase_ptr = 1;
    return (1);
  ...
  *omit_phase_ptr = 0;
  ...
  if (error == 17) {
     printf("<This branch (L7041) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 1) {
    *omit_phase_ptr = 1;
    *pp2 = *curr_ptr;
  ...
  while (1) {
    ...
    while (1) {
      ...
      if ((unsigned long )app_ptr == (unsigned long )((void *)0)) {
        ...
        } printf("<This branch (L7342) is removed by Cov debloating tool>\n"); exit(6);
      }
...
{ 
  ...
  if (group_shape == 3) {
    ...
    } printf("<This branch (L7440) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (group_shape == 2) {
...
{ 
  ...
  if (group_ptr->SHAPE == 5) {
   ...
   printf("<This branch (L7560) is removed by Cov debloating tool>\n"); exit(6);
...
int sgrrot(struct Geomnode *start_ptr , double XC , double YC , double phi ) 
{
 ...
 printf("<This branch (L7708) is removed by Cov debloating tool>\n"); exit(6);
}
int simamp(struct Group *group_ptr ) 
{ 
  int error ;
  ...
  if (error != 0) {
    {
     ...
     printf("<This branch (L7764) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    return (0);
  }
}
  ...
  if (error == 17) {
    {
     ...
     printf("<This branch (L7953) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error == 1) {
    *polarization_ptr = 0;
    *phepol_ptr = (double )90;
...
{ 
  ...
  *step_unit_ptr = 0;
  ...
  if (error != 0) {
     ...
     printf("<This branch (L8033) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
{ 
  ...
  *pstep_unit_ptr = 0;
  ...
  if (error == 1) {
     ...
     printf("<This branch (L8070) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (error != 0) {
    {
             ...
             double *py_ptr , double *qx_ptr , double *qy_ptr , int *pqxy_unit_ptr ) 
{
 ...
 printf("<This branch (L8173) is removed by Cov debloating tool>\n"); exit(6);
}
void unaminit(void) 
{ 
  char i ;
...
{ 
  ...
  *curr_ptr = p1;
  ...
  if (error != 0) {
     printf("<This branch (L8211) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (error != 0) {
     ...
     printf("<This branch (L8218) is removed by Cov debloating tool>\n"); exit(6);
  }
  *pp2 = *curr_ptr;
  return (0);
}
...
int uvdir(struct charac *p1 , struct charac **pp2 , double *u_ptr , double *v_ptr ) 
{
 ...
 printf("<This branch (L8296) is removed by Cov debloating tool>\n"); exit(6);
}
int uvval(struct charac *p1 , struct charac **pp2 , double *val_ptr ) 
{
            ...
            double *qx_ptr , double *qy_ptr , int *pqxy_unit_ptr ) 
{
 ...
 printf("<This branch (L8443) is removed by Cov debloating tool>\n"); exit(6);
}
void waitcont(void) 
{ 
