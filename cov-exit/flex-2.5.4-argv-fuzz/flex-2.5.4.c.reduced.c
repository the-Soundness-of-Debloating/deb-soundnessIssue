...
{ 
  ...
  while (1) {
    ...
    if (! *(rule_useful + i___0)) {
      if (i___0 != default_rule) {
        ...
        } printf("<This branch (L469) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    i___0 ++;
  }
  ...
  if (spprdflt) {
     ...
     printf("<This branch (L483) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  make_tables();
  flexend(0);
...
{ 
  ...
  if (lex_compat) {
    if (C_plus_plus) {
      ...
      } printf("<This branch (L504) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (fulltbl) {
      {

      } printf("<This branch (L509) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if (fullspd) {
      {

      } printf("<This branch (L514) is removed by Cov debloating tool>\n"); exit(6);
    }
    }
  ...
  if (fullspd) {
    ...
    if (usemecs) {
      ...
      } printf("<This branch (L561) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (interactive) {
      {

      } printf("<This branch (L566) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (lex_compat) {
      {

      } printf("<This branch (L571) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (do_yylineno) {
      {

      } printf("<This branch (L576) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (fulltbl) {
      if (fullspd) {
        {

        } printf("<This branch (L582) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
  }
  }
  if (C_plus_plus) {
     ...
     printf("<This branch (L592) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (C_plus_plus) {
     ...
     printf("<This branch (L600) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (useecs) {
    ecgroup[1] = 0;
    i___0 = 2;
  ...
  if (! use_stdout) {
    if (! did_outfilename) {
      if (C_plus_plus) {
         printf("<This branch (L636) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        suffix = (char *)"c";
      }
      {
    ...
    if ((unsigned long )prev_stdout == (unsigned long )((void *)0)) {
      ...
      } printf("<This branch (L653) is removed by Cov debloating tool>\n"); exit(6);
    }
    outfile_created = 1;
  }
  if (skelname) {
    {
     ...
     printf("<This branch (L665) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (tmp) {
    ...
    } printf("<This branch (L709) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (did_outfilename) {
    {
...
{ 
  ...
  if ((unsigned long )skelfile != (unsigned long )((void *)0)) {
    {
     ...
     printf("<This branch (L753) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (exit_status != 0) {
     ...
     printf("<This branch (L783) is removed by Cov debloating tool>\n"); exit(6);
  }
  ...
  if (printstats) {
    ...
    } printf("<This branch (L1077) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  exit(exit_status);
  }
  ...
  *(action_array + 0) = (char )'\000';
  ...
  if ((int )*(program_name + 0) != 0) {
    ...
    if ((int )*(program_name + (tmp___0 - 1UL)) == 43) {
       printf("<This branch (L1148) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  argv ++;
  argc --;
  ...
  while (1) {
    while_continue: ;/* CIL Label */ ;
    if (! argc) {
       printf("<This branch (L1159) is removed by Cov debloating tool>\n"); exit(6);
    }
    arg = *(argv + 0);
    if ((int )*(arg + 0) != 45) {
      goto while_break;
    ...
    if ((int )*(arg + 1) == 0) {
       printf("<This branch (L1166) is removed by Cov debloating tool>\n"); exit(6);
    }
    }
    if ((int )*(arg + 1) == 45) {
      {
       ...
       printf("<This branch (L1191) is removed by Cov debloating tool>\n"); exit(6);
    }
    i___0 = 1;
    {
    while (1) {
      ...
      if ((int )*(arg + i___0) == 99) {
         printf("<This branch (L1211) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int )*(arg + i___0) == 67) {
        goto case_67;
      }
      ...
      if ((int )*(arg + i___0) == 104) {
         printf("<This branch (L1229) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int )*(arg + i___0) == 73) {
         printf("<This branch (L1232) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int )*(arg + i___0) == 105) {
         printf("<This branch (L1235) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int )*(arg + i___0) == 108) {
        goto case_108;
      }
      if ((int )*(arg + i___0) == 76) {
         printf("<This branch (L1241) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      if (i___0 != 1) {
        ...
        } printf("<This branch (L1298) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (! sawcmpflag) {
        useecs = 0;
        usemecs = 0;
      ...
      while (1) {
        ...
        if ((int )*(arg + i___0) == 70) {
           printf("<This branch (L1321) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int )*(arg + i___0) == 102) {
          goto case_102;
        }
        ...
        if ((int )*(arg + i___0) == 114) {
         ...
         printf("<This branch (L1332) is removed by Cov debloating tool>\n"); exit(6);
        case_97: ;/* CIL Label */ 
        long_align = 1;
  ...
  if (num_input_files > 0) {
    tmp___4 = *(input_files + 0);
     ...
     printf("<This branch (L1475) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  ...
  if (backing_up_report) {
    {
     ...
     printf("<This branch (L1569) is removed by Cov debloating tool>\n"); exit(6);
  } else {
  ...
  if (C_plus_plus) {
    {
     ...
     printf("<This branch (L1748) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    if (yytext_is_array) {
      {
    ...
    if (yyclass) {
      ...
      } printf("<This branch (L1763) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  if (useecs) {
    {
  ...
  if (! reject) {
    if (! (dfaacc + ds)->dfaacc_state) {
      ...
      if (backing_up_report) {
        ...
        } printf("<This branch (L2134) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
  }
  }
...
void dump_transitions(FILE *file , int *state ) 
{
 ...
 printf("<This branch (L2312) is removed by Cov debloating tool>\n"); exit(6);
}
  ...
  while (1) {
    ...
    if (! (*(trans1 + ns) < 0)) {
      ...
      if (stkend >= current_max_dfa_size) {
        ...
        } printf("<This branch (L2370) is removed by Cov debloating tool>\n"); exit(6);
      }
      *(stk + stkend) = ns;
      *(trans1 + ns) -= 32001;
      ...
      if (tsp != 0) {
        if (! (*(trans1 + tsp) < 0)) {
          ...
          if (stkend >= current_max_dfa_size) {
            ...
            } printf("<This branch (L2407) is removed by Cov debloating tool>\n"); exit(6);
          }
          *(stk + stkend) = tsp;
          *(trans1 + tsp) -= 32001;
          ...
          if (nfaccnum != 0) {
             ...
             printf("<This branch (L2414) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (nfaccnum != 0) {
             printf("<This branch (L2417) is removed by Cov debloating tool>\n"); exit(6);
          } else { //Added block
        ...
        if (tsp != 0) {
          if (! (*(trans1 + tsp) < 0)) {
            ...
            if (stkend >= current_max_dfa_size) {
              ...
              } printf("<This branch (L2449) is removed by Cov debloating tool>\n"); exit(6);
            }
            *(stk + stkend) = tsp;
            *(trans1 + tsp) -= 32001;
            nfaccnum = *(accptnum + tsp);
  ...
  while (1) {
    ...
    if (*(trans1 + *(stk + stkpos)) < 0) {
      *(trans1 + *(stk + stkpos)) += 32001;
      ...
      } printf("<This branch (L2498) is removed by Cov debloating tool>\n"); exit(6);
    }
    stkpos ++;
  }
  while_break___1: ;/* CIL Label */ ;
...
void increase_max_dfas(void) 
{
 ...
 printf("<This branch (L2547) is removed by Cov debloating tool>\n"); exit(6);
}
void ntod(void) 
{ 
  int *accset ;
  ...
  if (trace) {
    ...
    } printf("<This branch (L2626) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  inittbl();
  }
  ...
  if (fulltbl) {
    if (nultrans) {
      num_full_table_rows = numecs;
       ...
       printf("<This branch (L2683) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (long_align) {
       printf("<This branch (L2686) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___2 = "short";
    }
    {
    ...
    if (tmp___3) {
      ...
      if (variable_trailing_context_rules) {
        if (nacc > 0) {
          ...
          } printf("<This branch (L2742) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    i___0 ++;
  ...
  if (! fullspd) {
    ...
    if (! tmp___4) {
      ...
      } printf("<This branch (L2757) is removed by Cov debloating tool>\n"); exit(6);
    }
    numas ++;
    num_start_states ++;
    todo_next ++;
  ...
  while (1) {
    ...
    if (trace) {
      ...
      } printf("<This branch (L2791) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      ...
      if (symlist[sym]) {
        ...
        if (duplist[sym] == 0) {
          ...
          if (trace) {
            ...
            } printf("<This branch (L2841) is removed by Cov debloating tool>\n"); exit(6);
          }
          i___0 = 0;
          {
          while (1) {
...
{ 
    ...
    if (hashval == *(dhash + i___0)) {
      if (numstates == *(dfasiz + i___0)) {
        ...
        while (1) {
          ...
          if (*(sns + j) != *(oldsns + j)) {
             printf("<This branch (L3049) is removed by Cov debloating tool>\n"); exit(6);
          }
          j ++;
        }
        while_break___0: ;/* CIL Label */ ;
        ...
        if (j > numstates) {
         ...
         printf("<This branch (L3060) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        hshsave ++;
      }
    }
  ...
  if (lastdfa >= current_max_dfas) {
    ...
    } printf("<This branch (L3073) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  newds = lastdfa;
      ...
      if (*(cclng + sym)) {
        ...
        *(nset + numstates) = tsp;
        ...
        while (1) {
          ...
          ch = (int )*(ccltbl + (ccllist + j));
          if (ch == 0) {
             printf("<This branch (L3219) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (ch > transsym) {
            goto while_break___1;
          } else { //Added block
    ...
    if (sym >= 65) {
      if (sym <= 90) {
        if (caseins) {
          ...
          } printf("<This branch (L3241) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          goto _L___0;
        }
      } else {
  ...
  while (1) {
    ...
    if (tch != 257) {
      if (tch < - lastccl) {
        ...
        } printf("<This branch (L3313) is removed by Cov debloating tool>\n"); exit(6);
      } else { //Added block
      if (tch >= csize) {
        {

        } printf("<This branch (L3318) is removed by Cov debloating tool>\n"); exit(6);
      }
      }
      if (tch >= 0) {
        {
        ...
        *(symlist + ec) = 1;
        ...
        if (*(cclng + tch)) {
          ...
          while (1) {
            ...
            ich = (int )*(ccltbl + (cclp + k));
            if (ich == 0) {
               printf("<This branch (L3385) is removed by Cov debloating tool>\n"); exit(6);
            }
            *(symlist + ich) = 1;
            k ++;
          }
...
{ 
  ...
  while (1) {
    ...
    if (NUL_mapping) {
      if (cclm == 0) {
         printf("<This branch (L3506) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    oldec = *(bck + cclm);
    newec = cclm;
    ...
    while (1) {
      ...
      if (i___0 != 0) {
        if (! (i___0 <= llsiz)) {
           printf("<This branch (L3518) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
        goto while_break___0;
      }
...
{ 
  ...
  if (fulltbl) {
    ...
    } printf("<This branch (L3758) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    {
  ...
  *(nxt + (tblend + 2)) = 0;
  ...
  while (1) {
    ...
    if (*(chk + i___0) > numecs) {
      ...
      } printf("<This branch (L3852) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if (*(chk + i___0) == 0) {
      {
...
{ 
  ...
  while (1) {
    ...
    if (caseins) {
       ...
       printf("<This branch (L3929) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (ecgroup[i___0] < 0) {
...
{ 
  ...
  end_of_buffer_action = num_rules + 1;
  if (long_align) {
     printf("<This branch (L4111) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    tmp = C_short_decl;
  }
  {
  ...
  while (1) {
    ...
    if (trace) {
       ...
       printf("<This branch (L4136) is removed by Cov debloating tool>\n"); exit(6);
    }
    i___0 ++;
  }
  while_break: ;/* CIL Label */ ;
  ...
  if (useecs) {
    ...
    } printf("<This branch (L4148) is removed by Cov debloating tool>\n"); exit(6);
  }
  return;
}
}
...
{ 
  ...
  if (fulltbl) {
    ...
    if (num_backing_up > 0) {
      ...
      } printf("<This branch (L4214) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    indent_puts((char *)"++yy_cp;");
    }
    if (num_backing_up > 0) {
      ...
      } printf("<This branch (L4222) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    indent_level --;
    outc('\n');
  ...
  if (fullspd) {
    ...
    if (! reject) {
      if (! interactive) {
        ...
        } printf("<This branch (L4285) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
  }
  }
  ...
  if (worry_about_NULs) {
    if (! nultrans) {
      if (useecs) {
        ...
        } printf("<This branch (L4310) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      goto _L;
    }
...
{ 
  ...
  if (need_backing_up) {
    ...
    if (fullspd) {
      ...
      } printf("<This branch (L4414) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if (fulltbl) {
      {
  ...
  if (fulltbl) {
    ...
    } printf("<This branch (L4438) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (fullspd) {
    {
    do_indent();
...
{ 
    ...
    *(accsiz + end_of_buffer_state) = 1;
    ...
    if (numas > 1) {
      tmp___0 = numas;
       ...
       printf("<This branch (L4563) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (long_align) {
      tmp___1 = C_long_decl;
    } else {
  ...
  while (1) {
    ...
    if (! reject) {
      if (trace) {
         ...
         printf("<This branch (L4687) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    i___0 ++;
  }
  ...
  if (usemecs) {
    if (trace) {
      ...
      } printf("<This branch (L4714) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    while (1) {
      ...
      if (trace) {
        ...
        } printf("<This branch (L4735) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tecbck[i___0] < 0) {
  ...
  if (total_states >= 32700) {
     printf("<This branch (L4814) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (long_align) {
    tmp___6 = C_long_decl;
  } else {
  ...
  if (total_states >= 32700) {
     printf("<This branch (L4879) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (long_align) {
    tmp___8 = C_long_decl;
  } else {
...
{ 
  ...
  if (yytext_is_array) {
    ...
    if (yymore_used) {
      ...
      } printf("<This branch (L4999) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  {
  indent_level = 0;
  ...
  if (fullspd) {
    ...
    if (total_table_size >= 32700) {
       printf("<This branch (L5011) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if (long_align) {
       printf("<This branch (L5014) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp = "short";
    }
    }
    ...
    if (long_align) {
      ...
      } printf("<This branch (L5029) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
  ...
  if (yymore_used) {
    ...
    if (yytext_is_array) {
      ...
      } printf("<This branch (L5206) is removed by Cov debloating tool>\n"); exit(6);
    }
  } else {
    {
  ...
  if (yymore_used) {
    if (! yytext_is_array) {
      ...
      } printf("<This branch (L5295) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  {
  skelout();
  ...
  if (ddebug) {
    ...
    if (C_plus_plus) {
       printf("<This branch (L5337) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    ...
    if (C_plus_plus) {
      ...
      } printf("<This branch (L5352) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
  ...
  if (! reject) {
    if (! interactive) {
      ...
      } printf("<This branch (L5459) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      indent_puts((char *)"yy_cp = yy_c_buf_p;");
      }
  ...
  if ((int )tmp > 1024) {
    {
     ...
     printf("<This branch (L5542) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
{ 
  ...
  while (1) {
    ...
    if (! (len + action_index >= action_size - 10)) {
     ...
     printf("<This branch (L5570) is removed by Cov debloating tool>\n"); exit(6);
...
{ 
  ...
  if (! mem) {
    ...
    } printf("<This branch (L5603) is removed by Cov debloating tool>\n"); exit(6);
  }
  return (mem);
}
}
int all_lower(char *str ) 
{
 ...
 printf("<This branch (L5634) is removed by Cov debloating tool>\n"); exit(6);
}
int all_upper(char *str ) 
{
 ...
 printf("<This branch (L5662) is removed by Cov debloating tool>\n"); exit(6);
}
void bubble(int *v , int n ) 
{ 
  register int i___0 ;
...
unsigned char clower(int c ) 
{
 ...
 printf("<This branch (L5745) is removed by Cov debloating tool>\n"); exit(6);
}
char *copy_string(char const   *str ) 
{ 
...
void flexerror(char const   *msg ) 
{
 ...
 printf("<This branch (L5955) is removed by Cov debloating tool>\n"); exit(6);
}
void flexfatal(char const   *msg ) 
{
 ...
 printf("<This branch (L5967) is removed by Cov debloating tool>\n"); exit(6);
}
int htoi(unsigned char *str ) 
{
 ...
 printf("<This branch (L5979) is removed by Cov debloating tool>\n"); exit(6);
}
void lerrif(char const   *msg , int arg ) 
{
 ...
 printf("<This branch (L5991) is removed by Cov debloating tool>\n"); exit(6);
}
void lerrsf(char const   *msg , char const   *arg ) 
{
...
{ 
  ...
  {
  if (! gen_line_dirs) {
     printf("<This branch (L6023) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (do_infile) {
    if (! infilename) {
       printf("<This branch (L6027) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      goto _L;
    }
  } else { //Added block
  ...
  if (! do_infile) {
    if (! outfilename) {
       printf("<This branch (L6035) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  }
  if (do_infile) {
  ...
  while (1) {
    ...
    if ((int )*s1 == 92) {
       ...
       printf("<This branch (L6059) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___0 = s2;
    s2 ++;
    tmp___1 = s1;
...
{ 
  ...
  if ((int )*(array + 1) == 114) {
     printf("<This branch (L6213) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 116) {
    goto case_116;
  }
  if ((int )*(array + 1) == 97) {
     printf("<This branch (L6219) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 118) {
     printf("<This branch (L6222) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 48) {
     printf("<This branch (L6225) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 49) {
     printf("<This branch (L6228) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 50) {
  ...
  if ((int )*(array + 1) == 53) {
     printf("<This branch (L6240) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 54) {
     printf("<This branch (L6243) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 55) {
     printf("<This branch (L6246) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((int )*(array + 1) == 120) {
     printf("<This branch (L6249) is removed by Cov debloating tool>\n"); exit(6);
  }
  goto switch_default;
  case_98: ;/* CIL Label */ 
...
int otoi(unsigned char *str ) 
{
 ...
 printf("<This branch (L6343) is removed by Cov debloating tool>\n"); exit(6);
}
void out(char const   *str ) 
{ 
...
char *readable_form(int c ) 
{
 ...
 printf("<This branch (L6553) is removed by Cov debloating tool>\n"); exit(6);
}
void *reallocate_array(void *array , int size , size_t element_size ) 
{ 
  ...
  if (! new_array) {
    ...
    } printf("<This branch (L6568) is removed by Cov debloating tool>\n"); exit(6);
  }
  return (new_array);
}
}
...
{ 
    ...
    if (*(trans1 + i___0) != 0) {
      {
       ...
       printf("<This branch (L6847) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  if (state == 0) {
    ...
    } printf("<This branch (L6857) is removed by Cov debloating tool>\n"); exit(6);
  }
...
{ 
  ...
  if (*(state_type + mach) == 2) {
   ...
   printf("<This branch (L6979) is removed by Cov debloating tool>\n"); exit(6);
  case_1: ;/* CIL Label */ 
  ...
  *(state_type + mach) = 1;
  if (*(transchar + mach) == 257) {
     ...
     printf("<This branch (L6994) is removed by Cov debloating tool>\n"); exit(6);
  }
  goto switch_break;
  switch_default: ;/* CIL Label */ 
  {
...
{ 
  ...
  {
  if (first == 0) {
     printf("<This branch (L7013) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (second == 0) {
      ...
      if (*(trans1 + *(finalst + first)) == 0) {
        if (*(accptnum + *(finalst + first)) == 0) {
          ...
          mkxtion(*(finalst + second), orend);
           ...
           printf("<This branch (L7091) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
      ...
      if (useecs) {
        if (sym) {
          tmp___8 = sym;
           ...
           printf("<This branch (L7280) is removed by Cov debloating tool>\n"); exit(6);
        }
        {
...
{ 
  ...
  if (num_rules > 8191) {
    ...
    } printf("<This branch (L7340) is removed by Cov debloating tool>\n"); exit(6);
  }
  *(rule_linenum + num_rules) = linenum;
...
{ 
  ...
  if ((unsigned long )successor != (unsigned long )((struct hash_entry *)0)) {
     ...
     printf("<This branch (L7779) is removed by Cov debloating tool>\n"); exit(6);
  } else {
...
void scextend(void) 
{
 ...
 printf("<This branch (L7925) is removed by Cov debloating tool>\n"); exit(6);
}
void scinstal(char *str , int xcluflg___0 ) 
{ 
  int tmp ;
  ...
  if (lastsc >= current_max_scs) {
    ...
    } printf("<This branch (L7939) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  *(scname + lastsc) = copy_string((char const   *)str);
  ...
  if (tmp) {
    ...
    } printf("<This branch (L7948) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
int sclookup(char *str ) 
{
 ...
 printf("<This branch (L7968) is removed by Cov debloating tool>\n"); exit(6);
}
    ...
    if (mindiff * 100 > totaltrans * 10) {
      ...
      while (1) {
        ...
        if (d < mindiff) {
           ...
           printf("<This branch (L8037) is removed by Cov debloating tool>\n"); exit(6);
        }
        i___0 = protnext[i___0];
      }
      while_break___0: ;/* CIL Label */ ;
...
{ 
  ...
  if (numtrans > 4) {
    if (tblend < 2) {
       printf("<This branch (L8177) is removed by Cov debloating tool>\n"); exit(6);
    }
    i___0 = tblend - numecs;
  } else {
    i___0 = firstfree;
...
{ 
  ...
  while (1) {
    ...
    if (*(state + minec) != -1) {
      ...
      if (deflink != -32766) {
         printf("<This branch (L8362) is removed by Cov debloating tool>\n"); exit(6);
      }
      }
    }
    minec ++;
  ...
  while (1) {
    while_continue___0: ;/* CIL Label */ ;
    if (! (maxec > 0)) {
       printf("<This branch (L8381) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (*(state + maxec) != -1) {
      if (*(state + maxec) != 0) {
        goto while_break___0;
      ...
      if (deflink != -32766) {
         printf("<This branch (L8388) is removed by Cov debloating tool>\n"); exit(6);
      }
      }
    }
    maxec --;
            ...
            while (1) {
              ...
              if (baseaddr < current_max_xpairs) {
                if (! (*(chk + baseaddr) != 0)) {
                 ...
                 printf("<This branch (L8453) is removed by Cov debloating tool>\n"); exit(6);
              }
              baseaddr ++;
            }
            while_break___5: ;/* CIL Label */ ;
  ...
  while (1) {
    ...
    if (*(state + i___0) != -1) {
      ...
      if (deflink != -32766) {
         ...
         printf("<This branch (L8517) is removed by Cov debloating tool>\n"); exit(6);
      }
      }
    }
    i___0 ++;
...
{ 
  ...
  while (1) {
    ...
    if (firstfree >= current_max_xpairs) {
      ...
      } printf("<This branch (L8564) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  while_break: ;/* CIL Label */ ;
  }
  ...
  *(nxt + firstfree) = onenxt;
  if (firstfree > tblend) {
    ...
    if (firstfree >= current_max_xpairs) {
      ...
      } printf("<This branch (L8580) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
  return;
}
...
{ 
  ...
  if (tmpbase + numecs >= current_max_template_xpairs) {
    ...
    } printf("<This branch (L8651) is removed by Cov debloating tool>\n"); exit(6);
  }
  i___0 = 1;
  {
  while (1) {
...
{ 
  ...
  if (onesp >= 499) {
    ...
    } printf("<This branch (L8752) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    onesp ++;
...
{ 
  ...
  {
  if (eofseen) {
     printf("<This branch (L8809) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    {
    toktype = flexscan();
    }
  ...
  if (toktype == -1) {
     printf("<This branch (L8816) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (toktype == 0) {
    _L: ;
    eofseen = 1;
    if (sectnum == 1) {
      ...
      } printf("<This branch (L8826) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      toktype = 0;
    }
  }
  ...
  if (trace) {
    ...
    switch_break: ;/* CIL Label */ ;
    } printf("<This branch (L9191) is removed by Cov debloating tool>\n"); exit(6);
  }
  return (toktype);
}
}
...
{ 
  ...
  *yyssp = (short )yystate;
  if ((unsigned long )yyssp >= (unsigned long )((yyss + yystacksize) - 1)) {
...

    {
     ...
     printf("<This branch (L9569) is removed by Cov debloating tool>\n"); exit(6);
  }
  goto yybackup;
  yybackup: ;
  ...
  if ((unsigned int )yychar <= 280U) {
    yychar1 = (int )yytranslate[yychar];
     ...
     printf("<This branch (L9589) is removed by Cov debloating tool>\n"); exit(6);
  }
  }
  yyn += yychar1;
  if (yyn < 0) {
     printf("<This branch (L9594) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (yyn > 110) {
     printf("<This branch (L9597) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  ...
  if (yyn < 0) {
    if (yyn == -32768) {
       printf("<This branch (L9607) is removed by Cov debloating tool>\n"); exit(6);
    }
    yyn = - yyn;
    goto yyreduce;
  } else { //Added block
  if (yyn == 0) {
     printf("<This branch (L9613) is removed by Cov debloating tool>\n"); exit(6);
  }
  }
  if (yyn == 107) {
    goto yyacceptlab;
  ...
  *yyvsp = yylval;
  if (yyerrstatus) {
     printf("<This branch (L9625) is removed by Cov debloating tool>\n"); exit(6);
  }
  yystate = yyn;
  goto yynewstate;
  yydefault: ;
  ...
  if (yyn == 0) {
     printf("<This branch (L9632) is removed by Cov debloating tool>\n"); exit(6);
  }
  yyreduce: ;
  yylen = (int )yyr2[yyn];
  if (yylen > 0) {
  ...
  if (yyn == 6) {
     printf("<This branch (L9647) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 7) {
    goto case_7;
  }
  if (yyn == 8) {
     printf("<This branch (L9653) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 9) {
     printf("<This branch (L9656) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 10) {
     printf("<This branch (L9659) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 11) {
     printf("<This branch (L9662) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 12) {
     printf("<This branch (L9665) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 16) {
     printf("<This branch (L9668) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 17) {
     printf("<This branch (L9671) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 18) {
     printf("<This branch (L9674) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 19) {
    goto case_19;
  }
  if (yyn == 20) {
     printf("<This branch (L9680) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 22) {
    goto case_22;
  }
  ...
  if (yyn == 25) {
     printf("<This branch (L9692) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 26) {
  ...
  if (yyn == 28) {
     printf("<This branch (L9701) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 29) {
  ...
  if (yyn == 34) {
     printf("<This branch (L9713) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 35) {
    goto case_35;
  }
  if (yyn == 36) {
     printf("<This branch (L9719) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 37) {
    goto case_37;
  }
  ...
  if (yyn == 63) {
     printf("<This branch (L9800) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 64) {
     printf("<This branch (L9803) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 65) {
     printf("<This branch (L9806) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 66) {
     printf("<This branch (L9809) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 67) {
     printf("<This branch (L9812) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 68) {
     printf("<This branch (L9815) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yyn == 69) {
  ...
  if (scon_stk_ptr > 0) {
    ...
    while_break___0: ;/* CIL Label */ ;
    } printf("<This branch (L9968) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    i = 1;
    {
    while (1) {
  ...
  if (scon_stk_ptr > 0) {
    ...
    while_break___2: ;/* CIL Label */ ;
    } printf("<This branch (L10015) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    i = 1;
    {
    while (1) {
  ...
  if (previous_continued_action) {
     ...
     printf("<This branch (L10174) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (lex_compat) {
    {
  ...
  if (varlength) {
     ...
     printf("<This branch (L10190) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    trailcnt = rulelen;
  }
  }
  ...
  if (trlcontxt) {
    ...
    } printf("<This branch (L10214) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  if (previous_continued_action) {
    {


    } printf("<This branch (L10220) is removed by Cov debloating tool>\n"); exit(6);
  }
  }
  if (lex_compat) {
    {
  ...
  if (varlength) {
    ...
    } printf("<This branch (L10233) is removed by Cov debloating tool>\n"); exit(6);
  }
  }
  {
  trlcontxt = 1;
  ...
  if (trlcontxt) {
     ...
     printf("<This branch (L10259) is removed by Cov debloating tool>\n"); exit(6);
  }
  goto switch_break;
  case_39: ;/* CIL Label */ 
  {
  ...
  if (trlcontxt) {
    ...
    } printf("<This branch (L10275) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    trlcontxt = 1;
  }
  if (varlength) {
  ...
  if (*(yyvsp + -3) == 0) {
     ...
     printf("<This branch (L10339) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    {
  ...
  if (*(yyvsp + -1) <= 0) {
    ...
    } printf("<This branch (L10367) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    {
  ...
  if (caseins) {
     ...
     printf("<This branch (L10434) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  yyval = mkstate(*(yyvsp + 0));
  }
  ...
  if (caseins) {
     ...
     printf("<This branch (L10466) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (*(yyvsp + -2) > *(yyvsp + 0)) {
    {

    } printf("<This branch (L10471) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    i = *(yyvsp + -2);
    {
    while (1) {
    ...
    if (cclsorted) {
      if (*(yyvsp + -2) > lastchar) {
       ...
       printf("<This branch (L10494) is removed by Cov debloating tool>\n"); exit(6);
    }
    cclsorted = tmp___10;
    lastchar = *(yyvsp + 0);
  }
  ...
  if (caseins) {
     ...
     printf("<This branch (L10852) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  rulelen ++;
  ...
  *yyvsp = yyval;
  ...
  if (yystate >= 0) {
    if (yystate <= 110) {
      if ((int const   )yycheck[yystate] == (int const   )*yyssp) {
       ...
       printf("<This branch (L10881) is removed by Cov debloating tool>\n"); exit(6);
    }
  } else {
    yystate = (int )yydefgoto[yyn - 48];
  }
  ...
  if (yyfree_stacks) {
    ...
    } printf("<This branch (L10952) is removed by Cov debloating tool>\n"); exit(6);
  }
  return (0);
  yyabortlab: ;
...
void build_eof_action(void) 
{
 ...
 printf("<This branch (L11001) is removed by Cov debloating tool>\n"); exit(6);
}
void format_synerr(char *msg , char *arg ) 
{
 ...
 printf("<This branch (L11013) is removed by Cov debloating tool>\n"); exit(6);
}
void synerr(char *str ) 
{
...
void format_warn(char *msg , char *arg ) 
{
 ...
 printf("<This branch (L11037) is removed by Cov debloating tool>\n"); exit(6);
}
void warn(char *str ) 
{
...
void format_pinpoint_message(char *msg , char *arg ) 
{
 ...
 printf("<This branch (L11060) is removed by Cov debloating tool>\n"); exit(6);
}
void pinpoint_message(char *str ) 
{
 ...
 printf("<This branch (L11071) is removed by Cov debloating tool>\n"); exit(6);
}
void line_warning(char *str , int line ) 
{ 
  char warning[2048] ;
...
void yyerror(char *msg ) 
{
 ...
 printf("<This branch (L11106) is removed by Cov debloating tool>\n"); exit(6);
}
int yyleng  ;
FILE *yyout ;
...
{ 
  ...
  while (1) {
    ...
    *yy_cp = (char )'\000';
    ...
    {
    if (yy_act == 0) {
       printf("<This branch (L13351) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 1) {
       printf("<This branch (L13354) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 2) {
      goto case_2;
    }
    ...
    if (yy_act == 4) {
       printf("<This branch (L13363) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 5) {
       printf("<This branch (L13366) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 6) {
      goto case_6;
    }
    if (yy_act == 7) {
       printf("<This branch (L13372) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 8) {
      goto case_8;
    }
    ...
    if (yy_act == 10) {
       printf("<This branch (L13381) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 11) {
       printf("<This branch (L13384) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 12) {
       printf("<This branch (L13387) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 13) {
       printf("<This branch (L13390) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 14) {
       printf("<This branch (L13393) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 15) {
      goto case_15;
    }
    if (yy_act == 16) {
       printf("<This branch (L13399) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 17) {
      goto case_17;
    }
    ...
    if (yy_act == 20) {
       printf("<This branch (L13411) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 21) {
      goto case_21;
    }
    if (yy_act == 22) {
       printf("<This branch (L13417) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 23) {
       printf("<This branch (L13420) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 24) {
       printf("<This branch (L13423) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 25) {
       printf("<This branch (L13426) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 26) {
       printf("<This branch (L13429) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 27) {
      goto case_27;
    }
    ...
    if (yy_act == 33) {
       printf("<This branch (L13450) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 34) {
       printf("<This branch (L13453) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 35) {
       printf("<This branch (L13456) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 36) {
       printf("<This branch (L13459) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 37) {
       printf("<This branch (L13462) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 38) {
       printf("<This branch (L13465) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 39) {
       printf("<This branch (L13468) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 40) {
       printf("<This branch (L13471) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 41) {
       printf("<This branch (L13474) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 42) {
       printf("<This branch (L13477) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 43) {
       printf("<This branch (L13480) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 44) {
       printf("<This branch (L13483) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 45) {
       printf("<This branch (L13486) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 46) {
       printf("<This branch (L13489) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 47) {
       printf("<This branch (L13492) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 48) {
       printf("<This branch (L13495) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 49) {
       printf("<This branch (L13498) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 50) {
       printf("<This branch (L13501) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 51) {
       printf("<This branch (L13504) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 52) {
       printf("<This branch (L13507) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 53) {
       printf("<This branch (L13510) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 54) {
       printf("<This branch (L13513) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 55) {
       printf("<This branch (L13516) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 56) {
       printf("<This branch (L13519) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 57) {
       printf("<This branch (L13522) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 58) {
       printf("<This branch (L13525) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 59) {
       printf("<This branch (L13528) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 60) {
       printf("<This branch (L13531) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 61) {
       printf("<This branch (L13534) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 62) {
       printf("<This branch (L13537) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 63) {
       printf("<This branch (L13540) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 64) {
       printf("<This branch (L13543) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 65) {
       printf("<This branch (L13546) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 66) {
       printf("<This branch (L13549) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 67) {
       printf("<This branch (L13552) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 68) {
       printf("<This branch (L13555) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 69) {
       printf("<This branch (L13558) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 70) {
       printf("<This branch (L13561) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 71) {
       printf("<This branch (L13564) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 72) {
       printf("<This branch (L13567) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 73) {
       printf("<This branch (L13570) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 74) {
       printf("<This branch (L13573) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 75) {
       printf("<This branch (L13576) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 76) {
       printf("<This branch (L13579) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 77) {
       printf("<This branch (L13582) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 78) {
       printf("<This branch (L13585) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 79) {
       printf("<This branch (L13588) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 80) {
       printf("<This branch (L13591) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 81) {
       printf("<This branch (L13594) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 82) {
       printf("<This branch (L13597) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 83) {
       printf("<This branch (L13600) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 84) {
       printf("<This branch (L13603) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 85) {
    ...
    if (yy_act == 87) {
       printf("<This branch (L13612) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 88) {
      goto case_88;
    }
    if (yy_act == 169) {
       printf("<This branch (L13618) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 89) {
      goto case_89;
    }
    if (yy_act == 90) {
       printf("<This branch (L13624) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 91) {
       printf("<This branch (L13627) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 92) {
      goto case_92;
    }
    ...
    if (yy_act == 96) {
       printf("<This branch (L13642) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 97) {
       printf("<This branch (L13645) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 98) {
    ...
    if (yy_act == 101) {
       printf("<This branch (L13657) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 102) {
       printf("<This branch (L13660) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 103) {
       printf("<This branch (L13663) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 104) {
      goto case_104;
    }
    ...
    if (yy_act == 109) {
       printf("<This branch (L13681) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 110) {
    ...
    if (yy_act == 112) {
       printf("<This branch (L13690) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 113) {
       printf("<This branch (L13693) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 114) {
       printf("<This branch (L13696) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 115) {
      goto case_115;
    }
    ...
    if (yy_act == 117) {
       printf("<This branch (L13705) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 118) {
      goto case_118;
    }
    ...
    if (yy_act == 133) {
       printf("<This branch (L13753) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 134) {
       printf("<This branch (L13756) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 135) {
       printf("<This branch (L13759) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 136) {
       printf("<This branch (L13762) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 137) {
    ...
    if (yy_act == 141) {
       printf("<This branch (L13777) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 142) {
       printf("<This branch (L13780) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 143) {
       printf("<This branch (L13783) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 144) {
      goto case_144;
    }
    if (yy_act == 145) {
       printf("<This branch (L13789) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 146) {
       printf("<This branch (L13792) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 147) {
       printf("<This branch (L13795) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 148) {
       printf("<This branch (L13798) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 149) {
      goto case_149;
    }
    ...
    if (yy_act == 153) {
       printf("<This branch (L13813) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 154) {
      goto case_154;
    }
    ...
    if (yy_act == 156) {
       printf("<This branch (L13822) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 157) {
      goto case_157;
    }
    ...
    if (yy_act == 181) {
       printf("<This branch (L13840) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 179) {
       printf("<This branch (L13843) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 182) {
       printf("<This branch (L13846) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 162) {
      goto case_162;
    }
    ...
    if (yy_act == 165) {
       printf("<This branch (L13861) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 167) {
       printf("<This branch (L13864) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 168) {
      goto case_167;
    }
    if (yy_act == 171) {
       printf("<This branch (L13870) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 172) {
    ...
    if (yy_act == 174) {
       printf("<This branch (L13879) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 175) {
       printf("<This branch (L13882) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 176) {
       printf("<This branch (L13885) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 177) {
       printf("<This branch (L13888) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 178) {
       printf("<This branch (L13891) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 180) {
       printf("<This branch (L13894) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 183) {
       printf("<This branch (L13897) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 184) {
       printf("<This branch (L13900) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 185) {
       printf("<This branch (L13903) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (yy_act == 166) {
      goto case_166;
    }
     printf("<This branch (L13908) is removed by Cov debloating tool>\n"); exit(6);
    case_0: ;/* CIL Label */ 
    ...
    if (indented_code) {
       printf("<This branch (L14144) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_break;
    case_30: ;/* CIL Label */ 
    if (yyleng > 0) {
    ...
    if (! didadef) {
      ...
      } printf("<This branch (L14190) is removed by Cov debloating tool>\n"); exit(6);
    }
    yy_start = 1;
    linenum ++;
    goto switch_break;
    ...
    if (bracelevel <= 0) {
      ...
      if (! yy_current_buffer) {
        ...
        } printf("<This branch (L14638) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
      ...
      } printf("<This branch (L14648) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_break;
    case_87: ;/* CIL Label */ 
    ...
    *yy_cp = (char )'\000';
    ...
    if (in_rule) {
     ...
     printf("<This branch (L14799) is removed by Cov debloating tool>\n"); exit(6);
    case_101: ;/* CIL Label */ 
    ...
    if (cclval != 0) {
     ...
     printf("<This branch (L14873) is removed by Cov debloating tool>\n"); exit(6);
    case_106: ;/* CIL Label */ 
    if (yyleng > 0) {
      yy_current_buffer->yy_at_bol = (int )*(yytext + (yyleng - 1)) == 10;
    }
    ...
    if ((unsigned long )nmdefptr == (unsigned long )((unsigned char *)0)) {
      ...
      if (len > 0) {
        if ((int )*(nmdefptr + (len - 1)) == 36) {
          ...
          if ((int )*(nmdefptr + 0) == 94) {
             printf("<This branch (L14919) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
          goto _L___0;
        }
    ...
    *yy_cp = (char )'\000';
    ...
    if ((yy_start - 1) / 2 == 10) {
       printf("<This branch (L15463) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (257);
    ...
    if ((unsigned long )yy_c_buf_p <= (unsigned long )(yy_current_buffer->yy_ch_buf + yy_n_chars)) {
      {
       ...
       printf("<This branch (L15533) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      ...
      if (tmp___10 == 0) {
       ...
       printf("<This branch (L15545) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (tmp___11) {
       ...
       printf("<This branch (L15563) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto switch_break___0;
     ...
     printf("<This branch (L15585) is removed by Cov debloating tool>\n"); exit(6);
    switch_default: ;/* CIL Label */ 
    {
...
{ 
  ...
  if ((unsigned long )yy_c_buf_p > (unsigned long )(yy_current_buffer->yy_ch_buf + (yy_n_chars + 1))) {
    ...
    } printf("<This branch (L15624) is removed by Cov debloating tool>\n"); exit(6);
  }
  if (yy_current_buffer->yy_fill_buffer == 0) {
     ...
     printf("<This branch (L15631) is removed by Cov debloating tool>\n"); exit(6);
  }
  ...
  while (1) {
    ...
    if (! (i___0 < number_to_move)) {
     ...
     printf("<This branch (L15641) is removed by Cov debloating tool>\n"); exit(6);
  ...
  if (yy_current_buffer->yy_buffer_status == 2) {
     ...
     printf("<This branch (L15652) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    ...
    if (yy_current_buffer->yy_is_interactive) {
      ...
      while_break___1: ;/* CIL Label */ ;
       ...
       printf("<This branch (L15730) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
  ...
  if (yy_n_chars == 0) {
    if (number_to_move == 0) {
      ...
      yyrestart(yyin);
       ...
       printf("<This branch (L15758) is removed by Cov debloating tool>\n"); exit(6);
    }
  } else {
    ret_val = 0;
  }
...
{ 
  ...
  while (1) {
    ...
    if (! ((unsigned long )yy_cp < (unsigned long )yy_c_buf_p)) {
     ...
     printf("<This branch (L15787) is removed by Cov debloating tool>\n"); exit(6);
...
static yy_state_type yy_try_NUL_trans(yy_state_type yy_current_state ) 
{
 ...
 printf("<This branch (L15853) is removed by Cov debloating tool>\n"); exit(6);
}
static void yyunput(int c , char *yy_bp ) 
{ 
  register char *yy_cp ;
...
{ 
  ...
  if (! b->yy_ch_buf) {
    ...
    } printf("<This branch (L16039) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
...
void yy_delete_buffer(YY_BUFFER_STATE b ) 
{
 ...
 printf("<This branch (L16068) is removed by Cov debloating tool>\n"); exit(6);
}
...
{ 
  ...
  if (file) {
    ...
    b->yy_is_interactive = tmp___0 > 0;
     ...
     printf("<This branch (L16089) is removed by Cov debloating tool>\n"); exit(6);
  }
  return;
}
}
...
{ 
  ...
  {
  if (! b) {
     printf("<This branch (L16100) is removed by Cov debloating tool>\n"); exit(6);
  }
  b->yy_n_chars = 0;
...
YY_BUFFER_STATE yy_scan_buffer(char *base___0 , yy_size_t size ) 
{
 ...
 printf("<This branch (L16158) is removed by Cov debloating tool>\n"); exit(6);
}
YY_BUFFER_STATE yy_scan_string(char const   *yy_str ) 
{
 ...
 printf("<This branch (L16181) is removed by Cov debloating tool>\n"); exit(6);
}
YY_BUFFER_STATE yy_scan_bytes(char const   *bytes , int len ) 
{
 ...
 printf("<This branch (L16228) is removed by Cov debloating tool>\n"); exit(6);
}
static void yy_push_state(int new_state ) 
{ 
  yy_size_t new_size ;
  ...
  if (yy_start_stack_ptr >= yy_start_stack_depth) {
    ...
    if (! yy_start_stack) {
      ...
      } printf("<This branch (L16250) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (! yy_start_stack) {
      {

      } printf("<This branch (L16255) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
...
{ 
  ...
  if (yy_start_stack_ptr < 0) {
    ...
    } printf("<This branch (L16274) is removed by Cov debloating tool>\n"); exit(6);
  }
...
static void yy_fatal_error(char const   *msg ) 
{
 ...
 printf("<This branch (L16289) is removed by Cov debloating tool>\n"); exit(6);
}
static void *yy_flex_alloc(yy_size_t size ) 
{ 
  void *tmp ;
...
static void *yy_flex_realloc(void *ptr , yy_size_t size ) 
{
 ...
 printf("<This branch (L16311) is removed by Cov debloating tool>\n"); exit(6);
}
static void yy_flex_free(void *ptr ) 
{
 ...
 printf("<This branch (L16322) is removed by Cov debloating tool>\n"); exit(6);
}
int yywrap(void) 
{ 
  ...
  if (num_input_files > 0) {
    {
     ...
     printf("<This branch (L16335) is removed by Cov debloating tool>\n"); exit(6);
  } else {
    return (1);
  }
}
  ...
  if (file) {
    ...
    if (tmp) {
      ...
      if ((unsigned long )yyin == (unsigned long )((void *)0)) {
        ...
        } printf("<This branch (L16358) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      {


      } printf("<This branch (L16364) is removed by Cov debloating tool>\n"); exit(6);
    }
  } else {
    {


    } printf("<This branch (L16370) is removed by Cov debloating tool>\n"); exit(6);
  }
  linenum = 1;
  return;
}
