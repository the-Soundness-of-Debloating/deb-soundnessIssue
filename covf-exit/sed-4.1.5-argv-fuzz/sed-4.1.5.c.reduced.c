...
void bad_prog(char const   *why )
{
  ...
  if (cur_input.name) {
    ...
    } printf("<This branch (L1244) is removed by Cov debloating tool>\n"); exit(6);
  }
  {
  exit(1);
  }
...
static struct vector *compile_program(struct vector *vector )
{
  ...
  while (1) {
    ...
    if ((int const   )*(*tmp___11 + ch) & 2048) {
      ...
      } printf("<This branch (L3153) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      cur_cmd->x.int_arg = -1;
    }
    if (ch == 125) {
      ...
      } printf("<This branch (L3160) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if (ch == 35) {
      {

      } printf("<This branch (L3165) is removed by Cov debloating tool>\n"); exit(6);
    } else { //Added block
    if (ch != -1) {
      if (ch != 10) {
        if (ch != 59) {
...
static _Bool test_eof(struct input *input )
{
  ...
  if (ch == -1) {
    if (separate_files) {
       printf("<This branch (L4824) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      ...
      if (tmp___4) {
        tmp___5 = 1;
         ...
         printf("<This branch (L4832) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
...
static _Bool match_an_address_p(struct addr *addr , struct input *input )
{
  ...
  if ((unsigned int )addr->addr_type == 4U) {
     printf("<This branch (L4862) is removed by Cov debloating tool>\n"); exit(6);
  }
  if ((unsigned int )addr->addr_type == 5U) {
     printf("<This branch (L4865) is removed by Cov debloating tool>\n"); exit(6);
  }
