...

  {
    if (sizeof(char) == 1UL) {
      ...
      tmp___1 = tmp;
       ...
       printf("<This branch (L400) is removed by Cov debloating tool>\n"); exit(6);
    }
    return ((char *)tmp___1);
  }
}
...
void *xmalloc(size_t n) {
...

  {
    ...
    if (!p) {
       ...
       printf("<This branch (L729) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (p);
  }
}
...
quotearg_buffer_restyled(char *buffer, size_t buffersize, char const *arg,
  ...
  switch_break:;
    ...
    while (1) {
      ...
      if ((int)c == 66) {
         printf("<This branch (L1762) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 67) {
        goto case_37;
      }
      ...
      if ((int)c == 69) {
         printf("<This branch (L1771) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 70) {
        goto case_37;
      }
      if ((int)c == 71) {
         printf("<This branch (L1777) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 72) {
        goto case_37;
      }
      ...
      if ((int)c == 74) {
         printf("<This branch (L1786) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 75) {
         printf("<This branch (L1789) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 76) {
        goto case_37;
      }
      ...
      if ((int)c == 83) {
         printf("<This branch (L1813) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 84) {
        goto case_37;
      }
      ...
      if ((int)c == 122) {
         printf("<This branch (L1918) is removed by Cov debloating tool>\n"); exit(6);
      }
          ...
          _L___0:;
            ...
            while (1) {
              ...
              if (backslash_escapes) {
                if (!printable) {
                  if (elide_outer_quotes) {
                     printf("<This branch (L2262) is removed by Cov debloating tool>\n"); exit(6);
                  }
                  while (1) {
                ...
                while_break___20:;
                  c = (unsigned char)(48 + ((int)c & 7));
                   ...
                   printf("<This branch (L2293) is removed by Cov debloating tool>\n"); exit(6);
                }
              } else {
              _L:;
              ...
              if (ilim <= i + 1UL) {
               ...
               printf("<This branch (L2313) is removed by Cov debloating tool>\n"); exit(6);
    ...
    store_escape:;
      if (elide_outer_quotes) {
         printf("<This branch (L2354) is removed by Cov debloating tool>\n"); exit(6);
      }
      while (1) {
...

  {
    ...
    if (size <= qsize) {
      ...
      if ((unsigned long)val != (unsigned long)(slot0)) {
         printf("<This branch (L2483) is removed by Cov debloating tool>\n"); exit(6);
      }
      val = xcharalloc(size);
      (sv + n)->val = val;
...

  {
    ...
    if (base - argv0 >= 7L) {
      ...
      if (tmp___0 == 0) {
         ...
         printf("<This branch (L2621) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    program_name = argv0;
...
int yyparse(parser_control *pc) {
  ...
  yyerrlab:;
    ...
    if (yyerrstatus == 3) {
       ...
       printf("<This branch (L4295) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto yyerrlab1;
    yyvsp -= yylen;
        ...
        if (0 <= yyn) {
          if (yyn <= 112) {
            if ((int const)yycheck[yyn] == 1) {
               ...
               printf("<This branch (L4315) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
      }
      ...
      *result = pc.seconds;
      ...
      if (!tmp___12) {
        if (!pc.zones_seen) {
          ...
          if (time_zone < 0L) {
             printf("<This branch (L5392) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            tmp___9 = time_zone;
          }
          ...
          if (tmp___10 != 0) {
             printf("<This branch (L5406) is removed by Cov debloating tool>\n"); exit(6);
          }
          tz_was_altered = (_Bool)1;
          tm = tm0;
          Start = mktime(&tm);
...
static size_t strftime_case____0(_Bool upcase, FILE *s, char const *format,
...

  {
    ...
    switch_break___0:;
      ...
      if (format_char == 0) {
         printf("<This branch (L6564) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto bad_format;
    case_37:;
      ...
      while (1) {
        ...
        if (width < 0) {
          tmp___39 = 0;
           ...
           printf("<This branch (L7885) is removed by Cov debloating tool>\n"); exit(6);
        }
        _w___11 = (size_t)tmp___39;
        if (_n___11 < _w___11) {
           printf("<This branch (L7889) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          tmp___40 = _n___11;
        }
        _incr___11 = tmp___40;
        ...
        if (p) {
          if (digits == 0) {
            if (_n___11 < _w___11) {
               ...
               printf("<This branch (L7931) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
          while (1) {

            if (to_lowcase) {
               printf("<This branch (L7937) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if (to_uppcase) {
                 printf("<This branch (L7940) is removed by Cov debloating tool>\n"); exit(6);
              } else {
...

  {
    if (status != 0) {
      emit_try_help();
       ...
       printf("<This branch (L9452) is removed by Cov debloating tool>\n"); exit(6);
    }
    exit(status);
  }
}
...
int main(int argc, char **argv) {
...

  {
    ...
    while (1) {
      ...
      if (optc == -130) {
         printf("<This branch (L9652) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == -131) {
         printf("<This branch (L9655) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto switch_default;
    case_100:;
