...
static strtol_error bkm_scale___0(unsigned long *x, int scale_factor) {
   ...
   printf("<This branch (L617) is removed by Cov debloating tool>\n"); exit(6);
}
...
strtol_error xstrtoul(char const *s, char **ptr, int strtol_base,
  ...
  char *tmp___6;
  {
    ...
    if (0 <= strtol_base) {
      if (!(strtol_base <= 36)) {
        ...
        } printf("<This branch (L671) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      {
      ...
      } printf("<This branch (L679) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (ptr) {
       printf("<This branch (L682) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      p = &t_ptr;
    }
    q = s;
  ...
  while_break:;
    if ((int const) * q == 45) {
       printf("<This branch (L700) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      ...
      if (*tmp___4 != 0) {
        {
         ...
         printf("<This branch (L734) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!valid_suffixes) {

       printf("<This branch (L739) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)*(*p) != 0) {
      {
        base = 1024;
...
void xalloc_die(void) {
   ...
   printf("<This branch (L935) is removed by Cov debloating tool>\n"); exit(6);
}
...
void *xmalloc(size_t n) {
   ...
   printf("<This branch (L966) is removed by Cov debloating tool>\n"); exit(6);
}
...
void version_etc_va(FILE *stream, char const *command_name, char const *package,
   ...
   printf("<This branch (L1202) is removed by Cov debloating tool>\n"); exit(6);
}
void version_etc(FILE *stream, char const *command_name, char const *package,
                 char const *version, ...) {
   ...
   printf("<This branch (L1213) is removed by Cov debloating tool>\n"); exit(6);
}
extern __attribute__((__nothrow__)) int
...
int save_cwd(struct saved_cwd *cwd) {
  {
    ...
    if (have_working_fchdir) {
      ...
      if (cwd->desc < 0) {
         printf("<This branch (L1440) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!have_working_fchdir) {
      {
       ...
       printf("<This branch (L1449) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (0);
  }
}
  ...
  int tmp___0;
  {
    if (0 <= (int)cwd->desc) {
      ...
      return (tmp < 0);
       ...
       printf("<This branch (L1465) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
}
void free_cwd(struct saved_cwd *cwd) {
  {
    ...
    if (cwd->name) {
      ...
      } printf("<This branch (L1479) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
static size_t quotearg_buffer_restyled(char *buffer, size_t buffersize,
  ...
  char *__cil_tmp37;
  {
    ...
    if ((unsigned int)quoting_style == 3U) {
       printf("<This branch (L1716) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 4U) {
       printf("<This branch (L1719) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 6U) {
       printf("<This branch (L1722) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 5U) {
      goto case_6;
    }
     printf("<This branch (L1727) is removed by Cov debloating tool>\n"); exit(6);
  ...
  switch_break:;
    i = (size_t)0;
    {
      ...
      while_continue___3: /* CIL Label */;
        ...
        if ((int)c == 63) {
           printf("<This branch (L1844) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 7) {
           printf("<This branch (L1847) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 8) {
           printf("<This branch (L1850) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 12) {
           printf("<This branch (L1853) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 10) {
           printf("<This branch (L1856) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 13) {
        ...
        if ((int)c == 126) {
           printf("<This branch (L1871) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 35) {
           printf("<This branch (L1874) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 124) {
        ...
        if ((int)c == 62) {
           printf("<This branch (L1889) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 60) {
           printf("<This branch (L1892) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 59) {
           printf("<This branch (L1895) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 42) {
           printf("<This branch (L1898) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 41) {
           printf("<This branch (L1901) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 40) {
           printf("<This branch (L1904) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 38) {
           printf("<This branch (L1907) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 36) {
           printf("<This branch (L1910) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 34) {
           printf("<This branch (L1913) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 33) {
           printf("<This branch (L1916) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 32) {
           printf("<This branch (L1919) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 39) {
           printf("<This branch (L1922) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 125) {
           printf("<This branch (L1925) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 123) {
           printf("<This branch (L1928) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 122) {
           printf("<This branch (L1931) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 121) {
           printf("<This branch (L1934) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 120) {
           printf("<This branch (L1937) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 119) {
           printf("<This branch (L1940) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 118) {
        ...
        if ((int)c == 116) {
           printf("<This branch (L1949) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 115) {
        ...
        if ((int)c == 111) {
           printf("<This branch (L1964) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 110) {
           printf("<This branch (L1967) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 109) {
           printf("<This branch (L1970) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 108) {
        ...
        if ((int)c == 104) {
           printf("<This branch (L1985) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 103) {
           printf("<This branch (L1988) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 102) {
           printf("<This branch (L1991) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 101) {
           printf("<This branch (L1994) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 100) {
          goto case_125;
        }
        ...
        if ((int)c == 98) {
           printf("<This branch (L2003) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 97) {
      ...
      switch_default___2:;
        ...
        if (1UL < m) {
           printf("<This branch (L2446) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (backslash_escapes) {
            if (!printable) {
            _L:;
  ...
  int *tmp___2;
  {
    if (o) {
      tmp = o;
       ...
       printf("<This branch (L2608) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      p = tmp;
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize,
  ...
  int *tmp___5;
  {
    ...
    if (n < 0) {
      ...
      } printf("<This branch (L2653) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nslots <= n0) {
      ...
      } printf("<This branch (L2681) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      size = (slotvec + n)->size;
      val = (slotvec + n)->val;
    ...
    if (size <= qsize) {
      ...
      } printf("<This branch (L2702) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
...
char *quotearg_char(char const *arg, char ch) {
   ...
   printf("<This branch (L2751) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_colon(char const *arg) {
...
static struct mode_change *make_node_op_equals(mode_t new_mode) {
  ...
  void *tmp;
  {
    ...
    if ((unsigned long)p == (unsigned long)((void *)0)) {
       printf("<This branch (L2811) is removed by Cov debloating tool>\n"); exit(6);
    }
...
struct mode_change *mode_compile(char const *mode_string___0,
  ...
  char *__cil_tmp33;
  {
    ...
    if ((unsigned int)tmp___11 == 0U) {
          ...
          if (64 >> 3 == 8) {
            if ((256 >> 3) >> 3 == 4) {
              if ((128 >> 3) >> 3 == 2) {
               ...
               printf("<This branch (L2894) is removed by Cov debloating tool>\n"); exit(6);
            }
          } else {
             printf("<This branch (L2897) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
           printf("<This branch (L2900) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
      _L___3:;
      ...
      if ((unsigned long)p == (unsigned long)((void *)0)) {
         printf("<This branch (L2976) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    }
    {
        ...
        mode_string___0++;
        {
          ...
          while_continue___0: /* CIL Label */;
            if ((int const) * mode_string___0 == 117) {
               printf("<This branch (L2998) is removed by Cov debloating tool>\n"); exit(6);
            }
            if ((int const) * mode_string___0 == 103) {
               printf("<This branch (L3001) is removed by Cov debloating tool>\n"); exit(6);
            }
            if ((int const) * mode_string___0 == 111) {
               printf("<This branch (L3004) is removed by Cov debloating tool>\n"); exit(6);
            }
      ...
      no_more_affected:;
        if (affected_bits) {
           printf("<This branch (L3032) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          who_specified_p = 0;
  ...
  while_break:;
    if ((int const) * mode_string___0 == 0) {
       printf("<This branch (L3193) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    newmode = oldmode & (unsigned int)((4032 | (448 >> 3)) | ((448 >> 3) >> 3));
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if ((int const)changes->flags & 2) {
           ...
           printf("<This branch (L3275) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          ...
          if ((int const)changes->flags & 1) {
             ...
             printf("<This branch (L3284) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
        if ((int const)changes->op == 61) {
          goto case_61;
        }
         printf("<This branch (L3290) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (tmp___5) {
        {
         ...
         printf("<This branch (L3422) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (created_dir_p) {
  ...
  char *__cil_tmp109;
  {
    ...
    if (tmp___65) {
      ...
      if ((parent_mode & 192) != 192) {
         ...
         printf("<This branch (L3556) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        ...
        if ((int)*dirpath == 47) {
          {
           ...
           printf("<This branch (L3590) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      slash = dirpath;
      {
    ...
    while_break:;
      {
        ...
        while_continue___0: /* CIL Label */;
          ...
          if (!do_chdir) {
             printf("<This branch (L3616) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
            *slash = (char)'\000';
          ...
          if (newly_created_dir) {
            if (verbose_fmt_string) {
              ...
              } printf("<This branch (L3668) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (owner != 4294967295U) {
               printf("<This branch (L3671) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if (group != 4294967295U) {
                 ...
                 printf("<This branch (L3724) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
            if (re_protect) {
              {
          ...
          if (do_chdir) {
            ...
            if (tmp___29 < 0) {
              ...
              }
              {
               ...
               printf("<This branch (L3786) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
          tmp___30 = slash;
          slash++;
    ...
    while_break___0:;
      if (!do_chdir) {
         printf("<This branch (L3808) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
        umask(oldmask);
                  ...
                  if (tmp___35 != 0) {
                    {
                     ...
                     printf("<This branch (L3839) is removed by Cov debloating tool>\n"); exit(6);
                  }
                  { free_cwd(&cwd); }
                }
      ...
      if ((unsigned long)verbose_fmt_string != (unsigned long)((void *)0)) {
        ...
        } printf("<This branch (L3859) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (owner != 4294967295U) {
         printf("<This branch (L3862) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (group != 4294967295U) {
      ...
      if (mode & ~((448 | (448 >> 3)) | ((448 >> 3) >> 3))) {
        {
         ...
         printf("<This branch (L3889) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
        while (1) {
    ...
    while_break___11:;
       ...
       printf("<This branch (L3981) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (retval);
  }
}
...
char *(__attribute__((__leaf__)) rpl_getcwd)(char *buf, size_t size) {
   ...
   printf("<This branch (L4394) is removed by Cov debloating tool>\n"); exit(6);
}
extern
...
void close_stdout(void) {
  ...
  char *__cil_tmp10;
  {
    ...
    if (e) {
     ...
     printf("<This branch (L4642) is removed by Cov debloating tool>\n"); exit(6);
      ...
      while_continue: /* CIL Label */;
        ...
        while_break___0:;
          if (!*p) {
             ...
             printf("<This branch (L4702) is removed by Cov debloating tool>\n"); exit(6);
          }
          base = p;
        }
        p++;
  ...
  char *__cil_tmp36;
  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (optc == 0) {
           printf("<This branch (L4898) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (optc == 112) {
          goto case_112;
        }
          ...
          if (!fail) {
            if (!create_parents) {
              if (!dir_created) {
                ...
                } printf("<This branch (L5005) is removed by Cov debloating tool>\n"); exit(6);
              } else {
                goto _L;
              }
            } else {
