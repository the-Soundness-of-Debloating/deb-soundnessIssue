    ...
    }
    {
      ...
      while_continue___0: /* CIL Label */;
        ...
        if (!(nHeap < 260)) {
          ...
          } printf("<This branch (L364) is removed by Cov debloating tool>\n"); exit(6);
        }
        {
          while (1) {
        ...
        if (!(nNodes < 516)) {
          ...
          } printf("<This branch (L460) is removed by Cov debloating tool>\n"); exit(6);
        }
        tooLong = (Bool)0;
        i = 1;
        {
          ...
          while_continue___7: /* CIL Label */;
            ...
            *(len + (i - 1)) = (UChar)j;
            if (j > maxLen) {
               printf("<This branch (L485) is removed by Cov debloating tool>\n"); exit(6);
            }
            i++;
          }
        ...
        if (!tooLong) {
         ...
         printf("<This branch (L494) is removed by Cov debloating tool>\n"); exit(6);
        {
...
Int32 BZ2_decompress(DState *s) {
...

  {
    ...
    retVal = 0;
    {
      ...
      if (s->state == 11) {
         printf("<This branch (L842) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 12) {
         printf("<This branch (L845) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 13) {
         printf("<This branch (L848) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 14) {
        goto case_14;
      }
      if (s->state == 15) {
         printf("<This branch (L854) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 16) {
         printf("<This branch (L857) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 17) {
         printf("<This branch (L860) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 18) {
         printf("<This branch (L863) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 19) {
         printf("<This branch (L866) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 20) {
         printf("<This branch (L869) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 21) {
         printf("<This branch (L872) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 22) {
         printf("<This branch (L875) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 23) {
         printf("<This branch (L878) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 24) {
         printf("<This branch (L881) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 25) {
         printf("<This branch (L884) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 26) {
         printf("<This branch (L887) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 27) {
         printf("<This branch (L890) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 28) {
         printf("<This branch (L893) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 29) {
         printf("<This branch (L896) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 30) {
         printf("<This branch (L899) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 31) {
         printf("<This branch (L902) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 32) {
         printf("<This branch (L905) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 33) {
         printf("<This branch (L908) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 34) {
         printf("<This branch (L911) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 35) {
         printf("<This branch (L914) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 36) {
         printf("<This branch (L917) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 37) {
         printf("<This branch (L920) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->state == 38) {
        goto case_38;
      }
      ...
      if (s->state == 41) {
       ...
       printf("<This branch (L934) is removed by Cov debloating tool>\n"); exit(6);
      ...
      s->state = 10;
      {
        ...
        while_continue: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L975) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
          ...
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L984) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break: /* CIL Label */;
      }
    ...
    case_11: ;/* CIL Label */
      s->state = 11;
      {
        ...
        while_continue___0: /* CIL Label */;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1016) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___0: /* CIL Label */;
      }
      if ((int)uc != 90) {
         ...
         printf("<This branch (L1023) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_12: ;/* CIL Label */
      s->state = 12;
      {
        ...
        while_continue___1: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1039) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1048) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___1: /* CIL Label */;
      }
      if ((int)uc != 104) {
         ...
         printf("<This branch (L1055) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_13: ;/* CIL Label */
      s->state = 13;
      {
        ...
        while_continue___2: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1071) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1080) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___2: /* CIL Label */;
      }
      if (s->blockSize100k < 49) {
         ...
         printf("<This branch (L1087) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (s->blockSize100k > 57) {

           printf("<This branch (L1091) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      s->blockSize100k -= 48;
      if (s->smallDecompress) {
        {
         ...
         printf("<This branch (L1116) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        {
        ...
        if ((unsigned long)s->tt == (unsigned long)((void *)0)) {
           ...
           printf("<This branch (L1126) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    case_14: ;/* CIL Label */
      s->state = 14;
      {
        ...
        while_continue___3: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1143) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
      ...
      if ((int)uc != 49) {
         ...
         printf("<This branch (L1162) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_15: ;/* CIL Label */
      s->state = 15;
      {
        ...
        while_continue___4: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1178) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1187) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___4: /* CIL Label */;
      }
    ...
    case_16: ;/* CIL Label */
      s->state = 16;
      {
        ...
        while_continue___5: /* CIL Label */;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1219) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___5: /* CIL Label */;
      }
      if ((int)uc != 89) {
         ...
         printf("<This branch (L1226) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_17: ;/* CIL Label */
      s->state = 17;
      {
        ...
        while_continue___6: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1242) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
      ...
      if ((int)uc != 38) {
         ...
         printf("<This branch (L1258) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_18: ;/* CIL Label */
      s->state = 18;
      {
        ...
        while_continue___7: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1274) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1283) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___7: /* CIL Label */;
      }
      if ((int)uc != 83) {
         ...
         printf("<This branch (L1290) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_19: ;/* CIL Label */
      s->state = 19;
      {
        ...
        while_continue___8: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1306) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1315) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break___8: /* CIL Label */;
      }
      if ((int)uc != 89) {
         ...
         printf("<This branch (L1322) is removed by Cov debloating tool>\n"); exit(6);
      }
      (s->currBlockNo)++;
      if (s->verbosity >= 2) {
        {
        ...
        } printf("<This branch (L1330) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    case_20: ;/* CIL Label */
      s->state = 20;
      {
        ...
        while_continue___9: /* CIL Label */;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1356) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 21;
      {
        ...
        while_continue___10: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1376) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1385) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
    ...
    case_22: ;/* CIL Label */
      s->state = 22;
      {
        ...
        while_continue___11: /* CIL Label */;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1414) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 23;
      {
        ...
        while_continue___12: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1434) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1443) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 24;
      {
        ...
        while_continue___13: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1463) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
      ...
      s->state = 25;
      {
        ...
        while_continue___14: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1492) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1501) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 26;
      {
        ...
        while_continue___15: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1521) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1530) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
    ...
    case_27: ;/* CIL Label */
      s->state = 27;
      {
        ...
        while_continue___16: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L1550) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
      ...
      if (s->origPtr < 0) {
         ...
         printf("<This branch (L1567) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->origPtr > 10 + 100000 * s->blockSize100k) {

         printf("<This branch (L1571) is removed by Cov debloating tool>\n"); exit(6);
      }
      i = 0;
      {
        while (1) {
        ...
        case_28: ;/* CIL Label */
          s->state = 28;
          {
            ...
            while_continue___18: /* CIL Label */;
              ...
              ((s->strm)->total_in_lo32)++;
              if ((s->strm)->total_in_lo32 == 0U) {
                 printf("<This branch (L1603) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
          ...
          if ((int)uc == 1) {
            s->inUse16[i] = (Bool)1;
             ...
             printf("<This branch (L1611) is removed by Cov debloating tool>\n"); exit(6);
          }
          i++;
        }
      ...
      if (s->nInUse == 0) {
         ...
         printf("<This branch (L1687) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    case_30: ;/* CIL Label */
      s->state = 30;
      {
        ...
        while_continue___23: /* CIL Label */;
          if (s->bsLive >= 3) {
           ...
           printf("<This branch (L1702) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (nGroups < 2) {
        ...
        if (nGroups > 6) {
           ...
           printf("<This branch (L1724) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    case_31: ;/* CIL Label */
      s->state = 31;
      {
        ...
        while_continue___24: /* CIL Label */;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L1750) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      if (nSelectors < 1) {
         ...
         printf("<This branch (L1757) is removed by Cov debloating tool>\n"); exit(6);
      }
      i = 0;
      {
        while (1) {
          ...
          j = 0;
          {
            ...
            case_32: ;/* CIL Label */
              s->state = 32;
              {
                ...
                while_continue___27: /* CIL Label */;
                  ...
                  if ((s->strm)->avail_in == 0U) {
                     ...
                     printf("<This branch (L1784) is removed by Cov debloating tool>\n"); exit(6);
                  }
                  s->bsBuff = (s->bsBuff << 8) |
                              (UInt32) * ((UChar *)(s->strm)->next_in);
                  s->bsLive += 8;
              ...
              if (j >= nGroups) {
                 ...
                 printf("<This branch (L1804) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
        ...
        case_33: ;/* CIL Label */
          s->state = 33;
          {
            ...
            while_continue___32: /* CIL Label */;
              ...
              ((s->strm)->total_in_lo32)++;
              if ((s->strm)->total_in_lo32 == 0U) {
                 printf("<This branch (L1882) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
                ...
                while_continue___34: /* CIL Label */;
                  if (curr < 1) {
                    ...
                    if (curr > 20) {
                       ...
                       printf("<This branch (L1903) is removed by Cov debloating tool>\n"); exit(6);
                    }
                  }
                case_34: ;/* CIL Label */
                  s->state = 34;
                  ...
                  s->state = 35;
                  {
                    ...
                    while_continue___36: /* CIL Label */;
                      ...
                      if ((s->strm)->avail_in == 0U) {
                         ...
                         printf("<This branch (L1951) is removed by Cov debloating tool>\n"); exit(6);
                      }
                      s->bsBuff = (s->bsBuff << 8) |
                                  (UInt32) * ((UChar *)(s->strm)->next_in);
                      s->bsLive += 8;
                      ...
                      ((s->strm)->total_in_lo32)++;
                      if ((s->strm)->total_in_lo32 == 0U) {
                         printf("<This branch (L1960) is removed by Cov debloating tool>\n"); exit(6);
                      }
                    }
    ...
    case_36: ;/* CIL Label */
          ...
          if (nextSym == 0) {
            ...
            _L:;
                  ...
                  }
                  {
                    ...
                    while_continue___48: /* CIL Label */;
                      if (zn > 20) {
                         ...
                         printf("<This branch (L2229) is removed by Cov debloating tool>\n"); exit(6);
                      }
                      if (zvec <= *(gLimit + zn)) {
                    ...
                    case_39: ;/* CIL Label */
                      s->state = 39;
                      {
                        ...
                        while_continue___49: /* CIL Label */;
                          ...
                          ((s->strm)->total_in_lo32)++;
                          if ((s->strm)->total_in_lo32 == 0U) {
                             printf("<This branch (L2258) is removed by Cov debloating tool>\n"); exit(6);
                          }
                        }
              ...
              if (s->smallDecompress) {
                ...
                } printf("<This branch (L2304) is removed by Cov debloating tool>\n"); exit(6);
              } else {
                {
                  while (1) {
                  while_continue___51: /* CIL Label */;
                    ...
                    if (nblock >= nblockMAX) {
                       ...
                       printf("<This branch (L2314) is removed by Cov debloating tool>\n"); exit(6);
                    }
              ...
              if (nblock >= nblockMAX) {
                 ...
                 printf("<This branch (L2327) is removed by Cov debloating tool>\n"); exit(6);
              }
              nn = (UInt32)(nextSym - 1);
              if (nn < 16U) {
                pp = s->mtfbase[0];
              ...
              if (s->smallDecompress) {
                 printf("<This branch (L2424) is removed by Cov debloating tool>\n"); exit(6);
              } else {
            ...
            case_40: ;/* CIL Label */
              s->state = 40;
              {
                ...
                while_continue___58: /* CIL Label */;
                  ...
                  ((s->strm)->total_in_lo32)++;
                  if ((s->strm)->total_in_lo32 == 0U) {
                     printf("<This branch (L2467) is removed by Cov debloating tool>\n"); exit(6);
                  }
                }
              ...
              if (zvec - *(gBase + zn) < 0) {
                 ...
                 printf("<This branch (L2517) is removed by Cov debloating tool>\n"); exit(6);
              } else {
                if (zvec - *(gBase + zn) >= 258) {
      ...
      if (s->origPtr < 0) {
         ...
         printf("<This branch (L2533) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (s->origPtr >= nblock) {
      ...
      i = 0;
      {
        ...
        while_continue___63: /* CIL Label */;
          ...
          if (s->cftab[i] < 0) {
             ...
             printf("<This branch (L2574) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            if (s->cftab[i] > nblock) {

               printf("<This branch (L2578) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
          i++;
        }
      ...
      if (s->smallDecompress) {
...

        {
         ...
         printf("<This branch (L2700) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        i = 0;
        {
          while (1) {
        ...
        if (s->blockRandomised) {
           ...
           printf("<This branch (L2741) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (s->tPos >= 100000U * (UInt32)s->blockSize100k) {
             printf("<This branch (L2744) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->tPos = *(s->tt + s->tPos);
    ...
    case_42: ;/* CIL Label */
      s->state = 42;
      {
        ...
        while_continue___68: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2769) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2778) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      if ((int)uc != 114) {
         ...
         printf("<This branch (L2785) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_43: ;/* CIL Label */
      s->state = 43;
      {
        ...
        while_continue___69: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2801) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2810) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
    ...
    case_44: ;/* CIL Label */
      s->state = 44;
      {
        ...
        while_continue___70: /* CIL Label */;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2842) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      if ((int)uc != 56) {
         ...
         printf("<This branch (L2849) is removed by Cov debloating tool>\n"); exit(6);
      }
    case_45: ;/* CIL Label */
      s->state = 45;
      {
        ...
        while_continue___71: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2865) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
    ...
    case_46: ;/* CIL Label */
      s->state = 46;
      {
        ...
        while_continue___72: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2897) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2906) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      if ((int)uc != 144) {
         ...
         printf("<This branch (L2913) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      s->state = 47;
      {
        ...
        while_continue___73: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2930) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2939) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 48;
      {
        ...
        while_continue___74: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2959) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2968) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 49;
      {
        ...
        while_continue___75: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L2988) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L2997) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      ...
      s->state = 50;
      {
        ...
        while_continue___76: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
             ...
             printf("<This branch (L3017) is removed by Cov debloating tool>\n"); exit(6);
          }
          s->bsBuff =
              (s->bsBuff << 8) | (UInt32) * ((UChar *)(s->strm)->next_in);
          s->bsLive += 8;
...

  {
    ...
    if (zPend > 0) {

      {
       ...
       printf("<This branch (L3388) is removed by Cov debloating tool>\n"); exit(6);
    }
    *(mtfv + wr) = (UInt16)EOB;
    wr++;
    (s->mtfFreq[EOB])++;
...
static void sendMTFValues(EState *s) {
...

  {
    ...
    if (s->verbosity >= 3) {
      ...
      } printf("<This branch (L3450) is removed by Cov debloating tool>\n"); exit(6);
    }
    alphaSize = s->nInUse + 2;
    t = 0;
    {
    ...
    if (!(s->nMTF > 0)) {
      ...
      } printf("<This branch (L3479) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (s->nMTF < 200) {
      nGroups = 2;
    } else {
      if (s->nMTF < 600) {
         printf("<This branch (L3485) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (s->nMTF < 1200) {
           printf("<This branch (L3488) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (s->nMTF < 2400) {
             printf("<This branch (L3491) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            nGroups = 6;
          }
        }
      ...
      while_continue___1: /* CIL Label */;
        ...
        aFreq = 0;
        {
          ...
          while_continue___2: /* CIL Label */;
            if (aFreq < tFreq) {
              if (!(ge < alphaSize - 1)) {
                 printf("<This branch (L3515) is removed by Cov debloating tool>\n"); exit(6);
              }
            } else {
              goto while_break___2;
            }
        ...
        if (s->verbosity >= 3) {
          ...
          } printf("<This branch (L3544) is removed by Cov debloating tool>\n"); exit(6);
        }
        v = 0;
        {
          while (1) {
    ...
    iter = 0;
    {
      ...
      while_continue___4: /* CIL Label */;
            ...
            if (nGroups == 6) {
              if (50 == (ge - gs) + 1) {
                ...
                cost[5] = (UInt16)(cost45 >> 16);
                 ...
                 printf("<This branch (L3870) is removed by Cov debloating tool>\n"); exit(6);
              }
            } else {
            _L:;
              i = gs;
            ...
            if (nGroups == 6) {
              if (50 == (ge - gs) + 1) {
                ...
                (s->rfreq[bt][*(mtfv + (gs + 49))])++;
                 ...
                 printf("<This branch (L3974) is removed by Cov debloating tool>\n"); exit(6);
              }
            } else {
            _L___0:;
              i = gs;
        ...
        if (s->verbosity >= 3) {
          ...
          } printf("<This branch (L4020) is removed by Cov debloating tool>\n"); exit(6);
        }
        t = 0;
        {
          while (1) {
    ...
    if (nSelectors < 32768) {
      if (!(nSelectors <= 18002)) {
       ...
       printf("<This branch (L4053) is removed by Cov debloating tool>\n"); exit(6);
    }
    i = 0;
    {
      while (1) {
    ...
    t = 0;
    {
      ...
      while_continue___20: /* CIL Label */;
        ...
        if (!(!(maxLen > 17))) {
          ...
          } printf("<This branch (L4125) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (!(!(minLen < 1))) {
          {

          } printf("<This branch (L4130) is removed by Cov debloating tool>\n"); exit(6);
        }
        {
    ...
    if (s->verbosity >= 3) {
      ...
      } printf("<This branch (L4221) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      nBytes = s->numZ;
    ...
    if (s->verbosity >= 3) {
      ...
      } printf("<This branch (L4261) is removed by Cov debloating tool>\n"); exit(6);
    }
    nBytes = s->numZ;
    t = 0;
    {
    ...
    if (s->verbosity >= 3) {
      ...
      } printf("<This branch (L4324) is removed by Cov debloating tool>\n"); exit(6);
    }
    nBytes = s->numZ;
    selCtr = 0;
    gs = 0;
    {
      ...
      while_continue___33: /* CIL Label */;
        ...
        if (!((int)s->selector[selCtr] < nGroups)) {
          ...
          } printf("<This branch (L4342) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (nGroups == 6) {
          if (50 == (ge - gs) + 1) {
            {
    ...
    if (!(selCtr == nSelectors)) {
      ...
      } printf("<This branch (L4529) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (s->verbosity >= 3) {
      {
      ...
      } printf("<This branch (L4536) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
void BZ2_compressBlock(EState *s, Bool is_last_block) {

  {
    if (s->nblock > 0) {
      ...
      if (s->blockNo > 1) {
         printf("<This branch (L4549) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (s->verbosity >= 2) {
        {
        ...
        } printf("<This branch (L4559) is removed by Cov debloating tool>\n"); exit(6);
      }
      { BZ2_blockSort(s); }
    }
    ...
    if (is_last_block) {
      ...
      if (s->verbosity >= 2) {
        ...
        } printf("<This branch (L4605) is removed by Cov debloating tool>\n"); exit(6);
      }
      { bsFinishWrite(s); }
    }
    return;
...
void BZ2_bz__AssertH__fail(int errcode) {
   ...
   printf("<This branch (L4724) is removed by Cov debloating tool>\n"); exit(6);
}
static int bz_config_ok(void) {

  {
    if (sizeof(int) != 4UL) {
       printf("<This branch (L4730) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sizeof(short) != 2UL) {
       printf("<This branch (L4733) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sizeof(char) != 1UL) {
       printf("<This branch (L4736) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (1);
  }
}
...
int BZ2_bzCompressInit(bz_stream *strm, int blockSize100k___0,
...

  {
    { tmp = bz_config_ok(); }
    if (!tmp) {
       printf("<This branch (L4819) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)strm == (unsigned long)((void *)0)) {
       printf("<This branch (L4822) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (blockSize100k___0 < 1) {
         printf("<This branch (L4825) is removed by Cov debloating tool>\n"); exit(6);
      } else {
    ...
    if (workFactor___0 == 0) {
       printf("<This branch (L4841) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if ((unsigned long)s == (unsigned long)((void *)0)) {
       printf("<This branch (L4851) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      s->strm = strm;
    ...
    if ((unsigned long)s->arr1 == (unsigned long)((void *)0)) {
      ...
      if ((unsigned long)s->arr2 == (unsigned long)((void *)0)) {
         printf("<This branch (L4870) is removed by Cov debloating tool>\n"); exit(6);
      } else {
    ...
    if (s->mode == 2) {
      {
        ...
        while_continue: /* CIL Label */;
          if (!(!(s->nblock >= s->nblockMAX))) {
             printf("<This branch (L5015) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((s->strm)->avail_in == 0U) {
            goto while_break;
          }
          ...
          ((s->strm)->total_in_lo32)++;
          if ((s->strm)->total_in_lo32 == 0U) {
             printf("<This branch (L5058) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      while_break: /* CIL Label */;
      }
    } else {
      {
        ...
        while_continue___0: /* CIL Label */;
          ...
          if ((s->strm)->avail_in == 0U) {
           ...
           printf("<This branch (L5073) is removed by Cov debloating tool>\n"); exit(6);
            ...
            if (s->avail_in_expect == 0U) {
              {
               ...
               printf("<This branch (L5216) is removed by Cov debloating tool>\n"); exit(6);
            }
          } else {
          _L:;
            if (s->nblock >= s->nblockMAX) {
              ...
              } printf("<This branch (L5224) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if ((s->strm)->avail_in == 0U) {
                goto while_break;
              }
    ...
    if (progress_in) {
      ...
      if (progress_out) {
        tmp___3 = 1;
         ...
         printf("<This branch (L5241) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return ((Bool)tmp___3);
  }
...
int BZ2_bzCompress(bz_stream *strm, int action) {
...

  {
    ...
    if ((unsigned long)s->strm != (unsigned long)strm) {
       printf("<This branch (L5263) is removed by Cov debloating tool>\n"); exit(6);
    }
  preswitch : {
    if (s->mode == 1) {
  ...
  case_2: ;/* CIL Label */
    if (action == 0) {
      ...
      if (action == 1) {
         ...
         printf("<This branch (L5296) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (action == 2) {
    ...
    if (s->avail_in_expect > 0U) {
      ...
      if (tmp___1) {
        if (s->state_out_pos < s->numZ) {
         ...
         printf("<This branch (L5349) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    s->mode = 1;
    return (4);
...
int BZ2_bzCompressEnd(bz_stream *strm) {
  ...
  {
    if ((unsigned long)strm == (unsigned long)((void *)0)) {
       printf("<This branch (L5364) is removed by Cov debloating tool>\n"); exit(6);
    }
    s = (EState *)strm->state;
    if ((unsigned long)s == (unsigned long)((void *)0)) {
       printf("<This branch (L5368) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)s->strm != (unsigned long)strm) {
...
int BZ2_bzDecompressInit(bz_stream *strm, int verbosity___0, int small) {
...

  {
    ...
    if ((unsigned long)strm == (unsigned long)((void *)0)) {
       printf("<This branch (L5405) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (small != 0) {
    ...
    if (verbosity___0 < 0) {
       printf("<This branch (L5413) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (verbosity___0 > 4) {
    ...
    if ((unsigned long)s == (unsigned long)((void *)0)) {
       printf("<This branch (L5427) is removed by Cov debloating tool>\n"); exit(6);
    }
    s->strm = strm;
    strm->state = (void *)s;
    s->state = 10;
...
static Bool unRLE_obuf_to_output_FAST(DState *s) {
...

  {
    if (s->blockRandomised) {
      ...
      } printf("<This branch (L5637) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      ...
      s_save_nblockPP = s->save_nblock + 1;
      {
        ...
        while_continue___1: /* CIL Label */;
          ...
          if (c_nblock_used > s_save_nblockPP) {
             printf("<This branch (L5688) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (c_nblock_used == s_save_nblockPP) {
            c_state_out_len = 0;
            goto return_notr;
          ...
          if (c_tPos >= 100000U * (UInt32)ro_blockSize100k) {
             printf("<This branch (L5696) is removed by Cov debloating tool>\n"); exit(6);
          }
          c_tPos = *(c_tt + c_tPos);
          ...
          if (c_nblock_used == s_save_nblockPP) {
             printf("<This branch (L5707) is removed by Cov debloating tool>\n"); exit(6);
          }
          c_state_out_len = 2;
          if (c_tPos >= 100000U * (UInt32)ro_blockSize100k) {
          ...
          c_nblock_used++;
          if (c_nblock_used == s_save_nblockPP) {
             printf("<This branch (L5718) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)k1 != c_k0) {
            c_k0 = (Int32)k1;
          ...
          c_nblock_used++;
          if (c_nblock_used == s_save_nblockPP) {
             printf("<This branch (L5733) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)k1 != c_k0) {
            c_k0 = (Int32)k1;
            goto while_continue___1;
          ...
          if (c_tPos >= 100000U * (UInt32)ro_blockSize100k) {
             printf("<This branch (L5748) is removed by Cov debloating tool>\n"); exit(6);
          }
          c_tPos = *(c_tt + c_tPos);
    ...
    return_notr:;
      ...
      if ((s->strm)->total_out_lo32 < total_out_lo32_old) {
         printf("<This branch (L5761) is removed by Cov debloating tool>\n"); exit(6);
      }
...
Int32 BZ2_indexIntoF(Int32 indx, Int32 *cftab) {
   ...
   printf("<This branch (L5800) is removed by Cov debloating tool>\n"); exit(6);
}
static Bool unRLE_obuf_to_output_SMALL(DState *s) {
   ...
   printf("<This branch (L6128) is removed by Cov debloating tool>\n"); exit(6);
}
int BZ2_bzDecompress(bz_stream *strm) {
  Bool corrupt;
  DState *s;
...

  {
    ...
    if ((unsigned long)s->strm != (unsigned long)strm) {
       printf("<This branch (L6145) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      while (1) {
      while_continue: /* CIL Label */;
        if (s->state == 1) {
           printf("<This branch (L6151) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (s->state == 2) {
          if (s->smallDecompress) {
            {

            } printf("<This branch (L6157) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            { corrupt = unRLE_obuf_to_output_FAST(s); }
          }
          if (corrupt) {
             printf("<This branch (L6162) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (s->nblock_used == s->save_nblock + 1) {
            if (s->state_out_len == 0) {
              ...
              if (s->calculatedBlockCRC != s->storedBlockCRC) {
                 printf("<This branch (L6181) is removed by Cov debloating tool>\n"); exit(6);
              }
        ...
        if (s->state >= 10) {
          ...
          if (r == 4) {
            ...
            if (s->calculatedCombinedCRC != s->storedCombinedCRC) {
               printf("<This branch (L6210) is removed by Cov debloating tool>\n"); exit(6);
            }
            return (r);
          }
          if (s->state != 2) {
...
int BZ2_bzDecompressEnd(bz_stream *strm) {
...

  {
    ...
    s = (DState *)strm->state;
    if ((unsigned long)s == (unsigned long)((void *)0)) {
       printf("<This branch (L6234) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)s->strm != (unsigned long)strm) {
       printf("<This branch (L6237) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)s->tt != (unsigned long)((void *)0)) {
      {
    ...
    if ((unsigned long)s->ll16 != (unsigned long)((void *)0)) {
      ...
      } printf("<This branch (L6247) is removed by Cov debloating tool>\n"); exit(6);
    }
...
BZFILE *BZ2_bzWriteOpen(int *bzerror, FILE *f, int blockSize100k___0,
...

  {
    ...
    if ((unsigned long)bzf != (unsigned long)((void *)0)) {
       printf("<This branch (L6290) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)f == (unsigned long)((void *)0)) {
       printf("<This branch (L6293) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (blockSize100k___0 < 1) {
         printf("<This branch (L6296) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (blockSize100k___0 > 9) {
           printf("<This branch (L6299) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (workFactor___0 < 0) {
    ...
    if (tmp) {
       ...
       printf("<This branch (L6334) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if ((unsigned long)bzf == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L6344) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)bzerror != (unsigned long)((void *)0)) {
      *bzerror = 0;
    }
...
void BZ2_bzWrite(int *bzerror, BZFILE *b, void *buf, int len) {
...

  {
    ...
    if ((unsigned long)bzf == (unsigned long)((void *)0)) {
       printf("<This branch (L6398) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    ...
    if (tmp) {
       ...
       printf("<This branch (L6432) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (len == 0) {
       ...
       printf("<This branch (L6441) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    bzf->strm.next_in = (char *)buf;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (ret != 1) {
           ...
           printf("<This branch (L6460) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (bzf->strm.avail_out < 5000U) {
          {
           ...
           printf("<This branch (L6484) is removed by Cov debloating tool>\n"); exit(6);
        }
...
void BZ2_bzWriteClose64(int *bzerror, BZFILE *b, int abandon,
...

  {
    ...
    if ((unsigned long)bzf == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L6523) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!bzf->writing) {
       ...
       printf("<This branch (L6532) is removed by Cov debloating tool>\n"); exit(6);
    }
    { tmp = ferror(bzf->handle); }
    if (tmp) {
       ...
       printf("<This branch (L6542) is removed by Cov debloating tool>\n"); exit(6);
    }
          ...
          while_continue: /* CIL Label */;
            ...
            if (ret != 3) {
              if (ret != 4) {
                 ...
                 printf("<This branch (L6574) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
            if (bzf->strm.avail_out < 5000U) {
              {
              ...
              if (n != n2) {
                 printf("<This branch (L6586) is removed by Cov debloating tool>\n"); exit(6);
              } else {
    ...
    if (!abandon) {
      ...
      if (!tmp___2) {
        ...
        if (tmp___1) {
           ...
           printf("<This branch (L6625) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    if ((unsigned long)nbytes_in_lo32 != (unsigned long)((void *)0)) {
...

  {
    ...
    if ((unsigned long)f == (unsigned long)((void *)0)) {
      ...
      if (small != 0) {
         ...
         printf("<This branch (L6677) is removed by Cov debloating tool>\n"); exit(6);
      } else {
      _L___2:;
        if (verbosity___0 < 0) {
           printf("<This branch (L6681) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (verbosity___0 > 4) {
             printf("<This branch (L6684) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            if ((unsigned long)unused == (unsigned long)((void *)0)) {
               ...
               printf("<This branch (L6691) is removed by Cov debloating tool>\n"); exit(6);
            } else {
            _L___1:;
              if ((unsigned long)unused != (unsigned long)((void *)0)) {
                if (nUnused < 0) {
                   printf("<This branch (L6696) is removed by Cov debloating tool>\n"); exit(6);
                } else {
                  if (nUnused > 5000) {
                  _L___0:;
    ...
    if ((unsigned long)bzf == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L6733) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)bzerror != (unsigned long)((void *)0)) {
      *bzerror = 0;
    }
...
void BZ2_bzReadClose(int *bzerror, BZFILE *b) {
...

  {
    ...
    if ((unsigned long)bzf == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L6796) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (bzf->writing) {
       ...
       printf("<This branch (L6805) is removed by Cov debloating tool>\n"); exit(6);
    }
...
int BZ2_bzRead(int *bzerror, BZFILE *b, void *buf, int len) {
...

  {
    ...
    if (bzf->writing) {
       ...
       printf("<This branch (L6858) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (len == 0) {
       ...
       printf("<This branch (L6867) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    bzf->strm.next_out = (char *)buf;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (tmp) {
           ...
           printf("<This branch (L6882) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (bzf->strm.avail_in == 0U) {
          {
        ...
        if (ret == 0) {
          ...
          if (tmp___2) {
            if (bzf->strm.avail_in == 0U) {
               ...
               printf("<This branch (L6935) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
        if (ret == 4) {
...
static Bool uInt64_isZero(UInt64 *n) {
   ...
   printf("<This branch (L7168) is removed by Cov debloating tool>\n"); exit(6);
}
static Int32 uInt64_qrm10(UInt64 *n) {
   ...
   printf("<This branch (L7192) is removed by Cov debloating tool>\n"); exit(6);
}
static void uInt64_toAscii(char *outbuf, UInt64 *n) {
   ...
   printf("<This branch (L7236) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void compressStream(FILE *stream, FILE *zStream) {
...

  {
    ...
    if (tmp) {
       printf("<This branch (L7293) is removed by Cov debloating tool>\n"); exit(6);
    }
    { tmp___0 = ferror(zStream); }
    if (tmp___0) {
       printf("<This branch (L7297) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if (bzerr != 0) {
       printf("<This branch (L7304) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (verbosity >= 2) {
      {


      } printf("<This branch (L7310) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      while (1) {
      while_continue: /* CIL Label */;
        ...
        if (tmp___2) {
           printf("<This branch (L7325) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (nIbuf > 0) {
          {
    ...
    if (bzerr != 0) {
       printf("<This branch (L7343) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if ((unsigned long)zStream != (unsigned long)stdout) {
      ...
      if (fd < 0) {
         printf("<This branch (L7359) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
      ...
      if (ret == -1) {
         printf("<This branch (L7367) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
      outputHandleJustInCase = (FILE *)((void *)0);
    ...
    if (tmp___5) {
       printf("<This branch (L7375) is removed by Cov debloating tool>\n"); exit(6);
    }
    { ret = fclose(stream); }
    if (ret == -1) {
    ...
    if (verbosity >= 1) {
       ...
       printf("<This branch (L7406) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  errhandler : {
...
static Bool uncompressStream(FILE *zStream, FILE *stream) {
...

  {
    ...
    { tmp___0 = ferror(zStream); }
    if (tmp___0) {
       printf("<This branch (L7492) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      while (1) {
      while_continue: /* CIL Label */;
        ...
        if ((unsigned long)bzf == (unsigned long)((void *)0)) {
           printf("<This branch (L7502) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (bzerr != 0) {
             printf("<This branch (L7505) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
        streamNo++;
        {
          ...
          while_continue___0: /* CIL Label */;
            ...
            if (bzerr == -5) {
               printf("<This branch (L7517) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (bzerr == 0) {
              goto _L;
            } else {
            ...
            if (tmp___1) {
               printf("<This branch (L7535) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        while_break___0: /* CIL Label */;
        }
        if (bzerr != 4) {
           printf("<This branch (L7541) is removed by Cov debloating tool>\n"); exit(6);
        }
        { BZ2_bzReadGetUnused(&bzerr, bzf, &unusedTmpV, &nUnused); }
        if (bzerr != 0) {
          {

          } printf("<This branch (L7547) is removed by Cov debloating tool>\n"); exit(6);
        }
        ...
        i = 0;
        {
          ...
          while_continue___1: /* CIL Label */;
            if (!(i < nUnused)) {
             ...
             printf("<This branch (L7557) is removed by Cov debloating tool>\n"); exit(6);
  ...
  closeok : { tmp___3 = ferror(zStream); }
    if (tmp___3) {
       printf("<This branch (L7581) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    { tmp___5 = ferror(stream); }
    if (tmp___5) {
       printf("<This branch (L7599) is removed by Cov debloating tool>\n"); exit(6);
    }
    { ret = fflush(stream); }
    if (ret != 0) {
    ...
    if ((unsigned long)stream != (unsigned long)stdout) {
      {
       ...
       printf("<This branch (L7612) is removed by Cov debloating tool>\n"); exit(6);
    }
    outputHandleJustInCase = (FILE *)((void *)0);
    if (verbosity >= 2) {
      {
      ...
      } printf("<This branch (L7619) is removed by Cov debloating tool>\n"); exit(6);
    }
    return ((Bool)1);
  trycat:;
...
static Bool testStream(FILE *zStream) {
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if ((unsigned long)bzf == (unsigned long)((void *)0)) {
           printf("<This branch (L7778) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (bzerr != 0) {
        ...
        i = 0;
        {
          ...
          while_continue___1: /* CIL Label */;
            if (!(i < nUnused)) {
             ...
             printf("<This branch (L7815) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (tmp___1) {
       printf("<This branch (L7839) is removed by Cov debloating tool>\n"); exit(6);
    }
    { ret = fclose(zStream); }
    if (ret == -1) {
    ...
    if (verbosity >= 2) {
      ...
      } printf("<This branch (L7849) is removed by Cov debloating tool>\n"); exit(6);
    }
    return ((Bool)1);
  errhandler : { BZ2_bzReadClose(&bzerr_dummy, bzf); }
    ...
    }
    {
      ...
      if (bzerr == -4) {
         printf("<This branch (L7867) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (bzerr == -3) {
      ...
      if (bzerr == -5) {
       ...
       printf("<This branch (L7878) is removed by Cov debloating tool>\n"); exit(6);
    case_neg_9 : ;/* CIL Label */
    {
    ...
    case_neg_5: ;/* CIL Label */
      ...
      if (streamNo == 1) {
        ...
        return ((Bool)0);
         ...
         printf("<This branch (L7928) is removed by Cov debloating tool>\n"); exit(6);
      }
    switch_default : ;/* CIL Label */
    {
...
static void cadvise(void) {
   ...
   printf("<This branch (L7967) is removed by Cov debloating tool>\n"); exit(6);
}
static void showFileNames(void) {
   ...
   printf("<This branch (L7982) is removed by Cov debloating tool>\n"); exit(6);
}
static __attribute__((__noreturn__)) void cleanUpAndFail(Int32 ec);
...
static void panic(Char const *s) {
   ...
   printf("<This branch (L8089) is removed by Cov debloating tool>\n"); exit(6);
}
static __attribute__((__noreturn__)) void crcError(void);
...
static void compressedStreamEOF(void) {
   ...
   printf("<This branch (L8124) is removed by Cov debloating tool>\n"); exit(6);
}
static __attribute__((__noreturn__)) void ioError(void);
static void ioError(void) {
   ...
   printf("<This branch (L8140) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void mySIGSEGVorSIGBUScatcher(IntNative n) {
   ...
   printf("<This branch (L8235) is removed by Cov debloating tool>\n"); exit(6);
}
static __attribute__((__noreturn__)) void outOfMemory(void);
...
static void configError(void) {
   ...
   printf("<This branch (L8270) is removed by Cov debloating tool>\n"); exit(6);
}
static void pad(Char *s) {
   ...
   printf("<This branch (L8299) is removed by Cov debloating tool>\n"); exit(6);
}
static void copyFileName(Char *to, Char *from) {
  size_t tmp;

  {
    ...
    if (tmp > 1024UL) {
      ...
      } printf("<This branch (L8317) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
...
static FILE *fopen_output_safely(Char *name, char const *mode) {
...

  {
    ...
    if (fh == -1) {
       printf("<This branch (L8355) is removed by Cov debloating tool>\n"); exit(6);
    }
    { fp = fdopen(fh, mode); }
    if ((unsigned long)fp == (unsigned long)((void *)0)) {
      {

      } printf("<This branch (L8361) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (fp);
  }
}
static Bool notAStandardFile(Char *name) {
...

  {
    ...
    if (i != 0) {
       printf("<This branch (L8377) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static Int32 countHardLinks(Char *name) {
...

  {
    ...
    if (i != 0) {
       printf("<This branch (L8396) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static void saveInputFileMetaInfo(Char *srcName) {
...

  {
    ...
    if (retVal != 0) {
      ...
      } printf("<This branch (L8413) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
static void applySavedFileAttrToOutputFile(IntNative fd) {
...

  {
    ...
    if (retVal != 0) {
      ...
      } printf("<This branch (L8444) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static Bool mapSuffix(Char *name, Char const *oldSuffix,
   ...
   printf("<This branch (L8499) is removed by Cov debloating tool>\n"); exit(6);
}
...

  {
    ...
    if ((unsigned long)name == (unsigned long)((void *)0)) {
      if (srcMode != 1) {
        ...
        } printf("<This branch (L8544) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
      if (srcMode == 1) {
      ...
      if (srcMode == 3) {
       ...
       printf("<This branch (L8554) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (srcMode != 1) {
      ...
      if (tmp) {
         ...
         printf("<This branch (L8594) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (srcMode != 1) {
      {
    ...
    i = 0;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (tmp___3) {
           ...
           printf("<This branch (L8634) is removed by Cov debloating tool>\n"); exit(6);
        }
        i++;
      }
    while_break: /* CIL Label */;
        ...
        if ((statBuf.st_mode & 61440U) == 16384U) {
          {
           ...
           printf("<This branch (L8657) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    if (srcMode == 3) {
      ...
      if (tmp___5) {
        if (forceOverwrite) {
        ...
        } else {
          {
           ...
           printf("<This branch (L8697) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    if (srcMode == 3) {
      if (!forceOverwrite) {
        ...
        if (n > 0) {
...

          {
           ...
           printf("<This branch (L8719) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    if (srcMode == 3) {
    ...
    }
    {
      ...
      if (srcMode == 2) {
         printf("<This branch (L8733) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (srcMode == 3) {
        goto case_3___0;
      }
       printf("<This branch (L8738) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (tmp___8) {
        {
         ...
         printf("<This branch (L8760) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      if ((unsigned long)outStr == (unsigned long)((void *)0)) {
        {
         ...
         printf("<This branch (L8827) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((unsigned long)inStr == (unsigned long)((void *)0)) {
        {
         ...
         printf("<This branch (L8845) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto switch_break___0;
    switch_default : ;/* CIL Label */
    {
    ...
    if (verbosity >= 1) {
      ...
      } printf("<This branch (L8861) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if (srcMode == 3) {
      ...
      if (!keepInputFiles) {
        ...
        if (retVal != 0) {
          ...
          } printf("<This branch (L8882) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    deleteOutputOnInterrupt = (Bool)0;
...
static void uncompress(Char *name) {
...

  {
    ...
    if ((unsigned long)name == (unsigned long)((void *)0)) {
      if (srcMode != 1) {
        ...
        } printf("<This branch (L8935) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    cantGuess = (Bool)0;
    {
      if (srcMode == 1) {
       ...
       printf("<This branch (L8943) is removed by Cov debloating tool>\n"); exit(6);
  ...
  zzz:;
    if (srcMode != 1) {
      {
       ...
       printf("<This branch (L9006) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (srcMode != 1) {
      {
       ...
       printf("<This branch (L9024) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (srcMode == 3) {
      ...
      if (srcMode == 2) {
         ...
         printf("<This branch (L9044) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (srcMode == 3) {
       ...
       printf("<This branch (L9064) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (cantGuess) {
       ...
       printf("<This branch (L9074) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (srcMode == 3) {
      {
       ...
       printf("<This branch (L9095) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (srcMode == 3) {
       ...
       printf("<This branch (L9117) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (srcMode == 3) {
      {

      } printf("<This branch (L9122) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      if (srcMode == 1) {
        goto case_1___0;
      }
       printf("<This branch (L9128) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (tmp___8) {
        {
         ...
         printf("<This branch (L9156) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto switch_break___0;
    case_2___0 : ;/* CIL Label */
    {
    ...
    if (verbosity >= 1) {
      ...
      } printf("<This branch (L9239) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      outputHandleJustInCase = outStr;
      deleteOutputOnInterrupt = (Bool)1;
    ...
    if (magicNumberOK) {
      if (srcMode == 3) {
       ...
       printf("<This branch (L9278) is removed by Cov debloating tool>\n"); exit(6);
    }
    deleteOutputOnInterrupt = (Bool)0;
    if (magicNumberOK) {
      if (verbosity >= 1) {
        ...
        } printf("<This branch (L9286) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
       ...
       printf("<This branch (L9302) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
static void testf(Char *name) {
...

  {
    ...
    if ((unsigned long)name == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L9332) is removed by Cov debloating tool>\n"); exit(6);
    }
    { copyFileName(outName, (Char *)"(none)"); }
    {
      ...
      if (srcMode == 3) {
       ...
       printf("<This branch (L9342) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (srcMode != 1) {
      ...
      if (tmp) {
         ...
         printf("<This branch (L9377) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (srcMode != 1) {
      {
      ...
      if (!tmp___2) {
        {
         ...
         printf("<This branch (L9394) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (srcMode != 1) {
      {
    ...
    {
      if (srcMode == 1) {
         printf("<This branch (L9416) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (srcMode == 2) {
         printf("<This branch (L9419) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (srcMode == 3) {
        goto case_2___0;
      }
       printf("<This branch (L9424) is removed by Cov debloating tool>\n"); exit(6);
    case_1___0 : ;/* CIL Label */
    {
      ...
      if ((unsigned long)inStr == (unsigned long)((void *)0)) {
        {
         ...
         printf("<This branch (L9465) is removed by Cov debloating tool>\n"); exit(6);
      }
      goto switch_break___0;
    switch_default : ;/* CIL Label */
    {
    ...
    if (allOK) {
      if (verbosity >= 1) {
        ...
        } printf("<This branch (L9492) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!allOK) {
...
static void license(void) {
   ...
   printf("<This branch (L9528) is removed by Cov debloating tool>\n"); exit(6);
}
static void usage(Char *fullProgName) {
   ...
   printf("<This branch (L9574) is removed by Cov debloating tool>\n"); exit(6);
}
static void redundant(Char *flag) {
   ...
   printf("<This branch (L9586) is removed by Cov debloating tool>\n"); exit(6);
}
static void *myMalloc(Int32 n) {
  void *p;
      ...
      tmp___3 = root;
      {
        ...
        while_continue: /* CIL Label */;
          if (!((unsigned long)tmp___3->link != (unsigned long)((void *)0))) {
           ...
           printf("<This branch (L9638) is removed by Cov debloating tool>\n"); exit(6);
        }
      while_break: /* CIL Label */;
      }
...
static void addFlagsFromEnvVar(Cell **argList, Char *varName) {
...

  {
    ...
    if ((unsigned long)envbase != (unsigned long)((void *)0)) {
      ...
      } printf("<This branch (L9721) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
IntNative main(IntNative argc, Char **argv) {
...

  {
    if (sizeof(Int32) != 4UL) {
      ...
      } printf("<This branch (L9774) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (sizeof(UInt32) != 4UL) {
        {

        } printf("<This branch (L9779) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (sizeof(Int16) != 2UL) {
          {
          ...
          if (sizeof(UInt16) != 2UL) {
            ...
            if (sizeof(Char) != 1UL) {
              ...
              } printf("<This branch (L9794) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if (sizeof(UChar) != 1UL) {
                {

                } printf("<This branch (L9799) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
          }
        }
    ...
    aa = argList;
    {
      ...
      while_continue___1: /* CIL Label */;
        ...
        if (tmp___0 == 0) {
           ...
           printf("<This branch (L9876) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)*(aa->name + 0) == 45) {
          if (decode) {
            goto __Cont;
    ...
    if ((unsigned long)tmp___3 != (unsigned long)((char *)0)) {
       printf("<This branch (L9907) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    ...
    if ((unsigned long)tmp___5 != (unsigned long)((char *)0)) {
       printf("<This branch (L9916) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      { tmp___6 = strstr((char const *)progName, "Z2CAT"); }
      if ((unsigned long)tmp___6 != (unsigned long)((char *)0)) {
         printf("<This branch (L9920) is removed by Cov debloating tool>\n"); exit(6);
      } else {
    ...
    aa = argList;
    {
      ...
      while_continue___2: /* CIL Label */;
        ...
        if (tmp___9 == 0) {
           printf("<This branch (L9948) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)*(aa->name + 0) == 45) {
          if ((int)*(aa->name + 1) != 45) {
            j = 1;
              ...
              while_continue___3: /* CIL Label */;
                ...
                }
                {
                  ...
                  if ((int)*(aa->name + j) == 107) {
                   ...
                   printf("<This branch (L9978) is removed by Cov debloating tool>\n"); exit(6);
    ...
    aa = argList;
    {
      ...
      while_continue___4: /* CIL Label */;
        ...
        if (tmp___28 == 0) {
           printf("<This branch (L10125) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          ...
          if (tmp___27 == 0) {
            ...
            if (tmp___26 == 0) {
               printf("<This branch (L10133) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              ...
              if (tmp___25 == 0) {
                ...
                if (tmp___24 == 0) {
                   printf("<This branch (L10141) is removed by Cov debloating tool>\n"); exit(6);
                } else {
                  { tmp___23 = strcmp((char const *)aa->name, "--keep"); }
                  if (tmp___23 == 0) {
                     printf("<This branch (L10145) is removed by Cov debloating tool>\n"); exit(6);
                  } else {
                    ...
                    if (tmp___22 == 0) {
                      ...
                      if (tmp___21 == 0) {
                         printf("<This branch (L10153) is removed by Cov debloating tool>\n"); exit(6);
                      } else {
                        {
                          tmp___20 =
                        ...
                        if (tmp___20 == 0) {
                          ...
                          } printf("<This branch (L10162) is removed by Cov debloating tool>\n"); exit(6);
                        } else {
                          {
                            tmp___19 =
                          ...
                          if (tmp___19 == 0) {
                            ...
                            } printf("<This branch (L10171) is removed by Cov debloating tool>\n"); exit(6);
                          } else {
                            {
                            ...
                            if (tmp___18 == 0) {
                               printf("<This branch (L10178) is removed by Cov debloating tool>\n"); exit(6);
                            } else {
                              {
                              ...
                              if (tmp___17 == 0) {
                                ...
                                if (tmp___16 == 0) {
                                  ...
                                  } printf("<This branch (L10196) is removed by Cov debloating tool>\n"); exit(6);
                                } else {
                                  {
                                  ...
                                  if (tmp___15 == 0) {
                                    ...
                                    if (tmp___14 == 0) {
                                       printf("<This branch (L10210) is removed by Cov debloating tool>\n"); exit(6);
                                    } else {
                                      {
                                        tmp___13 =
                                      ...
                                      if (tmp___13 == 0) {
                                        ...
                                        if (tmp___12 == 0) {
                                          ...
                                          } printf("<This branch (L10228) is removed by Cov debloating tool>\n"); exit(6);
                                        } else {
                                          {
                                            tmp___11 =
    ...
    if (opMode == 3) {
      if (srcMode == 2) {
        ...
        } printf("<This branch (L10295) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (srcMode == 2) {
      if (numFileNames == 0) {
    ...
    if (opMode == 1) {
        ...
        aa = argList;
        {
          ...
          while_continue___5: /* CIL Label */;
            ...
            if (tmp___29 == 0) {
               ...
               printf("<This branch (L10330) is removed by Cov debloating tool>\n"); exit(6);
            }
            if ((int)*(aa->name + 0) == 45) {
              if (decode) {
                goto __Cont___0;
      ...
      if (opMode == 2) {
        ...
        if (srcMode == 1) {
          ...
          } printf("<This branch (L10381) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (unzFailsExist) {
          {


          } printf("<This branch (L10387) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
        testFailsExist = (Bool)0;
        if (srcMode == 1) {
          ...
          } printf("<This branch (L10394) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          decode = (Bool)1;
          aa = argList;
          {
            ...
            while_continue___7: /* CIL Label */;
              ...
              if (tmp___31 == 0) {
                 ...
                 printf("<This branch (L10407) is removed by Cov debloating tool>\n"); exit(6);
              }
              if ((int)*(aa->name + 0) == 45) {
                if (decode) {
                  goto __Cont___2;
...
__inline static void fallbackSimpleSort(UInt32 *fmap, UInt32 *eclass, Int32 lo,
   ...
   printf("<This branch (L10538) is removed by Cov debloating tool>\n"); exit(6);
}
static void fallbackQSort3(UInt32 *fmap, UInt32 *eclass, Int32 loSt,
   ...
   printf("<This branch (L10739) is removed by Cov debloating tool>\n"); exit(6);
}
static void fallbackSort(UInt32 *fmap, UInt32 *eclass, UInt32 *bhtab,
...

  {
              ...
              while_continue___10: /* CIL Label */;
                if (*(bhtab + (k >> 5)) & (unsigned int)(1 << (k & 31))) {
                  if (!(k & 31)) {
                   ...
                   printf("<This branch (L10916) is removed by Cov debloating tool>\n"); exit(6);
                }
                 printf("<This branch (L10918) is removed by Cov debloating tool>\n"); exit(6);
              }
            while_break___10: /* CIL Label */;
            }
            if (*(bhtab + (k >> 5)) & (unsigned int)(1 << (k & 31))) {
              {
                ...
                while_continue___11: /* CIL Label */;
                  if (!(*(bhtab + (k >> 5)) == 4294967295U)) {
                   ...
                   printf("<This branch (L10929) is removed by Cov debloating tool>\n"); exit(6);
                }
              while_break___11: /* CIL Label */;
              }
              {
    ...
    if (verb >= 4) {
      ...
      } printf("<This branch (L11038) is removed by Cov debloating tool>\n"); exit(6);
    }
    j = 0;
    i = 0;
    {
    ...
    if (!(j < 256)) {
      ...
      } printf("<This branch (L11067) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...

  {
    ...
    k = (Int32)(nblock + 8U);
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (i2 >= nblock) {
           printf("<This branch (L11269) is removed by Cov debloating tool>\n"); exit(6);
        }
        k -= 8;
        (*budget)--;
        if (!(k >= 0)) {
           printf("<This branch (L11274) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
        ...
        i = lo + h;
        {
          ...
          while_continue___1: /* CIL Label */;
            ...
            *(ptr + j) = v;
            i++;
            if (*budget < 0) {
               printf("<This branch (L11401) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        while_break___1: /* CIL Label */;
        }
    ...
    sp++;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (!(sp < 98)) {
          ...
          } printf("<This branch (L11487) is removed by Cov debloating tool>\n"); exit(6);
        }
        sp--;
        lo = stackLo[sp];
        hi = stackHi[sp];
        ...
        if (hi - lo < 20) {
          ...
          _L : {
            ...
            if (*budget < 0) {
               printf("<This branch (L11501) is removed by Cov debloating tool>\n"); exit(6);
            }
            goto while_continue;
          }
        }
...
static void mainSort(UInt32 *ptr, UChar *block, UInt16 *quadrant, UInt32 *ftab,
...

  {
    ...
    if (verb >= 4) {
      ...
      } printf("<This branch (L11794) is removed by Cov debloating tool>\n"); exit(6);
    }
    i = 1;
    {
      while (1) {
      ...
      while_continue___11: /* CIL Label */;
              ...
              if (!(*(ftab + sb) & (unsigned int)(1 << 21))) {
                ...
                if (hi > lo) {
                  if (verb >= 4) {
                    ...
                    } printf("<This branch (L11946) is removed by Cov debloating tool>\n"); exit(6);
                  }
                  {
                  ...
                  if (*budget < 0) {
                     printf("<This branch (L11953) is removed by Cov debloating tool>\n"); exit(6);
                  }
                }
              }
                    ...
                    1U);
        {
          ...
          while_continue___15: /* CIL Label */;
            ...
            k = (Int32)(*(ptr + j) - 1U);
            if (k < 0) {
               printf("<This branch (L12015) is removed by Cov debloating tool>\n"); exit(6);
            }
            c1 = *(block + k);
            if (!bigDone[c1]) {
              tmp___0 = copyEnd[c1];
        ...
        if (!(copyStart[ss] - 1 == copyEnd[ss])) {
           ...
           printf("<This branch (L12036) is removed by Cov debloating tool>\n"); exit(6);
        }
        j = 0;
        {
          while (1) {
        ...
        if (i < 255) {
          ...
          shifts = 0;
          {
            ...
            while_continue___17: /* CIL Label */;
              if (!(bbSize >> shifts > 65534)) {
               ...
               printf("<This branch (L12063) is removed by Cov debloating tool>\n"); exit(6);
            }
          while_break___17: /* CIL Label */;
          }
          j = bbSize - 1;
          ...
          if (!((bbSize - 1) >> shifts <= 65535)) {
            ...
            } printf("<This branch (L12087) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
        i++;
      }
    ...
    if (verb >= 4) {
      ...
      } printf("<This branch (L12100) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
void BZ2_blockSort(EState *s) {
...

  {
    ...
    if (nblock < 10000) {
      ...
      i = nblock + 34;
      if (i & 1) {
         printf("<This branch (L12132) is removed by Cov debloating tool>\n"); exit(6);
      }
      quadrant = (UInt16 *)(block + i);
      if (wfact < 1) {
         printf("<This branch (L12136) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (wfact > 100) {
         printf("<This branch (L12139) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
      ...
      if (verb >= 3) {
        ...
        } printf("<This branch (L12158) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (budget < 0) {
         ...
         printf("<This branch (L12169) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    s->origPtr = -1;
    i = 0;
    {
      ...
      while_continue: /* CIL Label */;
        if (!(i < s->nblock)) {
           printf("<This branch (L12178) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (*(ptr + i) == 0U) {
          s->origPtr = i;
          goto while_break;
    ...
    if (!(s->origPtr != -1)) {
      ...
      } printf("<This branch (L12191) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
