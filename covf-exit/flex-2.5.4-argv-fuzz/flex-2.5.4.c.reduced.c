    ...
    if (outfile_created) {
      ...
      if (tmp___3) {
        ...
        if (tmp___2) {
          ...
          } printf("<This branch (L771) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          {
...
{ 
  ...
  *yyvsp = yyval;
  ...
  if ((unsigned long )yyssp == (unsigned long )yyss) {
     printf("<This branch (L10906) is removed by Cov debloating tool>\n"); exit(6);
  }
  yyvsp --;
  yyssp --;
  yystate = (int )*yyssp;
  ...
  if (yyn > 110) {
     printf("<This branch (L10921) is removed by Cov debloating tool>\n"); exit(6);
  } else { //Added block
  ...
  if (yyn == 0) {
     printf("<This branch (L10937) is removed by Cov debloating tool>\n"); exit(6);
  }
  }
  if (yyn == 107) {
     printf("<This branch (L10941) is removed by Cov debloating tool>\n"); exit(6);
  }
  yyvsp ++;
  *yyvsp = yylval;
  yystate = yyn;
  ...
  if (yy_current_buffer->yy_buffer_status == 2) {
    ...
    while (1) {
      ...
      if (b->yy_is_our_buffer) {
        ...
        if (new_size <= 0) {
           printf("<This branch (L15666) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          b->yy_buf_size *= 2U;
        }
        {
  ...
  while (1) {
    ...
    if (*yy_cp) {
      tmp = (int )yy_ec[(unsigned int )((unsigned char )*yy_cp)];
       ...
       printf("<This branch (L15790) is removed by Cov debloating tool>\n"); exit(6);
    }
    yy_c = (YY_CHAR )tmp;
    if (yy_accept[yy_current_state]) {
      yy_last_accepting_state = yy_current_state;
