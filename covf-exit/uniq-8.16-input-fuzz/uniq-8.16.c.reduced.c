...
void close_stdout(void) {
...

  {
    ...
    if (tmp___3 != 0) {
       ...
       printf("<This branch (L1348) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
...
int close_stream(FILE *stream) {
...

  {
    ...
    if (prev_fail) {
       printf("<This branch (L1388) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (fclose_fail) {
         ...
         printf("<This branch (L1407) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (0);
  }
...
int c_tolower(int c) {
   ...
   printf("<This branch (L1509) is removed by Cov debloating tool>\n"); exit(6);
}
char *last_component(char const *name) __attribute__((__pure__));
...
void argmatch_invalid(char const *context, char const *value, ptrdiff_t problem) {
   ...
   printf("<This branch (L1780) is removed by Cov debloating tool>\n"); exit(6);
}
void argmatch_valid(char const *const *arglist, char const *vallist, size_t valsize) {
...
strtol_error xstrtoul(char const *s, char **ptr, int strtol_base, unsigned long *val,
...

  {
    ...
    if ((int)ch == 45) {
       printf("<This branch (L1997) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
...
void *xrealloc(void *p, size_t n) {

  {
    if (!n) {
       ...
       printf("<This branch (L2325) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      p = realloc(p, n);
    }
    if (!p) {
       ...
       printf("<This branch (L2335) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (p);
  }
}
...
void xalloc_die(void) {
   ...
   printf("<This branch (L2366) is removed by Cov debloating tool>\n"); exit(6);
}
...
void version_etc_arn(FILE *stream, char const *command_name, char const *package,
   ...
   printf("<This branch (L3046) is removed by Cov debloating tool>\n"); exit(6);
}
void version_etc_va(FILE *stream, char const *command_name, char const *package,
                    char const *version, va_list authors) {
   ...
   printf("<This branch (L3080) is removed by Cov debloating tool>\n"); exit(6);
}
void version_etc(FILE *stream, char const *command_name, char const *package,
                 char const *version, ...) __attribute__((__sentinel__));
void version_etc(FILE *stream, char const *command_name, char const *package,
   ...
   printf("<This branch (L3095) is removed by Cov debloating tool>\n"); exit(6);
}
char const version_etc_copyright[47] =
...
__inline static char *xcharalloc(size_t n) {
   ...
   printf("<This branch (L3381) is removed by Cov debloating tool>\n"); exit(6);
}
...
static struct quoting_options quoting_options_from_style(enum quoting_style style) {
   ...
   printf("<This branch (L3443) is removed by Cov debloating tool>\n"); exit(6);
}
static char const *gettext_quote(char const *msgid, enum quoting_style s) {
   ...
   printf("<This branch (L3500) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t quotearg_buffer_restyled(char *buffer, size_t buffersize, char const *arg,
   ...
   printf("<This branch (L4668) is removed by Cov debloating tool>\n"); exit(6);
}
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize, struct quoting_options const *options) {
   ...
   printf("<This branch (L4762) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_n_style(int n, enum quoting_style s, char const *arg) {
   ...
   printf("<This branch (L4778) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_n_style_mem(int n, enum quoting_style s, char const *arg, size_t argsize) {
...
void set_program_name(char const *argv0) {
...

  {
    if ((unsigned long)argv0 == (unsigned long)((void *)0)) {
      ...
      } printf("<This branch (L4874) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if ((unsigned long)slash != (unsigned long)((void *)0)) {
      base = slash + 1;
       ...
       printf("<This branch (L4882) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (base - argv0 >= 7L) {
      {
       ...
       printf("<This branch (L4897) is removed by Cov debloating tool>\n"); exit(6);
    }
    program_name = argv0;
...
int posix2_version(void) {
   ...
   printf("<This branch (L4955) is removed by Cov debloating tool>\n"); exit(6);
}
...
__inline static int strcoll_loop(char const *s1, size_t s1size, char const *s2,
   ...
   printf("<This branch (L5480) is removed by Cov debloating tool>\n"); exit(6);
}
int memcoll(char *s1, size_t s1len, char *s2, size_t s2len) {
   ...
   printf("<This branch (L5515) is removed by Cov debloating tool>\n"); exit(6);
}
...
static char const *get_charset_aliases(void) {
   ...
   printf("<This branch (L5821) is removed by Cov debloating tool>\n"); exit(6);
}
char const *locale_charset(void) {
   ...
   printf("<This branch (L5882) is removed by Cov debloating tool>\n"); exit(6);
}
...
struct linebuffer *readlinebuffer_delim(struct linebuffer *linebuffer, FILE *stream,
...

  {
    ...
    if (tmp) {
       printf("<This branch (L5921) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      while (1) {
      while_continue: /* CIL Label */;
        ...
        if (c == -1) {
          if ((unsigned long)p == (unsigned long)buffer) {
           ...
           printf("<This branch (L5940) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (p) {
      if (1) {
      ...
      } else {
        {
         ...
         printf("<This branch (L6054) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (hard);
  }
...
static _Bool protect_fd(int fd) {
   ...
   printf("<This branch (L6141) is removed by Cov debloating tool>\n"); exit(6);
}
FILE *freopen_safer(char const *name, char const *mode, FILE *f) {
  _Bool protect_in;
  _Bool protect_out;
...

  {
    ...
    {
      if (tmp == 2) {
         printf("<This branch (L6167) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tmp == 1) {
         printf("<This branch (L6170) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tmp == 0) {
        goto case_0;
      }
      ...
      if (protect_out) {
        {
         ...
         printf("<This branch (L6220) is removed by Cov debloating tool>\n"); exit(6);
      } else {
      _L:;
        if (protect_err) {
          {
    ...
    if (protect_in) {
      ...
      } printf("<This branch (L6260) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!f) {
      {


      } printf("<This branch (L6266) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (f);
  }
}
    ...
    if (fd < 0) {
      {
       ...
       printf("<This branch (L6341) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
...
__inline static void emit_ancillary_info(void) {
   ...
   printf("<This branch (L6520) is removed by Cov debloating tool>\n"); exit(6);
}
...
void usage(int status) {
   ...
   printf("<This branch (L6615) is removed by Cov debloating tool>\n"); exit(6);
}
...

  {
    ...
    }
    {
      if ((unsigned int)tmp == 0U) {
       ...
       printf("<This branch (L6632) is removed by Cov debloating tool>\n"); exit(6);
    ...
    _L___2 : {
      ...
      }
      {
        ...
        while_continue___1: /* CIL Label */;
          ...
          if (tmp___14) {
             printf("<This branch (L6964) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
          ...
          if ((unsigned long)tmp___10 == (unsigned long)((struct linebuffer *)0)) {
            ...
            if (tmp___9) {
               printf("<This branch (L6974) is removed by Cov debloating tool>\n"); exit(6);
            }
            goto while_break___1;
          }
          {
          ...
          if (match_count == 0xffffffffffffffffUL) {
             printf("<This branch (L6991) is removed by Cov debloating tool>\n"); exit(6);
          }
...

  {
          ...
          _L___3 : {
            ...
            _L___2:;
            ...
            } else {
              {
                ...
                if (optc == 50) {
                   printf("<This branch (L7181) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 51) {
                ...
                if (optc == 53) {
                   printf("<This branch (L7190) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 54) {
                   printf("<This branch (L7193) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 55) {
                   printf("<This branch (L7196) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 56) {
                   printf("<This branch (L7199) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 57) {
                ...
                if (optc == 119) {
                 ...
                 printf("<This branch (L7228) is removed by Cov debloating tool>\n"); exit(6);
                ...
                if ((int)*(optarg + 0) == 43) {
                  {
                   ...
                   printf("<This branch (L7259) is removed by Cov debloating tool>\n"); exit(6);
                } else {
                _L___1:;
                  if (nfiles == 2) {
                    {
                    ...
                    } printf("<This branch (L7268) is removed by Cov debloating tool>\n"); exit(6);
                  } else {
                    tmp___6 = nfiles;
                    nfiles++;
    ...
    if ((unsigned int)countmode == 0U) {
      if (output_later_repeated) {
        ...
        } printf("<This branch (L7366) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
