...
void reset_eof(void) {
   ...
   printf("<This branch (L952) is removed by Cov debloating tool>\n"); exit(6);
}
union block *find_next_block(void) {
...
void xclose(int fd) {
...

  {
    ...
    if (tmp___0 != 0) {
      ...
      } printf("<This branch (L1006) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
static _Bool check_label_pattern(union block *label) {
   ...
   printf("<This branch (L1054) is removed by Cov debloating tool>\n"); exit(6);
}
void open_archive(enum access_mode wanted_access) {
  int backed_up_flag;
  char *tmp;
...
void archive_read_error(void) {
   ...
   printf("<This branch (L1838) is removed by Cov debloating tool>\n"); exit(6);
}
static void short_read(size_t status) {
   ...
   printf("<This branch (L1939) is removed by Cov debloating tool>\n"); exit(6);
}
void flush_read(void) {
  size_t status;
  char *tmp;
...
static void backspace_output(void) {
   ...
   printf("<This branch (L2404) is removed by Cov debloating tool>\n"); exit(6);
}
void close_archive(void) {
  int tmp;
  int tmp___0;
...
void closeout_volume_number(void) {
   ...
   printf("<This branch (L2565) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool new_volume(enum access_mode mode) {
   ...
   printf("<This branch (L3069) is removed by Cov debloating tool>\n"); exit(6);
}
...
void diff_init(void) {
   ...
   printf("<This branch (L3134) is removed by Cov debloating tool>\n"); exit(6);
}
void report_difference(struct tar_stat_info *st __attribute__((__unused__)),
                       char const *fmt, ...) {
   ...
   printf("<This branch (L3159) is removed by Cov debloating tool>\n"); exit(6);
}
static int process_noop(size_t size __attribute__((__unused__)),
                        char *data __attribute__((__unused__))) {

   printf("<This branch (L3164) is removed by Cov debloating tool>\n"); exit(6);
}
static int process_rawdata(size_t bytes, char *buffer___2) {
   ...
   printf("<This branch (L3207) is removed by Cov debloating tool>\n"); exit(6);
}
...
static int process_dumpdir(size_t bytes, char *buffer___2) {
   ...
   printf("<This branch (L3229) is removed by Cov debloating tool>\n"); exit(6);
}
static void read_and_process(off_t size, int (*processor)(size_t, char *)) {
   ...
   printf("<This branch (L3277) is removed by Cov debloating tool>\n"); exit(6);
}
static int get_stat_data(char const *file_name, struct stat *stat_data) {
   ...
   printf("<This branch (L3304) is removed by Cov debloating tool>\n"); exit(6);
}
void diff_archive(void) {
   ...
   printf("<This branch (L3810) is removed by Cov debloating tool>\n"); exit(6);
}
void verify_volume(void) {
   ...
   printf("<This branch (L3958) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void to_base256(int negative, uintmax_t value, char *where,
   ...
   printf("<This branch (L4105) is removed by Cov debloating tool>\n"); exit(6);
}
...
static uintmax_t gid_substitute(int *negative) {
   ...
   printf("<This branch (L4355) is removed by Cov debloating tool>\n"); exit(6);
}
void gid_to_chars(gid_t v, char *p, size_t s) {
  char *__cil_tmp4;
...
void size_to_chars(size_t v, char *p, size_t s) {
   ...
   printf("<This branch (L4537) is removed by Cov debloating tool>\n"); exit(6);
}
void time_to_chars(time_t v, char *p, size_t s) {
  char *__cil_tmp4;
...
static uintmax_t uid_substitute(int *negative) {
   ...
   printf("<This branch (L4568) is removed by Cov debloating tool>\n"); exit(6);
}
void uid_to_chars(uid_t v, char *p, size_t s) {
  char *__cil_tmp4;
...
union block *start_private_header(char const *name, size_t size) {
   ...
   printf("<This branch (L4686) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void write_gnu_long_link(struct tar_stat_info *st, char const *p,
   ...
   printf("<This branch (L4749) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t split_long_name(char const *name, size_t length) {
   ...
   printf("<This branch (L4773) is removed by Cov debloating tool>\n"); exit(6);
}
static union block *write_ustar_long_name(char const *name) {
   ...
   printf("<This branch (L4834) is removed by Cov debloating tool>\n"); exit(6);
}
static void write_long_link(struct tar_stat_info *st) {
   ...
   printf("<This branch (L4891) is removed by Cov debloating tool>\n"); exit(6);
}
static union block *write_long_name(struct tar_stat_info *st) {
   ...
   printf("<This branch (L4962) is removed by Cov debloating tool>\n"); exit(6);
}
...
void pad_archive(off_t size_left) {
   ...
   printf("<This branch (L5505) is removed by Cov debloating tool>\n"); exit(6);
}
...
static unsigned int hash_link(void const *entry, unsigned int n_buckets) {
   ...
   printf("<This branch (L6070) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool compare_links(void const *entry1, void const *entry2) {
   ...
   printf("<This branch (L6081) is removed by Cov debloating tool>\n"); exit(6);
}
static void unknown_file_error(char *p) {
   ...
   printf("<This branch (L6098) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void move_archive(off_t count) {
   ...
   printf("<This branch (L6784) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void write_recent_bytes(char *data, size_t bytes) {
   ...
   printf("<This branch (L6868) is removed by Cov debloating tool>\n"); exit(6);
}
void delete_archive_members(void) {
...
static void repair_delayed_set_stat(char const *dir,
   ...
   printf("<This branch (L7585) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool file_newer_p(char const *file_name,
   ...
   printf("<This branch (L7717) is removed by Cov debloating tool>\n"); exit(6);
}
...
void fatal_exit(void) {
   ...
   printf("<This branch (L8997) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool xheader_keyword_deleted_p(char const *kw) {
   ...
   printf("<This branch (L9068) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool xheader_keyword_override_p(char const *keyword) {
   ...
   printf("<This branch (L9091) is removed by Cov debloating tool>\n"); exit(6);
}
static void xheader_list_append(struct keyword_list **root, char const *kw,
   ...
   printf("<This branch (L9116) is removed by Cov debloating tool>\n"); exit(6);
}
static void xheader_list_destroy(struct keyword_list **root) {
   ...
   printf("<This branch (L9144) is removed by Cov debloating tool>\n"); exit(6);
}
static __attribute__((__noreturn__)) void xheader_set_single_keyword(char *kw);
static void xheader_set_single_keyword(char *kw) {
   ...
   printf("<This branch (L9157) is removed by Cov debloating tool>\n"); exit(6);
}
static void xheader_set_keyword_equal(char *kw, char *eq) {
   ...
   printf("<This branch (L9269) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_set_option(char *string) {
   ...
   printf("<This branch (L9306) is removed by Cov debloating tool>\n"); exit(6);
}
static void to_decimal(uintmax_t value, char *where, size_t size) {
   ...
   printf("<This branch (L9354) is removed by Cov debloating tool>\n"); exit(6);
}
...
char *xheader_xhdr_name(struct tar_stat_info *st) {
   ...
   printf("<This branch (L9596) is removed by Cov debloating tool>\n"); exit(6);
}
char *xheader_ghdr_name(void) {
...
static struct xhdr_tab const *locate_handler(char const *keyword) {
   ...
   printf("<This branch (L9743) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool xheader_protected_pattern_p(char const *pattern) {
   ...
   printf("<This branch (L9770) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool xheader_protected_keyword_p(char const *keyword) {
...
static _Bool decode_record(char **p,
   ...
   printf("<This branch (L9862) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void decx(void *data, char const *keyword, char const *value) {
   ...
   printf("<This branch (L9918) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_decode(struct tar_stat_info *st) {
  char *p;
  char *endp;
...
static void decg(void *data, char const *keyword, char const *value) {
   ...
   printf("<This branch (L9960) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_decode_global(void) {
   ...
   printf("<This branch (L9992) is removed by Cov debloating tool>\n"); exit(6);
}
static void extended_header_init(void) {
   ...
   printf("<This branch (L10007) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_store(char const *keyword, struct tar_stat_info const *st,
                   void *data) {
   ...
   printf("<This branch (L10037) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_read(union block *p, size_t size) {
...
static size_t format_uintmax(uintmax_t val, char *buf, size_t s) {
   ...
   printf("<This branch (L10127) is removed by Cov debloating tool>\n"); exit(6);
}
static void xheader_print(struct xheader *xhdr, char const *keyword,
   ...
   printf("<This branch (L10252) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_finish(struct xheader *xhdr) {
   ...
   printf("<This branch (L10304) is removed by Cov debloating tool>\n"); exit(6);
}
void xheader_destroy(struct xheader *xhdr) {
  struct obstack *__o;
  void *__obj;
...
static void code_string(char const *string, char const *keyword,
   ...
   printf("<This branch (L10355) is removed by Cov debloating tool>\n"); exit(6);
}
static void decode_string(char **string, char const *arg) {
   ...
   printf("<This branch (L10374) is removed by Cov debloating tool>\n"); exit(6);
}
static void code_time(time_t t, unsigned long nano, char const *keyword,
   ...
   printf("<This branch (L10404) is removed by Cov debloating tool>\n"); exit(6);
}
static void decode_time(char const *arg, time_t *secs, unsigned long *nsecs) {
   ...
   printf("<This branch (L10429) is removed by Cov debloating tool>\n"); exit(6);
}
static void code_num(uintmax_t value, char const *keyword,
   ...
   printf("<This branch (L10447) is removed by Cov debloating tool>\n"); exit(6);
}
static void dummy_coder(struct tar_stat_info const *st
   ...
   printf("<This branch (L10455) is removed by Cov debloating tool>\n"); exit(6);
}
static void dummy_decoder(struct tar_stat_info *st __attribute__((__unused__)),
                          char const *arg __attribute__((__unused__))) {

   printf("<This branch (L10460) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void atime_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10479) is removed by Cov debloating tool>\n"); exit(6);
}
static void gid_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10488) is removed by Cov debloating tool>\n"); exit(6);
}
static void gid_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10501) is removed by Cov debloating tool>\n"); exit(6);
}
static void gname_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10510) is removed by Cov debloating tool>\n"); exit(6);
}
static void gname_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10517) is removed by Cov debloating tool>\n"); exit(6);
}
static void linkpath_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10526) is removed by Cov debloating tool>\n"); exit(6);
}
static void linkpath_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10533) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void ctime_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10552) is removed by Cov debloating tool>\n"); exit(6);
}
static void mtime_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10564) is removed by Cov debloating tool>\n"); exit(6);
}
static void mtime_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10571) is removed by Cov debloating tool>\n"); exit(6);
}
static void path_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10580) is removed by Cov debloating tool>\n"); exit(6);
}
static void path_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10591) is removed by Cov debloating tool>\n"); exit(6);
}
static void size_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10600) is removed by Cov debloating tool>\n"); exit(6);
}
static void size_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10616) is removed by Cov debloating tool>\n"); exit(6);
}
static void uid_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10625) is removed by Cov debloating tool>\n"); exit(6);
}
static void uid_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10638) is removed by Cov debloating tool>\n"); exit(6);
}
static void uname_coder(struct tar_stat_info const *st, char const *keyword,
   ...
   printf("<This branch (L10647) is removed by Cov debloating tool>\n"); exit(6);
}
static void uname_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10654) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_size_coder(struct tar_stat_info const *st,
   ...
   printf("<This branch (L10663) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_size_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10676) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_numblocks_coder(struct tar_stat_info const *st,
   ...
   printf("<This branch (L10685) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_numblocks_decoder(struct tar_stat_info *st,
   ...
   printf("<This branch (L10705) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_offset_coder(struct tar_stat_info const *st,
   ...
   printf("<This branch (L10718) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_offset_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10731) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_numbytes_coder(struct tar_stat_info const *st,
   ...
   printf("<This branch (L10744) is removed by Cov debloating tool>\n"); exit(6);
}
static void sparse_numbytes_decoder(struct tar_stat_info *st, char const *arg) {
   ...
   printf("<This branch (L10769) is removed by Cov debloating tool>\n"); exit(6);
}
struct xhdr_tab const xhdr_tab[17] = {
...
static unsigned int hash_directory(void const *entry, unsigned int n_buckets) {
   ...
   printf("<This branch (L10829) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool compare_directories(void const *entry1, void const *entry2) {
   ...
   printf("<This branch (L10844) is removed by Cov debloating tool>\n"); exit(6);
}
static struct directory *note_directory(char const *name, dev_t dev, ino_t ino,
   ...
   printf("<This branch (L10889) is removed by Cov debloating tool>\n"); exit(6);
}
...
static int compare_dirents(void const *first, void const *second) {
   ...
   printf("<This branch (L10925) is removed by Cov debloating tool>\n"); exit(6);
}
...
static char *sort_obstack(struct obstack *stk) {
   ...
   printf("<This branch (L11432) is removed by Cov debloating tool>\n"); exit(6);
}
char *get_directory_contents(char *path, dev_t device) {
   ...
   printf("<This branch (L11462) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool write_directory_file_entry(void *entry, void *data) {
   ...
   printf("<This branch (L11812) is removed by Cov debloating tool>\n"); exit(6);
}
void write_directory_file(void) {
   ...
   printf("<This branch (L11870) is removed by Cov debloating tool>\n"); exit(6);
}
void gnu_restore(char const *directory_name) {
   ...
   printf("<This branch (L12028) is removed by Cov debloating tool>\n"); exit(6);
}
...
void list_archive(void) {
   ...
   printf("<This branch (L12490) is removed by Cov debloating tool>\n"); exit(6);
}
enum read_header read_header(_Bool raw_extended_headers) {
  size_t i;
  int unsigned_sum;
...
gid_t gid_from_header(char const *p, size_t s) {
   ...
   printf("<This branch (L13349) is removed by Cov debloating tool>\n"); exit(6);
}
int major_from_header(char const *p, size_t s) {
  uintmax_t tmp;
  char *__cil_tmp4;
...
size_t size_from_header(char const *p, size_t s) {
   ...
   printf("<This branch (L13491) is removed by Cov debloating tool>\n"); exit(6);
}
time_t time_from_header(char const *p, size_t s) {
  uintmax_t tmp;
  char *__cil_tmp4;
...
char *stringify_uintmax_t_backwards(uintmax_t o___0, char *buf) {
   ...
   printf("<This branch (L13547) is removed by Cov debloating tool>\n"); exit(6);
}
...
char const *tartime(time_t t) {
   ...
   printf("<This branch (L13605) is removed by Cov debloating tool>\n"); exit(6);
}
...
void print_header(struct tar_stat_info *st, off_t block_ordinal) {
   ...
   printf("<This branch (L14084) is removed by Cov debloating tool>\n"); exit(6);
}
void print_for_mkdir(char *pathname, int length, mode_t mode) {
  char modes[11];
  char buf[(((sizeof(uintmax_t) * 8UL) * 302UL) / 1000UL + 1UL) + 1UL];
...
void skip_file(off_t size) {
...

  {
    if (multi_volume_option) {
       ...
       printf("<This branch (L14136) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      while (1) {
      while_continue: /* CIL Label */;
        ...
        if (!x) {
          ...
          } printf("<This branch (L14150) is removed by Cov debloating tool>\n"); exit(6);
        }
        {
        ...
        if (multi_volume_option) {
           printf("<This branch (L14157) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    while_break: /* CIL Label */;
    }
...
void extract_mangle(void) {
   ...
   printf("<This branch (L14423) is removed by Cov debloating tool>\n"); exit(6);
}
...
char *quote_copy_string(char const *string) {
   ...
   printf("<This branch (L14557) is removed by Cov debloating tool>\n"); exit(6);
}
int unquote_string(char *string) {
  int result;
  char *source;
...
static _Bool must_be_dot_or_slash(char const *path) {
   ...
   printf("<This branch (L14836) is removed by Cov debloating tool>\n"); exit(6);
}
static int safer_rmdir(char const *path) {
   ...
   printf("<This branch (L14854) is removed by Cov debloating tool>\n"); exit(6);
}
int remove_any_file(char const *path, enum remove_option option) {
...
void undo_last_backup(void) {
   ...
   printf("<This branch (L15142) is removed by Cov debloating tool>\n"); exit(6);
}
int deref_stat(_Bool deref, char const *name, struct stat *buf) {
  int tmp;
  int tmp___0;
...
void decode_mode(mode_t mode, char *string) {
   ...
   printf("<This branch (L15416) is removed by Cov debloating tool>\n"); exit(6);
}
static void call_arg_error(char const *call, char const *name) {
   ...
   printf("<This branch (L15435) is removed by Cov debloating tool>\n"); exit(6);
}
static __attribute__((__noreturn__)) void call_arg_fatal(char const *call,
                                                         char const *name);
static void call_arg_fatal(char const *call, char const *name) {
   ...
   printf("<This branch (L15455) is removed by Cov debloating tool>\n"); exit(6);
}
static void call_arg_warn(char const *call, char const *name) {
   ...
   printf("<This branch (L15473) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void chdir_fatal(char const *name);
...
void chmod_error_details(char const *name, mode_t mode) {
   ...
   printf("<This branch (L15503) is removed by Cov debloating tool>\n"); exit(6);
}
void chown_error_details(char const *name, uid_t uid, gid_t gid) {
   ...
   printf("<This branch (L15523) is removed by Cov debloating tool>\n"); exit(6);
}
void close_error(char const *name) {
   ...
   printf("<This branch (L15531) is removed by Cov debloating tool>\n"); exit(6);
}
void close_warn(char const *name) {
   ...
   printf("<This branch (L15539) is removed by Cov debloating tool>\n"); exit(6);
}
void close_diag(char const *name) {
   ...
   printf("<This branch (L15552) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void exec_fatal(char const *name);
void exec_fatal(char const *name) {
   ...
   printf("<This branch (L15560) is removed by Cov debloating tool>\n"); exit(6);
}
void link_error(char const *target, char const *source) {
   ...
   printf("<This branch (L15581) is removed by Cov debloating tool>\n"); exit(6);
}
void mkdir_error(char const *name) {
   ...
   printf("<This branch (L15589) is removed by Cov debloating tool>\n"); exit(6);
}
void mkfifo_error(char const *name) {
   ...
   printf("<This branch (L15597) is removed by Cov debloating tool>\n"); exit(6);
}
void mknod_error(char const *name) {
   ...
   printf("<This branch (L15605) is removed by Cov debloating tool>\n"); exit(6);
}
void open_error(char const *name) {
   ...
   printf("<This branch (L15613) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void open_fatal(char const *name);
void open_fatal(char const *name) {
   ...
   printf("<This branch (L15621) is removed by Cov debloating tool>\n"); exit(6);
}
void open_warn(char const *name) {
   ...
   printf("<This branch (L15629) is removed by Cov debloating tool>\n"); exit(6);
}
void open_diag(char const *name) {
   ...
   printf("<This branch (L15642) is removed by Cov debloating tool>\n"); exit(6);
}
void read_error(char const *name) {
...
void read_error_details(char const *name, off_t offset, size_t size) {
   ...
   printf("<This branch (L15675) is removed by Cov debloating tool>\n"); exit(6);
}
void read_warn_details(char const *name, off_t offset, size_t size) {
   ...
   printf("<This branch (L15700) is removed by Cov debloating tool>\n"); exit(6);
}
void read_diag_details(char const *name, off_t offset, size_t size) {
   ...
   printf("<This branch (L15713) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void read_fatal(char const *name);
void read_fatal(char const *name) {
   ...
   printf("<This branch (L15721) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void
read_fatal_details(char const *name, off_t offset, size_t size);
void read_fatal_details(char const *name, off_t offset, size_t size) {
   ...
   printf("<This branch (L15747) is removed by Cov debloating tool>\n"); exit(6);
}
void readlink_error(char const *name) {
   ...
   printf("<This branch (L15755) is removed by Cov debloating tool>\n"); exit(6);
}
void readlink_warn(char const *name) {
   ...
   printf("<This branch (L15763) is removed by Cov debloating tool>\n"); exit(6);
}
void readlink_diag(char const *name) {
...
void savedir_diag(char const *name) {
   ...
   printf("<This branch (L15805) is removed by Cov debloating tool>\n"); exit(6);
}
void seek_error(char const *name) {
   ...
   printf("<This branch (L15813) is removed by Cov debloating tool>\n"); exit(6);
}
void seek_error_details(char const *name, off_t offset) {
   ...
   printf("<This branch (L15838) is removed by Cov debloating tool>\n"); exit(6);
}
void seek_warn(char const *name) {
   ...
   printf("<This branch (L15846) is removed by Cov debloating tool>\n"); exit(6);
}
void seek_warn_details(char const *name, off_t offset) {
   ...
   printf("<This branch (L15870) is removed by Cov debloating tool>\n"); exit(6);
}
void seek_diag_details(char const *name, off_t offset) {
   ...
   printf("<This branch (L15883) is removed by Cov debloating tool>\n"); exit(6);
}
void symlink_error(char const *contents, char const *name) {
   ...
   printf("<This branch (L15904) is removed by Cov debloating tool>\n"); exit(6);
}
void stat_error(char const *name) {
   ...
   printf("<This branch (L15912) is removed by Cov debloating tool>\n"); exit(6);
}
void stat_warn(char const *name) {
...
void stat_diag(char const *name) {
   ...
   printf("<This branch (L15933) is removed by Cov debloating tool>\n"); exit(6);
}
void truncate_error(char const *name) {
   ...
   printf("<This branch (L15941) is removed by Cov debloating tool>\n"); exit(6);
}
void truncate_warn(char const *name) {
   ...
   printf("<This branch (L15949) is removed by Cov debloating tool>\n"); exit(6);
}
void unlink_error(char const *name) {
...
void utime_error(char const *name) {
   ...
   printf("<This branch (L15965) is removed by Cov debloating tool>\n"); exit(6);
}
void waitpid_error(char const *name) {
   ...
   printf("<This branch (L15973) is removed by Cov debloating tool>\n"); exit(6);
}
void write_error(char const *name) {
   ...
   printf("<This branch (L15981) is removed by Cov debloating tool>\n"); exit(6);
}
void write_error_details(char const *name, size_t status, size_t size) {
   ...
   printf("<This branch (L16000) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void
write_fatal_details(char const *name, ssize_t status, size_t size);
void write_fatal_details(char const *name, ssize_t status, size_t size) {
   ...
   printf("<This branch (L16011) is removed by Cov debloating tool>\n"); exit(6);
}
pid_t xfork(void) {
  pid_t p;
  __pid_t tmp;
...
void xpipe(int *fd) {
...

  {
    ...
    if (tmp___0 < 0) {
      ...
      } printf("<This branch (L16046) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
static int read_name_from_file(void) {
   ...
   printf("<This branch (L16422) is removed by Cov debloating tool>\n"); exit(6);
}
char *name_next(int change_dirs) {
  char const *source;
  char *cursor;
...
static struct name *merge_sort(struct name *list, int length,
   ...
   printf("<This branch (L17169) is removed by Cov debloating tool>\n"); exit(6);
}
static int compare_names(struct name const *n1, struct name const *n2) {
   ...
   printf("<This branch (L17201) is removed by Cov debloating tool>\n"); exit(6);
}
static void add_hierarchy_to_namelist(struct name *name, dev_t device) {
   ...
   printf("<This branch (L17292) is removed by Cov debloating tool>\n"); exit(6);
}
void collect_and_sort_names(void) {
   ...
   printf("<This branch (L17387) is removed by Cov debloating tool>\n"); exit(6);
}
struct name *name_scan(char const *path) {
   ...
   printf("<This branch (L17431) is removed by Cov debloating tool>\n"); exit(6);
}
char *name_from_list(void) {
   ...
   printf("<This branch (L17463) is removed by Cov debloating tool>\n"); exit(6);
}
void blank_name_list(void) {
   ...
   printf("<This branch (L17483) is removed by Cov debloating tool>\n"); exit(6);
}
char *new_name(char const *path, char const *name) {
...
static unsigned int hash_string_hasher(void const *name,
   ...
   printf("<This branch (L17539) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool hash_string_compare(void const *name1, void const *name2) {
   ...
   printf("<This branch (L17547) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool hash_string_insert(Hash_table **table___0, char const *string) {
   ...
   printf("<This branch (L17594) is removed by Cov debloating tool>\n"); exit(6);
}
...
void add_avoided_name(char const *name) {
   ...
   printf("<This branch (L17623) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool is_avoided_name(char const *name) {
  _Bool tmp;
...
size_t stripped_prefix_len(char const *file_name, size_t num) {
   ...
   printf("<This branch (L17782) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool contains_dot_dot(char const *name) {
   ...
   printf("<This branch (L17822) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void _rmt_shutdown(int handle, int errno_value) {
   ...
   printf("<This branch (L17859) is removed by Cov debloating tool>\n"); exit(6);
}
static int do_command(int handle, char const *buffer___2) {
   ...
   printf("<This branch (L17885) is removed by Cov debloating tool>\n"); exit(6);
}
static char *get_status_string(int handle, char *command_buffer) {
   ...
   printf("<This branch (L17982) is removed by Cov debloating tool>\n"); exit(6);
}
static long get_status(int handle) {
   ...
   printf("<This branch (L18012) is removed by Cov debloating tool>\n"); exit(6);
}
static off_t get_status_off(int handle) {
   ...
   printf("<This branch (L18096) is removed by Cov debloating tool>\n"); exit(6);
}
static void encode_oflag(char *buf, int oflag) {
   ...
   printf("<This branch (L18208) is removed by Cov debloating tool>\n"); exit(6);
}
int rmt_open__(char const *path, int open_mode, int bias,
               char const *remote_shell) {
   ...
   printf("<This branch (L18438) is removed by Cov debloating tool>\n"); exit(6);
}
int rmt_close__(int handle) {
   ...
   printf("<This branch (L18457) is removed by Cov debloating tool>\n"); exit(6);
}
size_t rmt_read__(int handle, char *buffer___2, size_t length) {
   ...
   printf("<This branch (L18516) is removed by Cov debloating tool>\n"); exit(6);
}
size_t rmt_write__(int handle, char *buffer___2, size_t length) {
   ...
   printf("<This branch (L18560) is removed by Cov debloating tool>\n"); exit(6);
}
off_t rmt_lseek__(int handle, off_t offset, int whence) {
   ...
   printf("<This branch (L18635) is removed by Cov debloating tool>\n"); exit(6);
}
int rmt_ioctl__(int handle, int operation, char *argument) {
   ...
   printf("<This branch (L18770) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool tar_sparse_init(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L18798) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool tar_sparse_done(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L18811) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool tar_sparse_scan(struct tar_sparse_file *file,
   ...
   printf("<This branch (L18825) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool tar_sparse_dump_region(struct tar_sparse_file *file, size_t i) {
   ...
   printf("<This branch (L18838) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool tar_sparse_extract_region(struct tar_sparse_file *file, size_t i) {
   ...
   printf("<This branch (L18851) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool tar_sparse_dump_header(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L18864) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool tar_sparse_fixup_header(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L18890) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool lseek_or_error(struct tar_sparse_file *file, off_t offset,
   ...
   printf("<This branch (L18906) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void sparse_add_map(struct tar_sparse_file *file, struct sp_array *sp) {
   ...
   printf("<This branch (L18961) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool sparse_scan_file(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L19052) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool sparse_dump_region(struct tar_sparse_file *file, size_t i) {
   ...
   printf("<This branch (L19160) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool sparse_extract_region(struct tar_sparse_file *file, size_t i) {
   ...
   printf("<This branch (L19234) is removed by Cov debloating tool>\n"); exit(6);
}
enum dump_status sparse_dump_file(int fd, struct tar_stat_info *st) {
   ...
   printf("<This branch (L19304) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool sparse_file_p(struct tar_stat_info *st) {
...
_Bool sparse_fixup_header(struct tar_stat_info *st) {
   ...
   printf("<This branch (L19346) is removed by Cov debloating tool>\n"); exit(6);
}
enum dump_status sparse_extract_file(int fd, struct tar_stat_info *st,
                                     off_t *size) {
   ...
   printf("<This branch (L19411) is removed by Cov debloating tool>\n"); exit(6);
}
enum dump_status sparse_skip_file(struct tar_stat_info *st) {
   ...
   printf("<This branch (L19453) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool check_sparse_region(struct tar_sparse_file *file, off_t beg,
   ...
   printf("<This branch (L19504) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool check_data_region(struct tar_sparse_file *file, size_t i) {
   ...
   printf("<This branch (L19583) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool sparse_diff_file(int fd, struct tar_stat_info *st) {
   ...
   printf("<This branch (L19659) is removed by Cov debloating tool>\n"); exit(6);
}
...
static enum oldgnu_add_status oldgnu_add_sparse(struct tar_sparse_file *file,
   ...
   printf("<This branch (L19693) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool oldgnu_fixup_header(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L19705) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void oldgnu_store_sparse_info(struct tar_sparse_file *file,
   ...
   printf("<This branch (L19819) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool oldgnu_dump_header(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L19869) is removed by Cov debloating tool>\n"); exit(6);
}
static struct tar_sparse_optab oldgnu_optab = {
...
static _Bool star_sparse_member_p(struct tar_sparse_file *file
   ...
   printf("<This branch (L19885) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool star_fixup_header(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L19897) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool pax_sparse_member_p(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L20007) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool pax_dump_header(struct tar_sparse_file *file) {
   ...
   printf("<This branch (L20054) is removed by Cov debloating tool>\n"); exit(6);
}
static struct tar_sparse_optab pax_optab = {
    (_Bool(*)(struct tar_sparse_file *))((void *)0),
    (_Bool(*)(struct tar_sparse_file *))((void *)0),
...
void sys_spawn_shell(void) {
   ...
   printf("<This branch (L20331) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool sys_compare_uid(struct stat *a, struct stat *b) {

   printf("<This branch (L20335) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool sys_compare_gid(struct stat *a, struct stat *b) {

   printf("<This branch (L20339) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool sys_compare_links(struct stat *link_data, struct stat *stat_data) {
...
int sys_truncate(int fd) {
   ...
   printf("<This branch (L20377) is removed by Cov debloating tool>\n"); exit(6);
}
void sys_reset_uid_gid(void) {
   ...
   printf("<This branch (L20391) is removed by Cov debloating tool>\n"); exit(6);
}
    ...
    if (tmp___0 != 0) {
      if (!force_local_option) {
        ...
        if (rmt_path__) {
           ...
           printf("<This branch (L20836) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          goto _L___1;
        }
      } else {
      _L___1 : { tmp___2 = is_regular_file(*(archive_name_array + 0)); }
        if (tmp___2) {
          ...
          if (archive < 0) {
            ...
            } printf("<This branch (L20851) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
            xdup2(archive, 0);
            execlp(use_compress_program_option, use_compress_program_option,
...
int confirm(char const *message_action, char const *message_name) {
   ...
   printf("<This branch (L21160) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void set_archive_format(char const *name) {
   ...
   printf("<This branch (L21199) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void assert_format(unsigned int fmt_mask) {
   ...
   printf("<This branch (L21236) is removed by Cov debloating tool>\n"); exit(6);
}
    ...
    if (use_compress_program_option) {
      {
       ...
       printf("<This branch (L21635) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static void append_file(char *path) {
   ...
   printf("<This branch (L23458) is removed by Cov debloating tool>\n"); exit(6);
}
void update_archive(void) {
   ...
   printf("<This branch (L23645) is removed by Cov debloating tool>\n"); exit(6);
}
...
static iconv_t utf8_init(_Bool to_utf) {
   ...
   printf("<This branch (L23660) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool utf8_convert(_Bool to_utf, char const *input, char **output) {
   ...
   printf("<This branch (L23702) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool string_ascii_p(char const *str) {
   ...
   printf("<This branch (L23723) is removed by Cov debloating tool>\n"); exit(6);
}
...
void addext(char *filename, char const *ext, int e) {
   ...
   printf("<This branch (L23806) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void __argmatch_die(void) {
   ...
   printf("<This branch (L23823) is removed by Cov debloating tool>\n"); exit(6);
}
...
int argmatch(char const *arg, char const *const *arglist, char const *vallist,
   ...
   printf("<This branch (L23884) is removed by Cov debloating tool>\n"); exit(6);
}
void argmatch_invalid(char const *context, char const *value, int problem) {
   ...
   printf("<This branch (L23915) is removed by Cov debloating tool>\n"); exit(6);
}
void argmatch_valid(char const *const *arglist, char const *vallist,
                    size_t valsize) {
   ...
   printf("<This branch (L23973) is removed by Cov debloating tool>\n"); exit(6);
}
int __xargmatch_internal(char const *context, char const *arg,
                         char const *const *arglist, char const *vallist,
                         size_t valsize, void (*exit_fn)(void)) {
   ...
   printf("<This branch (L23995) is removed by Cov debloating tool>\n"); exit(6);
}
...
char *find_backup_file_name(char const *file,
   ...
   printf("<This branch (L24093) is removed by Cov debloating tool>\n"); exit(6);
}
static int max_backup_version(char const *file, char const *dir) {
   ...
   printf("<This branch (L24143) is removed by Cov debloating tool>\n"); exit(6);
}
static int version_number(char const *base, char const *backup,
                          size_t base_length) {
   ...
   printf("<This branch (L24182) is removed by Cov debloating tool>\n"); exit(6);
}
...
enum backup_type get_version(char const *context, char const *version) {
   ...
   printf("<This branch (L24217) is removed by Cov debloating tool>\n"); exit(6);
}
enum backup_type xget_version(char const *context, char const *version) {
...
size_t dir_len(char const *path) {
   ...
   printf("<This branch (L24342) is removed by Cov debloating tool>\n"); exit(6);
}
char *dir_name(char const *path) {
   ...
   printf("<This branch (L24369) is removed by Cov debloating tool>\n"); exit(6);
}
...
static int fnmatch_no_wildcards(char const *pattern, char const *f,
   ...
   printf("<This branch (L24450) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool excluded_filename(struct exclude const *ex, char const *f) {
  size_t exclude_count;
...
int add_exclude_file(void (*add_func)(struct exclude *, char const *, int),
...

  {
    if ((int const) * (filename + 0) == 45) {
       ...
       printf("<This branch (L24582) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___9 = 0;
    }
    ...
    e = 0;
    if (use_stdin) {
       printf("<This branch (L24592) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      ...
      if (!in) {
         printf("<This branch (L24599) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
      while (1) {
    ...
    if (tmp___2) {
      ...
      } printf("<This branch (L24626) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!use_stdin) {
      {
        tmp___4 = fclose(in);
      ...
      if (tmp___4 != 0) {
        ...
        } printf("<This branch (L24636) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
    ...
    if (buf_count == 0UL) {
       printf("<This branch (L24645) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if ((int)*(buf + (buf_count - 1UL)) == (int)line_end) {
        tmp___10 = 0;
      } else {
         printf("<This branch (L24650) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
          ...
          if (tmp___7) {
            {
              ...
              while_continue___1: /* CIL Label */;
                if ((unsigned long)pattern_end == (unsigned long)pattern) {
                   printf("<This branch (L24672) is removed by Cov debloating tool>\n"); exit(6);
                } else {
                 ...
                 printf("<This branch (L24679) is removed by Cov debloating tool>\n"); exit(6);
              }
            while_break___1: /* CIL Label */;
            }
          }
    ...
    if (e) {
       printf("<This branch (L24700) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___11 = 0;
    }
    return (tmp___11);
...
int yyparse(void *parm) {
   ...
   printf("<This branch (L25675) is removed by Cov debloating tool>\n"); exit(6);
}
...
static long to_year(textint textyear) {
   ...
   printf("<This branch (L25825) is removed by Cov debloating tool>\n"); exit(6);
}
static table const *lookup_zone(parser_control const *pc, char const *name) {
   ...
   printf("<This branch (L25864) is removed by Cov debloating tool>\n"); exit(6);
}
static table const *lookup_word(parser_control const *pc, char *word) {
   ...
   printf("<This branch (L26063) is removed by Cov debloating tool>\n"); exit(6);
}
static int yylex(YYSTYPE *lvalp, parser_control *pc) {
   ...
   printf("<This branch (L26341) is removed by Cov debloating tool>\n"); exit(6);
}
static int yyerror(char *s __attribute__((__unused__))) {

   printf("<This branch (L26345) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool get_date(struct timespec *result, char const *p,
               struct timespec const *now) {
   ...
   printf("<This branch (L26614) is removed by Cov debloating tool>\n"); exit(6);
}
...
int gettime(struct timespec *ts) {
   ...
   printf("<This branch (L26643) is removed by Cov debloating tool>\n"); exit(6);
}
...
void *hash_lookup(Hash_table const *table___0, void const *entry) {
   ...
   printf("<This branch (L26687) is removed by Cov debloating tool>\n"); exit(6);
}
void *hash_get_first(Hash_table const *table___0) {
   ...
   printf("<This branch (L26713) is removed by Cov debloating tool>\n"); exit(6);
}
void *hash_get_next(Hash_table const *table___0, void const *entry) {
   ...
   printf("<This branch (L26760) is removed by Cov debloating tool>\n"); exit(6);
}
size_t hash_do_for_each(Hash_table const *table___0,
                        _Bool (*processor)(void *, void *),
                        void *processor_data) {
   ...
   printf("<This branch (L26802) is removed by Cov debloating tool>\n"); exit(6);
}
size_t hash_string(char const *string, size_t n_buckets) {
   ...
   printf("<This branch (L26823) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool is_prime(size_t candidate) {
   ...
   printf("<This branch (L26855) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t next_prime(size_t candidate) {
   ...
   printf("<This branch (L26877) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool check_tuning(Hash_table *table___0) {
   ...
   printf("<This branch (L26905) is removed by Cov debloating tool>\n"); exit(6);
}
Hash_table *hash_initialize(size_t candidate, Hash_tuning const *tuning,
                            size_t (*hasher)(void const *, size_t),
                            _Bool (*comparator)(void const *, void const *),
   ...
   printf("<This branch (L26984) is removed by Cov debloating tool>\n"); exit(6);
}
static struct hash_entry *allocate_entry(Hash_table *table___0) {
   ...
   printf("<This branch (L27001) is removed by Cov debloating tool>\n"); exit(6);
}
static void free_entry(Hash_table *table___0, struct hash_entry *entry) {
   ...
   printf("<This branch (L27010) is removed by Cov debloating tool>\n"); exit(6);
}
static void *hash_find_entry(Hash_table *table___0, void const *entry,
   ...
   printf("<This branch (L27081) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool hash_rehash(Hash_table *table___0, size_t candidate) {
   ...
   printf("<This branch (L27176) is removed by Cov debloating tool>\n"); exit(6);
}
void *hash_insert(Hash_table *table___0, void const *entry) {
   ...
   printf("<This branch (L27243) is removed by Cov debloating tool>\n"); exit(6);
}
...
static long double adjust_value(int inexact_style, long double value) {
   ...
   printf("<This branch (L27276) is removed by Cov debloating tool>\n"); exit(6);
}
static char *group_number(char *number, size_t numberlen, char const *grouping,
   ...
   printf("<This branch (L27332) is removed by Cov debloating tool>\n"); exit(6);
}
char *human_readable(uintmax_t n, char *buf, int opts,
                     uintmax_t from_block_size, uintmax_t to_block_size) {
   ...
   printf("<This branch (L27698) is removed by Cov debloating tool>\n"); exit(6);
}
...
__inline static int leapyear(int year) {
   ...
   printf("<This branch (L27726) is removed by Cov debloating tool>\n"); exit(6);
}
...
__inline static time_t ydhms_diff(long year1, long yday1, int hour1, int min1,
   ...
   printf("<This branch (L27776) is removed by Cov debloating tool>\n"); exit(6);
}
static time_t guess_time_tm(long year, long yday, int hour, int min, int sec,
   ...
   printf("<This branch (L27812) is removed by Cov debloating tool>\n"); exit(6);
}
static struct tm *ranged_convert(struct tm *(*convert)(time_t const *,
   ...
   printf("<This branch (L27871) is removed by Cov debloating tool>\n"); exit(6);
}
time_t mktime_internal(struct tm *tp,
   ...
   printf("<This branch (L28132) is removed by Cov debloating tool>\n"); exit(6);
}
...
time_t(__attribute__((__leaf__)) rpl_mktime)(struct tm *tp) {
   ...
   printf("<This branch (L28147) is removed by Cov debloating tool>\n"); exit(6);
}
...
static struct mode_change *make_node_op_equals(mode_t new_mode) {
   ...
   printf("<This branch (L28171) is removed by Cov debloating tool>\n"); exit(6);
}
static void mode_append_entry(struct mode_change **head,
   ...
   printf("<This branch (L28188) is removed by Cov debloating tool>\n"); exit(6);
}
struct mode_change *mode_compile(char const *mode_string,
                                 unsigned int masked_ops) {
   ...
   printf("<This branch (L28556) is removed by Cov debloating tool>\n"); exit(6);
}
mode_t mode_adjust(mode_t oldmode, struct mode_change const *changes) {
...
static int prepend_args(char const *options, char *buf, char **argv) {
   ...
   printf("<This branch (L28771) is removed by Cov debloating tool>\n"); exit(6);
}
void prepend_default_options(char const *options, int *pargc, char ***pargv) {
  char *buf;
  size_t tmp;
...
struct quoting_options *clone_quoting_options(struct quoting_options *o___0) {
   ...
   printf("<This branch (L28891) is removed by Cov debloating tool>\n"); exit(6);
}
void set_quoting_style(struct quoting_options *o___0, enum quoting_style s) {
...

  {
    ...
    if (o___0) {
      tmp = o___0;
       ...
       printf("<This branch (L28918) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static char const *gettext_quote(char const *msgid, enum quoting_style s) {
   ...
   printf("<This branch (L28943) is removed by Cov debloating tool>\n"); exit(6);
}
...

  {
    ...
    }
    {
      if ((unsigned int)quoting_style == 3U) {
         printf("<This branch (L28994) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((unsigned int)quoting_style == 4U) {
        goto case_4;
      }
       printf("<This branch (L28999) is removed by Cov debloating tool>\n"); exit(6);
      ...
      while_continue___3: /* CIL Label */;
        if (argsize == 0xffffffffffffffffUL) {
          tmp___9 = (int const) * (arg + i) == 0;
           ...
           printf("<This branch (L29090) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (tmp___9) {
          goto while_break___3;
        }
        if (backslash_escapes) {
          if (quote_string_len) {
             ...
             printf("<This branch (L29115) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
        c = (unsigned char)*(arg + i);
        {
          if ((int)c == 0) {
             printf("<This branch (L29121) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 63) {
             printf("<This branch (L29124) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 7) {
             printf("<This branch (L29127) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 8) {
             printf("<This branch (L29130) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 12) {
             printf("<This branch (L29133) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 10) {
             printf("<This branch (L29136) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 13) {
             printf("<This branch (L29139) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 9) {
             printf("<This branch (L29142) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 11) {
             printf("<This branch (L29145) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 92) {
             printf("<This branch (L29148) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 123) {
             printf("<This branch (L29151) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 125) {
             printf("<This branch (L29154) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 35) {
             printf("<This branch (L29157) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 126) {
             printf("<This branch (L29160) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 32) {
             printf("<This branch (L29163) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 33) {
             printf("<This branch (L29166) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 34) {
             printf("<This branch (L29169) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 36) {
             printf("<This branch (L29172) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 38) {
             printf("<This branch (L29175) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 40) {
             printf("<This branch (L29178) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 41) {
             printf("<This branch (L29181) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 42) {
             printf("<This branch (L29184) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 59) {
             printf("<This branch (L29187) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 60) {
             printf("<This branch (L29190) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 61) {
             printf("<This branch (L29193) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 62) {
             printf("<This branch (L29196) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 91) {
             printf("<This branch (L29199) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 94) {
             printf("<This branch (L29202) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 96) {
             printf("<This branch (L29205) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 124) {
             printf("<This branch (L29208) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 39) {
             printf("<This branch (L29211) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 37) {
             printf("<This branch (L29214) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 43) {
             printf("<This branch (L29217) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 44) {
             printf("<This branch (L29220) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 45) {
             printf("<This branch (L29223) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 46) {
             printf("<This branch (L29226) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 47) {
             printf("<This branch (L29229) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 48) {
             printf("<This branch (L29232) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 49) {
             printf("<This branch (L29235) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 50) {
             printf("<This branch (L29238) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 51) {
             printf("<This branch (L29241) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 52) {
             printf("<This branch (L29244) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 53) {
             printf("<This branch (L29247) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 54) {
             printf("<This branch (L29250) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 55) {
             printf("<This branch (L29253) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 56) {
             printf("<This branch (L29256) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 57) {
             printf("<This branch (L29259) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 58) {
             printf("<This branch (L29262) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 65) {
             printf("<This branch (L29265) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 66) {
             printf("<This branch (L29268) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 67) {
             printf("<This branch (L29271) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 68) {
             printf("<This branch (L29274) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 69) {
             printf("<This branch (L29277) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 70) {
             printf("<This branch (L29280) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 71) {
             printf("<This branch (L29283) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 72) {
             printf("<This branch (L29286) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 73) {
             printf("<This branch (L29289) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 74) {
             printf("<This branch (L29292) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 75) {
             printf("<This branch (L29295) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 76) {
             printf("<This branch (L29298) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 77) {
             printf("<This branch (L29301) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 78) {
             printf("<This branch (L29304) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 79) {
             printf("<This branch (L29307) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 80) {
             printf("<This branch (L29310) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 81) {
             printf("<This branch (L29313) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 82) {
             printf("<This branch (L29316) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 83) {
             printf("<This branch (L29319) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 84) {
             printf("<This branch (L29322) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 85) {
             printf("<This branch (L29325) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 86) {
             printf("<This branch (L29328) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 87) {
             printf("<This branch (L29331) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 88) {
             printf("<This branch (L29334) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 89) {
             printf("<This branch (L29337) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 90) {
             printf("<This branch (L29340) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 93) {
             printf("<This branch (L29343) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 95) {
             printf("<This branch (L29346) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 97) {
            goto case_37;
          }
          ...
          if ((int)c == 99) {
             printf("<This branch (L29355) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 100) {
             printf("<This branch (L29358) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 101) {
             printf("<This branch (L29361) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 102) {
             printf("<This branch (L29364) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 103) {
             printf("<This branch (L29367) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 104) {
             printf("<This branch (L29370) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 105) {
             printf("<This branch (L29373) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 106) {
             printf("<This branch (L29376) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 107) {
             printf("<This branch (L29379) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 108) {
             printf("<This branch (L29382) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 109) {
             printf("<This branch (L29385) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 110) {
             printf("<This branch (L29388) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 111) {
             printf("<This branch (L29391) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 112) {
             printf("<This branch (L29394) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 113) {
             printf("<This branch (L29397) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 114) {
            goto case_37;
          }
           printf("<This branch (L29402) is removed by Cov debloating tool>\n"); exit(6);
        ...
        if (backslash_escapes) {
          if (!(o___0->quote_these_too[(unsigned long)c / (sizeof(int) * 8UL)] &
           ...
           printf("<This branch (L29943) is removed by Cov debloating tool>\n"); exit(6);
        }
       printf("<This branch (L29945) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (i == 0UL) {
       ...
       printf("<This branch (L29974) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (quote_string) {
      {
      ...
      } printf("<This branch (L29997) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (len < buffersize) {
...

  {
    if (o___0) {
      p = o___0;
       ...
       printf("<This branch (L30023) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      tmp = __errno_location();
      e = *tmp;
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize,
...

  {
    ...
    if (n < 0) {
      ...
      } printf("<This branch (L30068) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nslots <= n0) {
      ...
      } printf("<This branch (L30096) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      size = (slotvec + n)->size;
      val = (slotvec + n)->val;
    ...
    if (size <= qsize) {
      ...
      } printf("<This branch (L30117) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      tmp___4 = __errno_location();
      *tmp___4 = e;
...
char *quotearg_n(int n, char const *arg) {
   ...
   printf("<This branch (L30136) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg(char const *arg) {
   ...
   printf("<This branch (L30144) is removed by Cov debloating tool>\n"); exit(6);
}
...
quoting_options_from_style(enum quoting_style style) {
   ...
   printf("<This branch (L30157) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_n_style(int n, enum quoting_style s, char const *arg) {
   ...
   printf("<This branch (L30174) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_char(char const *arg, char ch) {
...
int restore_cwd(struct saved_cwd const *cwd) {
   ...
   printf("<This branch (L30303) is removed by Cov debloating tool>\n"); exit(6);
}
...
char *xgetcwd(void) {
   ...
   printf("<This branch (L30466) is removed by Cov debloating tool>\n"); exit(6);
}
...
void xalloc_die(void) {
   ...
   printf("<This branch (L30497) is removed by Cov debloating tool>\n"); exit(6);
}
...

  {
    ...
    if (!p) {
      if (!n) {
       ...
       printf("<This branch (L30581) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      *pn = n;
      tmp = xrealloc(p, n * s);
...
static strtol_error bkm_scale___0(unsigned long *x, int scale_factor) {
   ...
   printf("<This branch (L30663) is removed by Cov debloating tool>\n"); exit(6);
}
...
strtol_error xstrtoul(char const *s, char **ptr, int strtol_base,
   ...
   printf("<This branch (L30947) is removed by Cov debloating tool>\n"); exit(6);
}
...
static strtol_error bkm_scale___1(uintmax_t *x, int scale_factor) {
   ...
   printf("<This branch (L30963) is removed by Cov debloating tool>\n"); exit(6);
}
static strtol_error bkm_scale_by_power___1(uintmax_t *x, int base, int power) {
   ...
   printf("<This branch (L30988) is removed by Cov debloating tool>\n"); exit(6);
}
strtol_error xstrtoumax(char const *s, char **ptr, int strtol_base,
                        uintmax_t *val, char const *valid_suffixes) {
   ...
   printf("<This branch (L31246) is removed by Cov debloating tool>\n"); exit(6);
}
