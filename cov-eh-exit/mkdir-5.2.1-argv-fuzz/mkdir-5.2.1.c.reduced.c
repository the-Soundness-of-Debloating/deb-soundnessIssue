    ...
    q = s;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (!((int const) * (*tmp___0 + (int)((unsigned char)*q)) & 8192)) {
         ...
         printf("<This branch (L694) is removed by Cov debloating tool>\n"); exit(6);
      }
...
void mode_free(struct mode_change *changes) {
   ...
   printf("<This branch (L3334) is removed by Cov debloating tool>\n"); exit(6);
}
          ...
          *tmp___30 = (char)'/';
          {
            ...
            while_continue___7: /* CIL Label */;
              if (!((int)*slash == 47)) {
               ...
               printf("<This branch (L3798) is removed by Cov debloating tool>\n"); exit(6);
            }
      ...
      if (tmp___36) {
        {
         ...
         printf("<This branch (L3853) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      while_continue: /* CIL Label */;
        if (1UL < len) {
          if (!((int const) * (name + (len - 1UL)) == 47)) {
           ...
           printf("<This branch (L4726) is removed by Cov debloating tool>\n"); exit(6);
        }
