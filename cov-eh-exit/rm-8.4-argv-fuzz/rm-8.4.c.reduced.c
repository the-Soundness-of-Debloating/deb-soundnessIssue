...
__inline static void clear_ungetc_buffer_preserving_position(FILE *fp) {
   ...
   printf("<This branch (L440) is removed by Cov debloating tool>\n"); exit(6);
}
int rpl_fflush(FILE *stream) {
...
static void __argmatch_die(void) {
   ...
   printf("<This branch (L1267) is removed by Cov debloating tool>\n"); exit(6);
}
...
void argmatch_invalid(char const *context, char const *value,
   ...
   printf("<This branch (L1340) is removed by Cov debloating tool>\n"); exit(6);
}
void argmatch_valid(char const *const *arglist, char const *vallist,
                    size_t valsize) {
   ...
   printf("<This branch (L1375) is removed by Cov debloating tool>\n"); exit(6);
}
ptrdiff_t __xargmatch_internal(char const *context, char const *arg,
                               char const *const *arglist, char const *vallist,
                               size_t valsize, void (*exit_fn)(void)) {
...
void *xrealloc(void *p, size_t n) {
   ...
   printf("<This branch (L1473) is removed by Cov debloating tool>\n"); exit(6);
}
...
void version_etc_va(FILE *stream, char const *command_name, char const *package,
   ...
   printf("<This branch (L1680) is removed by Cov debloating tool>\n"); exit(6);
}
void version_etc(FILE *stream, char const *command_name, char const *package,
                 char const *version, ...) __attribute__((__sentinel__));
void version_etc(FILE *stream, char const *command_name, char const *package,
   ...
   printf("<This branch (L1692) is removed by Cov debloating tool>\n"); exit(6);
}
char const version_etc_copyright[47] = {
...
__inline static char *xcharalloc(size_t n) {
   ...
   printf("<This branch (L1783) is removed by Cov debloating tool>\n"); exit(6);
}
extern __attribute__((__nothrow__)) int(__attribute__((__leaf__))
...
int set_char_quoting(struct quoting_options *o, char c, int i) {
  ...
  int r;
  {
    ...
    *p ^= (unsigned int)(((i & 1) ^ r) << shift);
    return (r);
  } printf("<This branch (L1814) is removed by Cov debloating tool>\n"); exit(6);
}
...
char *quotearg_char_mem(char const *arg, size_t argsize, char ch) {
  ...
  char *tmp;
  {
    ...
    tmp = quotearg_n_options(0, arg, argsize,
                             (struct quoting_options const *)(&options));
    return (tmp);
  } printf("<This branch (L2887) is removed by Cov debloating tool>\n"); exit(6);
}
char *quotearg_char(char const *arg, char ch) {
  char *tmp;
  {
...
int(__attribute__((__nonnull__(1, 2))) mbscasecmp)(char const *s1,
   ...
   printf("<This branch (L3213) is removed by Cov debloating tool>\n"); exit(6);
}
unsigned int const is_basic_table[8] = {
...
__inline static size_t rotr_sz(size_t x, int n) {
   ...
   printf("<This branch (L3310) is removed by Cov debloating tool>\n"); exit(6);
}
...
void *hash_lookup(Hash_table const *table___0, void const *entry) {
   ...
   printf("<This branch (L3345) is removed by Cov debloating tool>\n"); exit(6);
}
size_t hash_string(char const *string, size_t n_buckets) {
   ...
   printf("<This branch (L3362) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool is_prime(size_t candidate) {
   ...
   printf("<This branch (L3390) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t next_prime(size_t candidate) {
   ...
   printf("<This branch (L3412) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t raw_hasher(void const *data, size_t n) {
   ...
   printf("<This branch (L3421) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool raw_comparator(void const *a, void const *b) {
   printf("<This branch (L3424) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool check_tuning(Hash_table *table___0) {
   ...
   printf("<This branch (L3454) is removed by Cov debloating tool>\n"); exit(6);
}
...
Hash_table *(__attribute__((__warn_unused_result__))
   ...
   printf("<This branch (L3527) is removed by Cov debloating tool>\n"); exit(6);
}
void hash_free(Hash_table *table___0) {
   ...
   printf("<This branch (L3589) is removed by Cov debloating tool>\n"); exit(6);
}
...
static _Bool transfer_entries(Hash_table *dst, Hash_table *src, _Bool safe) {
   ...
   printf("<This branch (L3749) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool(__attribute__((__warn_unused_result__))
      hash_rehash)(Hash_table *table___0, size_t candidate) {
...
void *hash_delete(Hash_table *table___0, void const *entry) {
   ...
   printf("<This branch (L3928) is removed by Cov debloating tool>\n"); exit(6);
}
...
size_t triple_hash(void const *x, size_t table_size) {
   ...
   printf("<This branch (L3940) is removed by Cov debloating tool>\n"); exit(6);
}
_Bool triple_compare_ino_str(void const *x, void const *y) {
   ...
   printf("<This branch (L3965) is removed by Cov debloating tool>\n"); exit(6);
}
void triple_free(void *x) {
...
size_t hash_pjw(void const *x, size_t tablesize) {
   ...
   printf("<This branch (L3991) is removed by Cov debloating tool>\n"); exit(6);
}
extern __attribute__((__nothrow__)) char *(__attribute__((__leaf__))
...
static void fts_set_stat_required(FTSENT *p, _Bool required) {
   ...
   printf("<This branch (L4191) is removed by Cov debloating tool>\n"); exit(6);
}
...
__inline static int diropen(FTS const *sp, char const *dir) {
   ...
   printf("<This branch (L4276) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__nothrow__))
FTS *(__attribute__((__warn_unused_result__, __leaf__))
      fts_open)(char *const *argv, int options,
...
static _Bool leaf_optimization_applies(int dir_fd) {
   ...
   printf("<This branch (L4594) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t LCO_hash(void const *x, size_t table_size) {
   ...
   printf("<This branch (L4601) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool LCO_compare(void const *x, void const *y) {
   ...
   printf("<This branch (L4610) is removed by Cov debloating tool>\n"); exit(6);
}
static _Bool link_count_optimize_ok(FTSENT const *p) {
   ...
   printf("<This branch (L4662) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__nothrow__))
FTSENT *(__attribute__((__warn_unused_result__, __leaf__)) fts_read)(FTS *sp);
FTSENT *(__attribute__((__warn_unused_result__, __leaf__)) fts_read)(FTS *sp) {
...
static int fts_compare_ino(struct _ftsent const **a, struct _ftsent const **b) {
   ...
   printf("<This branch (L5091) is removed by Cov debloating tool>\n"); exit(6);
}
...
static int fts_compar(void const *a, void const *b) {
   ...
   printf("<This branch (L5655) is removed by Cov debloating tool>\n"); exit(6);
}
static FTSENT *fts_sort(FTS *sp, FTSENT *head, size_t nitems) {
   ...
   printf("<This branch (L5721) is removed by Cov debloating tool>\n"); exit(6);
}
static FTSENT *fts_alloc(FTS *sp, char const *name, size_t namelen) {
  register FTSENT *p;
  size_t len;
...
static void fts_padjust(FTS *sp, FTSENT *head) {
   ...
   printf("<This branch (L5826) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t fts_maxarglen(char *const *argv) {
  size_t len;
  size_t max;
...
int(__attribute__((__nonnull__(1))) rpl_fseeko)(FILE *fp, off_t offset,
   ...
   printf("<This branch (L5992) is removed by Cov debloating tool>\n"); exit(6);
}
#pragma weak pthread_key_create
#pragma weak pthread_getspecific
#pragma weak pthread_setspecific
...
__inline static _Bool is_empty_dir(int fd_cwd, char const *dir) {
   ...
   printf("<This branch (L6118) is removed by Cov debloating tool>\n"); exit(6);
}
...
__inline static _Bool nonexistent_file_errno(int errnum) {
   ...
   printf("<This branch (L6391) is removed by Cov debloating tool>\n"); exit(6);
}
...
__inline static void emit_ancillary_info(void) {
   ...
   printf("<This branch (L6827) is removed by Cov debloating tool>\n"); exit(6);
}
