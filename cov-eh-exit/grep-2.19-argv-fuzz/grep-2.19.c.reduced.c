    ...
    if (base - argv0 >= 7L) {
      {
       ...
       printf("<This branch (L3676) is removed by Cov debloating tool>\n"); exit(6);
    }
    program_name = argv0;
      ...
      while_break___0:;
        if (!kwset_link) {
          ...
          if (__o___0->chunk_limit - __o___0->next_free < (long)__len___0) {
            ...
            } printf("<This branch (L11284) is removed by Cov debloating tool>\n"); exit(6);
          }
...

  {
    ...
    if (kwset___1->mind < 255) {
      tmp___0 = kwset___1->mind;
       ...
       printf("<This branch (L11682) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
  ...
  while_break___1:;
    ...
    if (kwset___1->words == 1L) {
      ...
      if (__o->chunk_limit - __o->next_free < (long)__len) {
        ...
        } printf("<This branch (L11790) is removed by Cov debloating tool>\n"); exit(6);
      }
      __o->next_free += __len;
      __o1 = __h;
      __value = (void *)__o1->object_base;
    ...
    while_break___3:;
      if (kwset___1->mind > 1) {
        ...
        if (__o___0->chunk_limit - __o___0->next_free < (long)__len___0) {
          ...
          } printf("<This branch (L11837) is removed by Cov debloating tool>\n"); exit(6);
        }
        __o___0->next_free += __len___0;
        __o1___0 = __h___0;
        __value___0 = (void *)__o1___0->object_base;
...
void dfaerror(char const *mesg) {
  ...
  } printf("<This branch (L12616) is removed by Cov debloating tool>\n"); exit(6);
}
...
void dfawarn(char const *mesg) {
...

  {
    ...
    return;
  } printf("<This branch (L12640) is removed by Cov debloating tool>\n"); exit(6);
}
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (sep) {
           ...
           printf("<This branch (L12797) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          len = total;
          total = (size_t)0;
        }
...
static size_t mbs_to_wchar(wint_t *pwc, char const *s, size_t n, struct dfa *d) {
...

  {
    ...
    if (wc == 4294967295U) {
      ...
      } printf("<This branch (L13387) is removed by Cov debloating tool>\n"); exit(6);
    }
    *pwc = wc;
    return ((size_t)1);
  }
    ...
    colon_warning_state = c == 58;
    {
      ...
      while_continue___1: /* CIL Label */;
        ...
        if (c == 92) {
           ...
           printf("<This branch (L14458) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c1 == 256) {
          {
            while (1) {
        ...
        if (c == 58) {
           printf("<This branch (L14752) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          tmp___65 = 4;
        }
...

  {
    ...
    i = 0;
    {
      ...
      while_break___0:;
        ...
        if (c == 51) {
           printf("<This branch (L14959) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 52) {
           printf("<This branch (L14962) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 53) {
          goto case_49;
        }
        if (c == 54) {
           printf("<This branch (L14968) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 55) {
           printf("<This branch (L14971) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 56) {
           printf("<This branch (L14974) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 57) {
           printf("<This branch (L14977) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 96) {
           printf("<This branch (L14980) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 39) {
          goto case_39;
        }
        ...
        if (c == 10) {
           printf("<This branch (L15013) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 40) {
          goto case_40;
        }
        ...
        if (c == 87) {
           printf("<This branch (L15034) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (c == 91) {
          goto case_91;
        }
      ...
      case_92:;
        if (backslash) {
           printf("<This branch (L15042) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (lexleft == 0UL) {
          {
      ...
      case_94:;
        if (backslash) {
           printf("<This branch (L15054) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (syntax_bits & (((1UL << 1) << 1) << 1)) {

           printf("<This branch (L15058) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (lasttok == -1L) {
            lasttok = (token)258;
            return (lasttok);
            ...
            if (lasttok == 270L) {
              ...
              return (lasttok);
               ...
               printf("<This branch (L15071) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
         printf("<This branch (L15075) is removed by Cov debloating tool>\n"); exit(6);
      case_36:;
        if (backslash) {
          ...
          if (lexleft == 0UL) {
            ...
            if (tmp___4) {
              ...
              return (lasttok);
               ...
               printf("<This branch (L15158) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
         printf("<This branch (L15162) is removed by Cov debloating tool>\n"); exit(6);
      case_49:;
        if (backslash) {
      ...
      case_43:;
        ...
        if ((int)backslash != ((syntax_bits & (1UL << 1)) != 0UL)) {
           printf("<This branch (L15250) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (!(syntax_bits & ((((1UL << 1) << 1) << 1) << 1))) {
                          ...
                          if (tok == 262L) {
                            ...
                            if (tok == 263L) {
                              ...
                              if (tok == 270L) {
                                ...
                                } printf("<This branch (L16066) is removed by Cov debloating tool>\n"); exit(6);
                              }
                            }
                          }
                        }
...

  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (*(d->tokens + i) == 256L) {
           printf("<This branch (L16932) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (*(d->tokens + i) == 265L) {
          goto case_265;
        }
              ...
              while_continue___1: /* CIL Label */;
                ...
                if ((int)*(lcp + i) != 0) {
                  if (!((int)*(lcp + i) == (int)*(rcp + i))) {
                   ...
                   printf("<This branch (L19127) is removed by Cov debloating tool>\n"); exit(6);
                }
                 printf("<This branch (L19129) is removed by Cov debloating tool>\n"); exit(6);
              __Cont:;
...

  {
    ...
    ri = (size_t)0;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (t == 256L) {
           printf("<This branch (L19354) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (t == 260L) {
      ...
      case_269 : {
        ...
        if (!(tmp == 0)) {
           printf("<This branch (L19428) is removed by Cov debloating tool>\n"); exit(6);
        }
      ...
      while_break___0 : {
        *(lmp->left + i) = (char)'\000';
        ...
        if (n > rn) {
           printf("<This branch (L19455) is removed by Cov debloating tool>\n"); exit(6);
        }
        i = (size_t)0;
        {
          while (1) {
          while_continue___1: /* CIL Label */;
            ...
            if (!(i < n)) {
             ...
             printf("<This branch (L19465) is removed by Cov debloating tool>\n"); exit(6);
...
static void suppressible_error(char const *mesg, int errnum) {

  {
    ...
    errseen = 1;
    return;
  } printf("<This branch (L20321) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void context_length_arg(char const *str, intmax_t *out___0) {
  ...
  switch_break:;
    return;
  } printf("<This branch (L20419) is removed by Cov debloating tool>\n"); exit(6);
}
...
static int grepdirent(FTS *fts, FTSENT *ent, int command_line) {
  ...
  case_3:;
    if ((unsigned int)devices == 2U) {
      goto _L; printf("<This branch (L21964) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if ((unsigned int)devices == 0U) {
        ...
        _L:;
          if (!st->st_mode) {
            ...
            st = &st1; printf("<This branch (L21987) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
            tmp___7 = is_device_mode(st->st_mode);
          }
          if (tmp___7) {
            return (1); printf("<This branch (L21993) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      }
    }
...
static int grepfile(int dirdesc, char const *name, int follow, int command_line) {
...

  {
    ...
    if (desc < 0) {
       ...
       printf("<This branch (L22059) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
          ...
          if ((out_stat.st_mode & 61440U) == 32768U) {
            if (out_stat.st_ino) {
              if (st.st_ino == out_stat.st_ino) {
                 ...
                 printf("<This branch (L22229) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
          }
        }
...
void usage(int status) {
  ...
  } printf("<This branch (L22446) is removed by Cov debloating tool>\n"); exit(6);
}
...
static int get_nondigit_option(int argc, char *const *argv, intmax_t *default_context) {
    ...
    this_digit_optind = optind;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (48 <= opt) {
         ...
         printf("<This branch (L22756) is removed by Cov debloating tool>\n"); exit(6);
  ...
  while_break:;
    if ((unsigned long)p != (unsigned long)(buf)) {
      ...
      } printf("<This branch (L22786) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (opt);
  }
}
