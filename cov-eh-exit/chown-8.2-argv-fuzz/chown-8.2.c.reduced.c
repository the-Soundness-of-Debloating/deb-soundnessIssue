...
strtol_error xstrtoul(char const *s, char **ptr, int strtol_base,
  ...
  while_break:;
    ...
    *val = tmp;
    return (err);
  } printf("<This branch (L1174) is removed by Cov debloating tool>\n"); exit(6);
}
...
static char const *gettext_quote(char const *msgid, enum quoting_style s) {
...

  {
    ...
    return (translation);
  } printf("<This branch (L1819) is removed by Cov debloating tool>\n"); exit(6);
}
static size_t
quotearg_buffer_restyled(char *buffer, size_t buffersize, char const *arg,
  ...
  force_outer_quoting_style:
    ...
    return (tmp___7);
  } printf("<This branch (L2794) is removed by Cov debloating tool>\n"); exit(6);
}
...
char const *quote_n(int n, char const *name) {
...

  {
    ...
    return (tmp);
  } printf("<This branch (L2923) is removed by Cov debloating tool>\n"); exit(6);
}
char const *quote(char const *name) {
  char const *tmp;
...
void set_program_name(char const *argv0) {
...

  {
    ...
    if (base - argv0 >= 7L) {
       ...
       printf("<This branch (L2965) is removed by Cov debloating tool>\n"); exit(6);
    }
    program_name = argv0;
  ...
  while_break:;
    ...
    if (ok) {
      tmp___15 = 0;
       ...
       printf("<This branch (L7265) is removed by Cov debloating tool>\n"); exit(6);
    }
    exit(tmp___15);
  }
}
